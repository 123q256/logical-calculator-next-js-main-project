...
const ForgetPasswordLink = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // 👇 yaha apna backend API URL lagao
  ...
  return (
    <div className="max-w-[1140px] mx-auto lg:px-0 px-5 my-10">
      <div className="max-w-[1660px]">
        ...
        ></div>
        <div
          className="absolute z-10 bottom-[100px] right-[0px] sm:w-[60%] sm:right-[0px] sm:top-[200px] md:w-[70%] md:right-[0px] md:top-[350px] lg:w-[80%] lg:right-[50px]"
          style={{
            maxWidth: 351,
            height: 351,
            flexShrink: 0,
      ...
      <form onSubmit={handleSubmit}>
        <div className="max-w-screen-lg mx-auto justify-center  mt-10">
          <div className="flex mx-auto justify-center lg:w-[50%] md:w-[50%] w-full flex-col xl:my-8 lg:my-6 my-4 gap-x-5 gap-y-4">
            <div className="w-full">
              <p className="text-[30px] text-center font-bold pb-4">
                Reset Password
              </p>
              ...
              <div>
                <label
                  ...
                  className="block mb-2 xl:text-[16px] lg:text-[14px] text-[14px] font-medium text-[#000] pl-1"
                >
                  E-Mail Address:
                </label>
                <div className="relative">
                  <input
                    ...
                    className={`bg-white border ${
                      errors.email ? "border-red-500" : "border-[#F0F0F0]"
                    } rounded-[25.5px] border-2 text-gray-900 text-sm block w-full 2xl:p-5 xl:p-4 lg:p-3 p-3 input_border`}
                    placeholder="Email"
                  />
                  {errors.email && (
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleChange}
                    className={`bg-white border ${
                      errors.password ? "border-red-500" : "border-[#F0F0F0]"
                    } rounded-[25.5px] border-2 text-gray-900 text-sm block w-full 2xl:p-5 xl:p-4 lg:p-3 p-3 input_border`}
                  ...
                  {/* SVG icon for toggle */}
                  <div className="absolute top-6 right-0 flex items-center pr-4">
                    <button
                      type="button"
            ...
            <button
              type="submit"
              className="bg-[#000]  w-full py-3 shadow-2xl mb-8 text-[#fff] hover:bg-[#1A1A1A] hover:text-white duration-200 font-[600] text-[16px] rounded-[44px] px-5 mx-auto cursor-pointer"
            >
              Reset Password
            </button>
          </div>
