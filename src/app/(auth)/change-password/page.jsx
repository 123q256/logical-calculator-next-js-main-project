    ...
    <div className="max-w-[1140px] mx-auto lg:px-0 px-5 my-10">
      ...
      >
        <div className="max-w-screen-lg mx-auto justify-center  mt-10">
          <div className="flex mx-auto justify-center w-full flex-col xl:my-8 lg:my-6 my-4 gap-x-5 gap-y-4">
            <div className="w-full ">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  {/* SVG icon for toggle */}
                  <div className="absolute md:top-6 top-5 right-0 flex items-center pr-4">
                    <button
                      type="button"
