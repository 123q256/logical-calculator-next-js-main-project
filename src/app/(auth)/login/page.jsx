...
const Login = () => {
  ...
  const onSubmit = async (formData) => {
    try {
      ...
      Cookies.set("refresh_token", result?.payload?.refreshToken);
  ...
  const metaTitle = "Signin Page - Calculators Logical";
  const metaDescription = "Signin Page - Calculators Logical";
  const ogImage =
  ...
  return (
    <div className="flex justify-center items-center relative">
      ...
      <div className="z-10 flex 2xl:w-[65%] xl:w-[70%] lg:w-[75%] w-[90%]  my-10 bg-white rounded-[25px] shadow-lg bordered">
        <div
          className="lg:w-[50%] lg:rounded-[0px] rounded-[25px] w-[100%] 2xl:my-10 xl:my-7 lg:my-4 2xl:py-[20px] xl:py-[15px] lg:py-[8px] py-7 2xl:px-[50px] xl:px-[40px] lg:px-[35px] px-6"
          style={{
        ...
        >
          <a
            href="/"
            className="flex mb-3 items-center text-left  space-x-3 rtl:space-x-reverse mr-auto"
          >
            <img
              src="/logo/logo.png"
              className="h-8"
          ...
          <h1 className="2xl:text-[25px] text-center lg:text-[24px] text-[21px] font-[700] leading-[15.17px] text-black">
            Welcome Back
          </h1>
          <form
            className="2xl:mt-[100px] xl:mt-[40px] lg:mt-[45px] md:mt-[30px] mt-[12px]"
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                className="bg-white border-[#F0F0F0] rounded-[20.5px] text-gray-900 text-sm block w-full 2xl:p-5 xl:p-4 lg:p-3 p-3 input_border"
                {...register("email", {
            ...
            {/* Password Field */}
            <div className="xl:mt-5 mt-3 xl:mb-3 mb-1.5 relative">
              <label
                htmlFor="password"
                className="block my-2 pl-5 xl:text-[14px] lg:text-[12px] text-[14px] font-medium text-[#A3A3A3]"
              >
              ...
              <div className="relative">
                <input
                  ...
                  className="bg-white border-[#F0F0F0] rounded-[20.5px] text-gray-900 text-sm block w-full 2xl:p-5 xl:p-4 lg:p-3 p-3 pr-[50px] input_border"
                  {...register("password", {
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-3 flex items-center pr-4 cursor-pointer"
                  aria-label={showPassword ? "Hide password" : "Show password"}
                >
                  {showPassword ? (
                    // Show icon (password visible)
                    <svg
                      width={25}
                      height={19}
                      viewBox="0 0 25 19"
            ...
            <div className="">
              <a
                ...
                className="block text-right cursor-pointer hover:underline mb-2 text-[14px] font-medium text-[#A3A3A3]"
              >
                Forgot Password?
              </a>
            </div>
            ...
            <button
              type="submit"
              className="bg-[#000] text-white 2xl:text-[18px] xl:text-[16px] text-[14px] rounded-[30.69px] w-full 2xl:py-5 xl:py-4 lg:py-3 py-3 font-[600] cursor-pointer"
            >
              Login
            </button>
          </form>
          ...
          <div className="flex justify-center xl:my-6 my-3">
            <a
              href="#"
              className="bg-white relative border-2 border-black text-black 2xl:text-[18px] xl:text-[16px] text-[14px] rounded-[30.69px] w-full 2xl:py-5 xl:py-4 lg:py-3 py-3 font-[600] flex items-center justify-center"
            >
        ...
        <div className="w-[50%] lg:block hidden bg-black rounded-[25px] 2xl:py-[63px] xl:py-[40px] lg:py-[35px] 2xl:px-[50px] xl:px-[40px] lg:px-[35px]">
          ...
          <div className="flex justify-center my-10">
            <a
              href="/signup"
              className="bg-[#F7BB0D] 2xl:text-[18px] text-center xl:text-[16px] text-[14px] rounded-[36.69px] w-full 2xl:py-5 xl:py-4 lg:py-3 py-3 font-[600]"
            >
              Sign Up
            </a>
          </div>
