...
const ArmyBodyFatCalculator = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await calculateEbitCalculator({
        tech_activeDuty: formData.tech_activeDuty,
        ...
        tech_units1: formData.tech_units1in,
        ...
        tech_unit_h2: formData.tech_unit_h2in,
  ...
  const handleReset = () => {
    setFormData({
      ...
      tech_neck_ft: 0,
      tech_unit_ft_in1: "ft/in",
      tech_neck_in: 0,
      tech_unit_h1: "ft/in",
      tech_neck_cm: 1,
      tech_unit_h_cm1: "ft/in",
      tech_waist_ft: 0,
      tech_unit_ft_in2: "ft/in",
      tech_waist_in: 0,
      tech_unit_h2: "ft/in",
      tech_waist_cm: 2,
      tech_unit_h_cm2: "ft/in",
      tech_hip_ft: 1,
      tech_unit_ft_in3: "ft/in",
      tech_hip_in: 2,
      tech_unit_h3: "ft/in",
      tech_hip_cm: 2,
      tech_unit_h_cm3: "ft/in",
    });
    setResult(null);
    setFormError(null);
  };
          ...
          <div className="lg:w-[70%] md:w-[100%] w-full mx-auto ">
            <div className="grid grid-cols-12  gap-2 md:gap-4 lg:gap-4">
              <div className="col-span-12 md:col-span-6">
                <label htmlFor="tech_activeDuty" className="label">
                ...
                <div className="mt-2">
                  <select
                    className="input"
                    aria-label="select"
                    name="tech_activeDuty"
                    id="tech_activeDuty"
                    value={formData.tech_activeDuty}
                      ...
                      <div className="w-full mt-2">
                        ...
                        <p>
                          <strong className="text-[32px] text-[#119154]">
                            {Number(result?.tech_bodyFatPercentage).toFixed(2)}{" "}
                            %
                          </strong>
                        </p>
                        <p>{result?.tech_bodyFatCategory}</p>
                      </div>
                    </div>
                  </div>
                </div>
