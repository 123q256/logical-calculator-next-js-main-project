...
import {
  ...
  ArcElement, // Also add ArcElement for doughnut charts
} from "chart.js";
        ...
        datasets: [
          {
            ...
            data: dataPoints,
            borderColor: "#623a6c",
            backgroundColor: "rgb(40 69 245 / 68%)",
            tension: 0.4,
            pointRadius: 3,
            fill: true,
          },
    ...
    >
      <form className="row" onSubmit={handleSubmit}>
        <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg space-y-6 mb-3">
          ...
          <div className="lg:w-[90%] md:w-[96%] w-full mx-auto ">
            <div className="grid grid-cols-12  gap-2 md:gap-4 lg:gap-4">
              ...
              <div className="col-span-6">
                <label htmlFor="tech_weight" className="label">
                  ...
                  {formData.tech_unit_type == "metric" && (
                    <>
                      <span className="text-blue text">(kg)</span>
                    </>
                  )}
                </label>
                <div className=" relative">
                          ...
                          <div className="col-span-12 md:col-span-6 lg:col-span-6">
                            <div className="flex items-center justify-between bg-sky bordered rounded-lg px-3 py-2">
                              ...
                              <div className="border-s-dark ps-2">
                                <div>
                                  <strong className="text-[#119154] md:text-[20px]">
