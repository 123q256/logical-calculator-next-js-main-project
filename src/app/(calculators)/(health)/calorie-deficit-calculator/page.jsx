...
import { useGetSingleCalculatorDetailsMutation ,useCalorieDeficitCalculatorMutation} from "../../../../redux/services/calculator/calculatorApi";
...
import "../../../../components/styles/CssCalorieDeficitCalculator.css";
            ...
            {formError && (
              <p className="text-red-500 text-lg font-semibold w-full">
                      ...
                      <div className="col-span-6">
                          ...
                          {data?.payload?.tech_lang_keys["weight"]}:
                            ...
                            />
                               ...
                               {formData.tech_unit_type == "lbs" && (
                                 <>
                                 <span className="text-blue input_unit" id="lbs_or_kg1">lbs</span>
                                </>
                               )}
                                 {formData.tech_unit_type == "kg" && (
                                 <>
                                 <span className="text-blue input_unit" id="lbs_or_kg1">kg</span>
                                </>
                               )}
                            </div>
                      </div>
                      ...
                      <div className="col-span-12">
                          ...
                          <div className="mt-2">
                            <select
                              ...
                              onChange={handleChange}
                            >
                              <option value="1.2">{data?.payload?.tech_lang_keys["No_sport"]} </option>
                              <option value="1.375">{data?.payload?.tech_lang_keys["Light_activity"]} </option>
                              <option value="1.55">{data?.payload?.tech_lang_keys["Moderate_activity"]} </option>
                              <option value="1.725">{data?.payload?.tech_lang_keys["High_activity"]} </option>
                              <option value="1.9">{data?.payload?.tech_lang_keys["Extreme_activity"]} </option>
                            </select>
                          </div>
                      </div>
                  </div>
               ...
               <div className="mb-6 mt-10 text-center space-x-2">
                ...
                <Button type="formData?.tech_unit_type" isLoading={roundToTheNearestLoading}>
                  ...
                  <div>
                    ...
                    <div className="rounded-lg  md:w-[95%] lg:w-[95%] mt-3 flex justify-center">
                          <div className="w-full ">
                              <div className="w-full ">
                                <div className="grid grid-cols-12 gap-4 text-center bordered shadow-md rounded-lg px-2 mx-[10px] py-4">
                                  <div className="col-span-12 md:col-span-6 lg:col-span-6 ">
                                    <div className="text-center line-height border-end-cus px-3">
                                      <strong>{data?.payload?.tech_lang_keys[84]}</strong>
                                      <p className="text-[14px] px-4 py-2">
                                        You should take the following calories on a daily basis
                                      </p>
                                  ...
                                  <div className="col-span-12 md:col-span-6 lg:col-span-6 ">
                                    <div className="text-center line-height px-3">
                                      <strong>{data?.payload?.tech_lang_keys[86]}</strong>
                                 ...
                                 <div className="grid grid-cols-12 gap-x-2 mt-3">
                                  {/* Mild Weight Loss */}
                                  <div className="col-span-12 md:col-span-4 lg:col-span-4 bordered rounded-lg">
                                    <div className="shadow-md mt-2 p-2 rounded-lg flex justify-between items-center">
                                      <div>
                                        <span className="text-[12px]">Mild Weight Loss</span>
                                        <p className="text-[12px] text-gray-500">
                                          {formData?.tech_unit_type === "lbs" ? "( 0.5 lb/week )" : "( 0.25 kg/week )"}
                                        </p>
                                      </div>
                                      <div className="text-blue-500">
                                        <strong className="text-[14px]">
                                          {formatNumber(result?.tech_tdee - (formData?.tech_unit_type === "lbs" ? 250 : Math.round((7700 * 0.25) / 7)))}{" "}
                                          <span className="calo text-dark">Calories/Day</span>
                                        </strong>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  {/* Weight Loss */}
                                  <div className="col-span-12 md:col-span-4 lg:col-span-4 bordered rounded-lg">
                                    <div className="shadow-md mt-2 p-2 rounded-lg flex justify-between items-center mx-md-2">
                                      <div>
                                        <span className="text-[12px]">Weight Loss</span>
                                        <p className="text-[12px] text-gray-500">
                                          {formData?.tech_unit_type === "lbs" ? "( 1 lb/week )" : "( 0.5 kg/week )"}
                                        </p>
                                      </div>
                                      <div className="text-blue-500">
                                        <strong className="text-[14px]">
                                          {formatNumber(result?.tech_tdee - (formData?.tech_unit_type === "lbs" ? 500 : Math.round((7700 * 0.5) / 7)))}{" "}
                                          <span className="calo text-dark">Calories/Day</span>
                                        </strong>
                                      </div>
                                    </div>
                                  ...
                                  <div className="col-span-12 md:col-span-4 lg:col-span-4 bordered rounded-lg">
                                    <div className="shadow-md mt-2 p-2 rounded-lg flex justify-between items-center">
                                      <div>
                                        <span className="text-[12px]">Extreme Weight Loss</span>
                                        <p className="text-[12px] text-gray-500">
                                          {formData?.tech_unit_type === "lbs" ? "( 2 lb/week )" : "( 1 kg/week )"}
                                        </p>
                                      </div>
                                      <div className="text-blue-500">
                                        <strong className="text-[14px]">
                                          {formatNumber(result?.tech_tdee - (formData?.tech_unit_type === "lbs" ? 1000 : Math.round(7700 / 7)))}{" "}
                                          <span className="calo text-dark">Calories/Day</span>
                                        </strong>
                                      </div>
                                    </div>
                              ...
                              {!showDetail && (
                                <div className="w-full hide_table px-3">
                                  <p className="text-[18px] px-3 mt-4 mb-3 text-center">
                                    <strong>
                                      {data?.payload?.tech_lang_keys[56]} ({new Date().toLocaleDateString('en-US', { weekday: 'long', day: 'numeric', month: 'long', year: 'numeric' })})
                                    </strong>
                                  </p>

                                  <div className="w-full overflow-auto bordered rounded-lg custom-scroll" style={{ maxHeight: 286 }}>
                                    <table className="w-full px-3 text-center" cellSpacing="0">
                                      <thead>
                                        <tr>
                                          <th className="hidden"></th>
                                          <th className="text-[12px] border-b-dark p-2">{data?.payload?.tech_lang_keys[57]}</th>
                                          <th className="text-[12px] border-b-dark p-2">{data?.payload?.tech_lang_keys[58]}</th>
                                          <th className="text-[12px] border-b-dark p-2">{data?.payload?.tech_lang_keys[59]}</th>
                                          <th className="text-[12px] border-b-dark p-2">{data?.payload?.tech_lang_keys[60]}</th>
                                          <th className="text-[12px] border-b-dark p-2">{data?.payload?.tech_lang_keys[87]}</th>
                                        </tr>
                                      </thead>
                                      <tbody>
                                        {(result?.tech_intake_cal_array || []).map((val, idx) => {
                                          const [in_cal, yrs, date, less_cal] = val.split('@@');
                                          const borderClass = idx + 1 === (result?.tech_intake_cal_array.length) ? '' : 'border-b';

                                          return (
                                            <tr
                                              key={idx}
                                              className="click_me cursor-pointer"
                                              onClick={() => handleDetailClick(in_cal, yrs, date)}
                                            >
                                              <td className="hidden">{idx + 1}</td>
                                              <td className={`text-[14px] ${borderClass} p-2`} style={{ width: '15%' }}>{in_cal}</td>
                                              <td className={`text-[14px] ${borderClass} p-2`}>{less_cal}</td>
                                              <td className={`text-[14px] ${borderClass} p-2`}>{yrs}</td>
                                              <td className={`text-[14px] ${borderClass} p-2`}>{date}</td>
                                              <td className={`${borderClass} text-blue-500 p-2 flex`} title={data?.payload?.tech_lang_keys[77]}>
                                                <span className="mx-1">{data?.payload?.tech_lang_keys[87]}</span>
                                                <img
                                                  src='/images/blue-arrow.png'
                                                  alt="Arrow"
                              ...
                              {showDetail && (
                                <div className="w-full loading_data px-3 mt-4">
                                  <p className="text-[18px] px-3 mt-2 mb-1">
                                    <strong className="text-blue">{data?.payload?.tech_lang_keys[62]}</strong>
                                  </p>
                                  <div className="w-full bg-[#F6FAFC] overflow-auto px-3 relative">
                                        ...
                                        <div className="w-full">
                                          <p className="text-center my-2">
                                            <strong className="text-blue">
                                              ...
                                              <span className="cal_update text-blue">{selectedDetail?.calories}</span>{' '}
                                              {data?.payload?.tech_lang_keys[64]}{' '}
                                              <span id="time_update" className="text-blue">{selectedDetail?.time}</span>.
                                            </strong>
                                          </p>
                                          ...
                                          <div className="grid grid-cols-12 gap-3 text-[14px]">
                                            ...
                                            <div className="col-span-4 overflow-auto">
                                              <table className="w-full" cellSpacing="0">
                                                <tbody>
                                                  ...
                                                  <tr><td className="border-b p-2"><strong>{data?.payload?.tech_lang_keys['weight']}</strong></td></tr>
                                                  <tr><td className="border-b p-2"><strong>{data?.payload?.tech_lang_keys[64]}</strong></td></tr>
                                                  <tr><td className="border-b p-2"><strong>TDEE</strong></td></tr>
                                                  <tr><td className="border-b p-2"><strong>RMR</strong></td></tr>
                                                  <tr><td className="p-2"><strong>BMI</strong></td></tr>
                                                </tbody>
                                              </table>
                                            </div>
                                            ...
                                            <div className="col-span-4 overflow-auto">
                                              <table className="w-full" cellSpacing="0">
                                                <tbody>
                                                  <tr><td className="border-b p-2"><strong>{new Date().toLocaleDateString()}</strong></td></tr>
                                                  <tr>
                                                    <td className="border-b p-2">
                                                      <strong>{result?.tech_weight}</strong> <span>{result?.tech_formData?.tech_unit_type}</span>
                                                    </td>
                                                  </tr>
                                                  <tr>
                                                    <td className="border-b p-2">
                                                      <strong>{result?.tech_LBM}</strong> <span>{result?.tech_formData?.tech_unit_type}</span>
                                                    </td>
                                                  </tr>
                                                  <tr>
                                                    <td className="border-b p-2">
                                                      <strong>{result?.tech_tdee}</strong> <span>kcal</span>
                                                    </td>
                                                  </tr>
                                                  <tr>
                                                    <td className="border-b p-2">
                                                      <strong>{result?.tech_RMR}</strong> <span>kcal</span>
                                                    </td>
                                                  </tr>
                                                  <tr>
                                                    <td className="p-2"><strong>{result?.tech_BMI}</strong></td>
                                                  </tr>
                                                </tbody>
                                              </table>
                                            </div>
                                            ...
                                            <div className="col-span-4 overflow-auto">
                                              <table className="w-full" cellSpacing="0">
                                                <tbody>
                                                  <tr>
                                                    <td className="border-b p-2">
                                                      <strong className="text-blue" id="target_date">{selectedDetail?.targetDate || ''}</strong>
                                                    </td>
                                                  </tr>
                                                  <tr>
                                                    <td className="border-b p-2">
                                                      <strong>{result?.tech_target}</strong> <span>{result?.tech_formData?.tech_unit_type}</span>
                                                    </td>
                                                  </tr>
                                                  <tr>
                                                    <td className="border-b p-2">
                                                      <strong>{result?.tech_LBM_target}</strong> <span>{result?.tech_formData?.tech_unit_type}</span>
                                                    </td>
                                                  </tr>
                                                  <tr>
                                                    <td className="border-b p-2">
                                                      <strong>{result?.tech_tdee_target}</strong> <span>kcal</span>
                                                    </td>
                                                  </tr>
                                                  <tr>
                                                    <td className="border-b p-2">
                                                      <strong>{result?.tech_RMR_target}</strong> <span>kcal</span>
                                                    </td>
                                                  </tr>
                                                  <tr>
                                                    <td className="p-2"><strong>{result?.tech_BMI_target}</strong></td>
                                                  </tr>
                                                </tbody>
                                              </table>
                                            </div>
                                          ...
                                          <div className="col s12 padding_0 margin_top_15 text-center my-2">
                                            <strong className="text-blue">
                                              ...
                                              <span className="cal_update text-blue">{selectedDetail?.calories}</span> kcal
                                            </strong>
                                          </div>
                                          ...
                                          <div className="grid grid-cols-12 gap-3 text-[14px]">
                                            ...
                                            <div className="col-span-3 overflow-auto">
                                              <table className="w-full" cellSpacing="0">
                                                <tbody>
                                                  <tr><td className="border-b p-2"><strong className="text-blue">{data?.payload?.tech_lang_keys[66]}</strong></td></tr>
                                                  <tr><td className="border-b p-2"><strong>{data?.payload?.tech_lang_keys[67]}</strong></td></tr>
                                                  <tr><td className="border-b p-2"><strong>{data?.payload?.tech_lang_keys[68]}</strong></td></tr>
                                                  <tr><td className="border-b p-2"><strong>{data?.payload?.tech_lang_keys[69]}</strong></td></tr>
                                                  <tr><td className="p-2"><strong>{data?.payload?.tech_lang_keys[70]}</strong></td></tr>
                                                </tbody>
                                              </table>
                                            </div>
                                            ...
                                            <div className="col-span-3 overflow-auto">
                                              <table className="w-full" cellSpacing="0">
                                                <tbody>
                                                  <tr><td className="border-b p-2"><strong className="text-blue">{data?.payload?.tech_lang_keys[71]}</strong></td></tr>
                                                  <tr><td className="border-b p-2"><strong>Balanced</strong> (g): {selectedDetail?.macros?.balanced?.protein}</td></tr>
                                                  <tr><td className="border-b p-2"><strong>Low Fat</strong> (g): {selectedDetail?.macros?.lowFat?.protein}</td></tr>
                                                  <tr><td className="border-b p-2"><strong>Low Carbs</strong> (g): {selectedDetail?.macros?.lowCarb?.protein}</td></tr>
                                                  <tr><td className="p-2"><strong>High Protein</strong> (g): {selectedDetail?.macros?.highProtein?.protein}</td></tr>
                                                </tbody>
                                              </table>
                                            </div>
                                            ...
                                            <div className="col-span-3 overflow-auto">
                                              <table className="w-full" cellSpacing="0">
                                                <tbody>
                                                  <tr><td className="border-b p-2"><strong className="text-blue">{data?.payload?.tech_lang_keys[72]}</strong></td></tr>
                                                  <tr><td className="border-b p-2"><strong>Balanced</strong> (g): {selectedDetail?.macros?.balanced?.carbs}</td></tr>
                                                  <tr><td className="border-b p-2"><strong>Low Fat</strong> (g): {selectedDetail?.macros?.lowFat?.carbs}</td></tr>
                                                  <tr><td className="border-b p-2"><strong>Low Carbs</strong> (g): {selectedDetail?.macros?.lowCarb?.carbs}</td></tr>
                                                  <tr><td className="p-2"><strong>High Protein</strong> (g): {selectedDetail?.macros?.highProtein?.carbs}</td></tr>
                                                </tbody>
                                              </table>
                                            </div>
                                            ...
                                            <div className="col-span-3 overflow-auto">
                                              <table className="w-full" cellSpacing="0">
                                                <tbody>
                                                  <tr><td className="border-b p-2"><strong className="text-blue">{data?.payload?.tech_lang_keys[73]}</strong></td></tr>
                                                  <tr><td className="border-b p-2"><strong>Balanced</strong> (g): {selectedDetail?.macros?.balanced?.fats}</td></tr>
                                                  <tr><td className="border-b p-2"><strong>Low Fat</strong> (g): {selectedDetail?.macros?.lowFat?.fats}</td></tr>
                                                  <tr><td className="border-b p-2"><strong>Low Carbs</strong> (g): {selectedDetail?.macros?.lowCarb?.fats}</td></tr>
                                                  <tr><td className="p-2"><strong>High Protein</strong> (g): {selectedDetail?.macros?.highProtein?.fats}</td></tr>
                                                </tbody>
                                              </table>
                                            </div>
                                          </div>
                                          ...
                                          <div className="w-full text-center">
                                            <button
                                              type="button"
                                              className="bg-[#2845F5] text-white rounded-lg border-0 px-4 py-2 my-3 cursor-pointer"
                                    ...
                                    <div className="w-full mt-4 px-3">
                                      <div className="grid grid-cols-12 border-blue-500 pb-3 rounded-lg">
                                        <p className="col-span-12 text-[18px] px-3 mb-2 text-center radius-top bg-[#2845F5] text-white py-2">
                                            ...
                                            <tbody>
                                              <tr>
                                                <td className="border-b p-2">
                                                  ...
                                                  <span
                                                    ...
                                                    title={data?.payload?.tech_lang_keys[32]}
                                                  >
                                                    ?
                                                  </span>
                                                </td>
                                                <td className="border-b p-2 text-end">
                                                  ...
                                                  <span className="text-[14px]">Kcal/day</span>
                                                </td>
                                              </tr>
                                              <tr>
                                                <td className="border-b p-2">
                                                  ...
                                                  <span
                                                    className="bg-white radius-circle px-2 cursor-pointer"
                                                    title={data?.payload?.tech_lang_keys[54]}
                                                  >
                                                    ?
                                                  </span>
                                                </td>
                                              ...
                                              <tr>
                                                <td className="border-md-b p-2">
                                                  ...
                                                  <span
                                                    className="bg-white radius-circle px-2 cursor-pointer"
                                                    title={data?.payload?.tech_lang_keys[53]}
                                                  >
                                                    ?
                                                  </span>
                                                </td>
                                            ...
                                            <tbody>
                                              <tr>
                                                <td className="border-b p-2">
                                                  ...
                                                  <span
                                                    className="bg-white radius-circle px-2 cursor-pointer"
                                                    title={data?.payload?.tech_lang_keys[89]}
                                                  >
                                                    ?
                                                  </span>
                                                </td>
                                              ...
                                              <tr>
                                                <td className="border-b p-2">
                                                  ...
                                                  <span
                                                    className="bg-white radius-circle px-2 cursor-pointer"
                                                    title={data?.payload?.tech_lang_keys[52]}
                                                  >
                                                    ?
                                                  </span>
                                                </td>
                                              ...
                                              <tr>
                                                <td className="p-2">
                                                  ...
                                                  <span
                                                    className="bg-white radius-circle px-2 cursor-pointer"
                                                    title={data?.payload?.tech_lang_keys[55]}
                                                  >
                                                    ?
                                                  </span>
                                                </td>
                                                <td className="p-2 text-end">
                                                  ...
                                                  <span>{result?.tech_formData?.tech_unit_type}</span>
                                                </td>
                                              </tr>
                                            </tbody>
                                          </table>
