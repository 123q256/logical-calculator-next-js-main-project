                      ...
                      {dropdownVisible2 && (
                        <div className="absolute z-10 bg-white border border-gray-300 rounded-md w-auto mt-1 right-0">
                          {[
                            ...
                            { label: "ha", value: "ha" },
                            { label: "ac", value: "ac" },
                            { label: "soccer fields", value: "soccer fields" },
                          ].map((unit, index) => (
                            <p
                              key={index}
                              className="p-2 hover:bg-gray-100 cursor-pointer"
                ...
                <div>
                  ...
                  <div className="rounded-lg flex items-center justify-center">
                    <div className="w-full mt-3">
                      {(() => {
                        let rolls_unit = "(10 ft²)";
                        let pallets_unit = "(450 ft²)";
                        let total_area_unit = "Ft²";
                        let acres_unit = "Acres";

                        if (result?.tech_meter) {
                          rolls_unit = "(1 m²)";
                          pallets_unit = "(40 m²)";
                          total_area_unit = "M²";
                          acres_unit = "Hectares";
                              ...
                              <table className="w-full text-base ">
                                <tbody>
                                  <tr>
                                    ...
                                    <td className="border-b py-2">
                                      {data?.payload?.tech_lang_keys["rolls"]}{" "}
                                      {rolls_unit}
                                    </td>
                                  </tr>
                                  <tr>
                                    ...
                                    <td className="border-b py-2">
                                      {data?.payload?.tech_lang_keys["pallets"]}{" "}
                                      {pallets_unit}
                                    </td>
                                  </tr>
                                </tbody>
