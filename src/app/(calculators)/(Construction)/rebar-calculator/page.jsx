...
import { useRebarCalculatorMutation } from "../../../../redux/services/datecalculator/dateCalculatorApi";
                ...
                <div>
                  ...
                  <div className="rounded-lg  flex items-center justify-center">
                    <div className="w-full  mt-3">
                      <div className="lg:w-[60%] md:lg:w-[60%] w-[100%] gap-2">
                        <div className="overflow-auto">
                          <table className="lg:text-[18px] w-full md:text-[18px] text-[14px]">
                            <tbody>
                              <tr>
