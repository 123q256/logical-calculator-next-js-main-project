                    ...
                    <div className="w-full mt-3">
                      <div className="w-full">
                        <div className="w-full text-[16px] overflow-auto">
                          ...
                          <div className="mt-3">
                            <BlockMath
                              math={`\\int\\limits_{${formData?.tech_lb}}^{${formData?.tech_ub}} (${result?.tech_enter})\\, d${formData?.tech_with}`}
                            />
                          </div>
                          <div className="mt-3">
                            <InlineMath
                              math={`= ${result?.tech_ress} \\approx ${Number(
                                result?.tech_ress1
                              ).toFixed(3)}`}
                            />
                          </div>
                          ...
                          <div className="mt-3">
                            <BlockMath
                              math={`\\int (${result?.tech_enter})\\, d${formData?.tech_with}`}
                            />
                          </div>
                          <div className="mt-3">
                            <BlockMath
                              math={`= \\left(${result?.tech_res}\\right) + \\mathrm{constant}`}
                            />
                          </div>
...
export default ShellMethodCalculator;
