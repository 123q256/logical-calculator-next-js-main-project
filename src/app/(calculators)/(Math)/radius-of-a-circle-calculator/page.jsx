...
const RadiusOfACircleCalculator = () => {
          ...
          <div className="lg:w-[40%] md:w-[70%] w-full mx-auto ">
            <div className="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
              ...
              {(formData.tech_operations == "1" ||
                ...
                <>
                  <div className="col-span-12" id="f_input">
                    {formData.tech_operations == "3" ? (
                      <>
                                ...
                                <>
                                  <tr>
                                    ...
                                    <td className="py-2 border-b">
                                      {Number(result?.tech_radius).toFixed(2)}{" "}
                                      cm
                                    </td>
                                  </tr>
                                </>
                              ...
                              {result?.tech_circum && (
                                <>
                                  <tr>
                                    ...
                                    <td className="py-2 border-b">
                                      {Number(result?.tech_circum).toFixed(2)}{" "}
                                      cm
                                    </td>
                                  </tr>
                                </>
                              ...
                              {result?.tech_area && (
                                <>
                                  <tr>
                                    ...
                                    <td className="py-2 border-b">
                                      {Number(result?.tech_area).toFixed(2)} cm²
                                    </td>
                                  </tr>
                                </>
                              )}
                              {result?.tech_diameter && (
                                <>
                                  <tr>
                                    <td className="py-2 border-b" width="40%">
                                      <strong>
                                    ...
                                    <td className="py-2 border-b">
                                      {Number(result?.tech_diameter).toFixed(2)}{" "}
                                      cm
                                    </td>
                                  </tr>
                                </>
...
export default RadiusOfACircleCalculator;
