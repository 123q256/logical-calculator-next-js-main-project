...
const FractionToDecimalCalculator = () => {
      ...
      <form className="row" onSubmit={handleSubmit}>
        <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg space-y-6 mb-3">
          ...
          <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
            <div className="flex grid-cols-1 lg:grid-cols-1 lg:flex-row justify-center items-center mt-3 w-full">
                      ...
                      <div className="row">
                        <div className="col-12 text-[16px] overflow-auto">
                          <p className="mt-3 text-[18px]">
                            <InlineMath
                              math={`${formData?.tech_n1 ?? ""} \\dfrac{${
                                formData?.tech_n2
                              }}{${formData?.tech_d1}} = ${result?.tech_ans}`}
                            />
                          </p>

                          {Number.isFinite(formData?.tech_n1) && (
                            <>
                              <p className="mt-3">
                                <strong>
                              ...
                              <p className="mt-3">
                                ...
                                <InlineMath
                                  math={`\\dfrac{${result?.tech_totalN}}{${result?.tech_totalD}}`}
                                />
                              </p>
                              <p className="mt-3">
                                ...
                                <InlineMath
                                  math={`\\dfrac{${
                                    result?.tech_totalN / result?.tech_g
                                  }}{${result?.tech_totalD / result?.tech_g}}`}
                                />
                              </p>
                              ...
                              {result?.tech_btm === "1" ? (
                                ...
                                <p className="mt-3">
                                  {data?.payload?.tech_lang_keys["an"]} ={" "}
                                  <InlineMath
                                    math={`\\dfrac{${result?.tech_upr}}{${result?.tech_btm}}`}
                                  />
                                </p>
                              )}
                                ...
                                (() => {
                                  ...
                                  return (
                                    <p className="mt-3">
                                      ...
                                      {shi}{" "}
                                      <InlineMath
                                        math={`\\dfrac{${bta}}{${result?.tech_btm}}`}
                                      />
                                    </p>
                                  );
                                })()}
                              ...
                              <p className="mt-3">
                                ...
                                {Number(
                                  (result?.tech_upr / result?.tech_btm).toFixed(
                                    4
                                  )
                                )}
                              </p>
