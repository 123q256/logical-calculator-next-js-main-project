            ...
            <div className="grid grid-cols-12  gap-2 md:gap-3 lg:gap-3">
              <div className="md:col-span-6 col-span-12">
                ...
                <div className="mt-2">
                  ...
                  >
                    <option value="log">
                      {data?.payload?.tech_lang_keys["log"]}
                    </option>
                    <option value="anti">
                      {data?.payload?.tech_lang_keys["anti"]}{" "}
                    </option>
                      ...
                      <div className="w-full flex justify-center">
                        <div className="w-full text-[20px]">
                          <p className="flex justify-center">
                            {formData?.tech_method == "anti"
                              ? data?.payload?.tech_lang_keys["anti"]
                              : formData?.tech_method == "ln"
                              ? "ln"
                              : data?.payload?.tech_lang_keys["log"]}
                          </p>
...
export default LogAndAntilogCalculator;
