...
const AdditiveInverseCalculator = () => {
                    ...
                    <div className="w-full mt-3">
                      <div className="w-full">
                        ...
                        <div className="w-full text-[16px]">
                          ...
                          <p className="mt-2">
                            Additive Inverse = (-1) x Number
                          </p>
                          <p className="mt-2">
                            Additive Inverse = (-1) x {formData?.tech_nbr}
                          </p>
                          <p className="mt-2">
                            Additive Inverse = {result?.tech_ans}
                          </p>
                        </div>
                      </div>
                    </div>
...
export default AdditiveInverseCalculator;
