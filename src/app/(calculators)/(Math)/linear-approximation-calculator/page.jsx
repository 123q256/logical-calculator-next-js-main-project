...
import { useGetSingleCalculatorDetailsMutation ,useLinearApproximationCalculatorMutation} from "../../../../redux/services/calculator/calculatorApi";
                ...
                <div className="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                    <div className="col-span-12">
                        ...
                        <div className="mt-2">
                          ...
                          >
                            <option value="1">{data?.payload?.tech_lang_keys["2"]} : y=f(x)</option>
                            <option value="2">{data?.payload?.tech_lang_keys["3"]} : x=x(t), y=y(t)</option>
                            <option value="3">{data?.payload?.tech_lang_keys["3"]} : r=r(t)</option>
                          </select>
                        </div>
                    </div>
                    <div className="col-span-12">
                      {(formData?.tech_type == "2" )  ? (
                        <>
                        <label htmlFor="tech_EnterEq" className="label">{data?.payload?.tech_lang_keys['4']}: x(t)</label>
                        </>
                      ): ( formData?.tech_type == "3") ? (
                        <>
                        <label htmlFor="tech_EnterEq" className="label">   {data?.payload?.tech_lang_keys['4']}: r(t)</label>
                        </>
                      ):(
                        <>
                        <label htmlFor="tech_EnterEq" className="label">    {data?.payload?.tech_lang_keys['4']}: y = f(x)</label>
                        </>
                      )}
                    ...
                    <div className="col-span-12">
                      ...
                      {(formData?.tech_type == "2" || formData?.tech_type == "3" )  ? (
                        <>
                        <label htmlFor="tech_point" className="label">  t =</label>
                        </>
                      ):(
                        <>
                        <label htmlFor="tech_point" className="label">  {data?.payload?.tech_lang_keys['5']}: x₀</label>
                        </>
                      )}
                            <div className=" relative">
                            <input
                          ...
                          <div className="w-full overflow-auto">
                              {(formData?.tech_type === "1") ? (
                                <>
                                 <div className="w-full text-[16px]">
                                    <p className="mt-2 text-[16px] md:text-[18px]">
                                      <strong>
                                        <InlineMath math={`L(x) \\approx ${result?.tech_res}`} />
                                      </strong>
                                    </p>
                                    ...
                                    <p className="mt-2">
                                      ...
                                      <InlineMath math={`L(x) \\approx f(x_0) + f'(x_0)(x - x_0)`} />
                                    </p>

                                    <p className="mt-2">
                                      {data?.payload?.tech_lang_keys['10']}:{' '}
                                      <InlineMath math={`y_0 = f(x_0) = ${result?.tech_fun}`} />
                                    </p>

                                    <p className="mt-2">
                                      {data?.payload?.tech_lang_keys['11']}:{' '}
                                      <InlineMath math={`f'(x) = ${result?.tech_deri}`} />
                                    </p>
                                    ...
                                    <p className="mt-2">
                                      {data?.payload?.tech_lang_keys['6']}: <InlineMath math={`L(x) \\approx ${result?.tech_res}`} />
                                    </p>
                                  </div>
                                </>
                              ): (formData?.tech_type === "2") ? (
                                ...
                                <div className="w-full text-[16px]">
                                    ...
                                    <p className="mt-2">
                                      {data?.payload?.tech_lang_keys['9']}{' '}
                                      <InlineMath math={`L(x) \\approx f(x_0) + \\left.\\frac{dy}{dx}\\right|_{x_0,y_0}(x - x_0)`} />
                                    </p>

                                    <p className="mt-2">
                                      {data?.payload?.tech_lang_keys['14']} <InlineMath math={`t`} />: <br />
                                      <InlineMath
                                    ...
                                    <p className="mt-2">
                                      {data?.payload?.tech_lang_keys['15']}: <InlineMath math={`\\left.\\frac{dy}{dx}\\right|_{t = ${formData?.tech_point}}`} />
                                    </p>

                                    <p className="mt-2">
                                      {data?.payload?.tech_lang_keys['16']}: <InlineMath math={`\\frac{dy}{dx} = \\frac{\\frac{dy}{dt}}{\\frac{dx}{dt}}`} />
                                    </p>

                                    <p className="mt-2">
                                      {data?.payload?.tech_lang_keys['17']} <InlineMath math={`t`} />:{' '}
                                      <InlineMath math={`\\frac{dx}{dt} = ${result?.tech_deri}`} />
                                    </p>

                                    <p className="mt-2">
                                      {data?.payload?.tech_lang_keys['18']} <InlineMath math={`t`} />:{' '}
                                      <InlineMath math={`\\frac{dy}{dt} = ${result?.tech_deri1}`} />
                                    </p>

                                    <p className="mt-2">
                                      {data?.payload?.tech_lang_keys['19']}: <InlineMath math={`\\frac{dy}{dx} = \\frac{${result?.tech_deri1}}{${result?.tech_deri}}`} />
                                    </p>
                                ...
                                <div className="w-full text-[16px]">
                                  <p className="mt-2 text-[16px] md:text-[18px]">
                                    <strong>
                                      <InlineMath math={`L(x) \\approx ${result?.tech_soc}x ${sign} ${result?.tech_final}`} />
                                    </strong>
                                  </p>
                                  ...
                                  <p className="mt-2">
                                    {data?.payload?.tech_lang_keys['8']}{' '}
                                    <InlineMath math={`r(t) = ${result?.tech_enter} \\text{ at } t = ${formData?.tech_point}`} />
                                  </p>

                                  <p className="mt-2">
                                    {data?.payload?.tech_lang_keys['9']}{' '}
                                    <InlineMath math={`L(x) \\approx y_0 + \\left.\\frac{dy}{dx}\\right|_{x_0,y_0}(x - x_0)`} />
                                  </p>

                                  <p className="mt-2">
                                    {data?.payload?.tech_lang_keys['10']}: <InlineMath math={`r(${formData?.tech_point}) = ${result?.tech_point}`} />
                                  </p>
                                  ...
                                  <p className="mt-2">
                                    {data?.payload?.tech_lang_keys['21']}: <InlineMath math={`\\frac{dy}{dx} = \\frac{\\frac{dr}{dt} \\sin(t) + r \\cos(t)}{\\frac{dr}{dt} \\cos(t) - r \\sin(t)}`} />
                                  </p>

                                  <p className="mt-2">
                                    {data?.payload?.tech_lang_keys['22']} <InlineMath math={`t`} />:{' '}
                                    <InlineMath math={`\\frac{dr}{dt} = ${result?.tech_deri}`} />
                                  </p>
                                  ...
                                  <p className="mt-2">
                                    {data?.payload?.tech_lang_keys['6']}: <InlineMath math={`L(x) \\approx ${result?.tech_soc}x ${sign} ${result?.tech_final}`} />
                                  </p>
                                </div>
                                </>
                              ) }
