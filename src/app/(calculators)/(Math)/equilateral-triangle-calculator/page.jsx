            ...
            <div className="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
              <div className="col-span-12">
                ...
                <div className="mt-2">
                  ...
                  >
                    <option value="side">
                      {data?.payload?.tech_lang_keys[2]} P, s, K, h |{" "}
                      {data?.payload?.tech_lang_keys[3]} a
                    </option>
                    <option value="perimeter">
                      {data?.payload?.tech_lang_keys[2]} a, s, K, h |{" "}
                      {data?.payload?.tech_lang_keys[3]} P
                    </option>
                    <option value="semiperimeter">
                      {data?.payload?.tech_lang_keys[2]} a, P, K, h |{" "}
                      {data?.payload?.tech_lang_keys[3]} s
                    </option>
                    <option value="area">
                      {data?.payload?.tech_lang_keys[2]} a, P, s, h |{" "}
                      {data?.payload?.tech_lang_keys[3]} K
                    </option>
                    <option value="altitude">
                      {data?.payload?.tech_lang_keys[2]} a, P, s, K |{" "}
                      {data?.payload?.tech_lang_keys[3]} h
                    </option>
                  </select>
                </div>
              </div>
                          ...
                          <table className="w-full text-[16px]">
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td className="py-2 border-b">
                                  {Number(result?.tech_k).toFixed(3)}{" "}
                                  {result?.tech_unit}
                                  <sup>2</sup>
                                </td>
                              </tr>
                              <tr>
                                ...
                                <td className="py-2 border-b">
                                  {Number(result?.tech_p).toFixed(3)}{" "}
                                  {result?.tech_unit}
                                </td>
                              </tr>
                              <tr>
                                ...
                                <td className="py-2 border-b">
                                  {Number(result?.tech_s).toFixed(3)}{" "}
                                  {result?.tech_unit}
                                </td>
                              </tr>
                              <tr>
                                ...
                                <td className="py-2 border-b">
                                  {Number(result?.tech_h).toFixed(3)}{" "}
                                  {result?.tech_unit}
                                </td>
                              </tr>
                            </tbody>
