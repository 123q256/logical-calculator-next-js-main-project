...
const FactorialCalculator = () => {
  ...
  const [formData, setFormData] = useState({
    tech_to_calculate: "f", // f  af  sf  mf   df
    tech_nvalue: "5",
    tech_mvalue: "7",
  });
        ...
        <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-l3 space-y-6 mb-3">
          ...
          <div className="lg:w-[40%] md:w-[60%] w-full mx-auto ">
            <div className="grid grid-cols-1    gap-4">
              ...
              <div className="space-y-2">
                <label htmlFor="tech_nvalue" className="label">
                  n
                </label>
                <div className=" relative">
                  <input
                    ...
                    aria-label="input"
                    placeholder="00"
                    value={formData.tech_nvalue}
                    onChange={handleChange}
                  />
                </div>
              </div>

              {formData.tech_to_calculate != "f" && (
                <>
                  <div className="space-y-2">
                    <label htmlFor="tech_mvalue" className="label">
                      m
                    </label>
                    <div className=" relative">
                      <input
                      ...
                      <div className="w-full">
                        ...
                        result?.tech_fa != "INF" ? (
                          <>
                            ...
                            <div className="col-12 font-s-16 mt-2">
                              <p>
                                <strong>
                              ...
                              <p className="mt-2">
                                n = {formData?.tech_nvalue}
                              </p>
                              <p className="mt-2">n ! = {result?.tech_a}</p>
                              <p className="mt-2">n ! = {result?.tech_fa}</p>
                            </div>
                          </>
                        ) : formData?.tech_to_calculate == "af" &&
                          result?.tech_add != "INF" ? (
                          <>
                            ...
                            <div className="col-12 font-s-16 mt-2">
                              ...
                              <p className="mt-2">
                                m = {formData?.tech_mvalue}
                              </p>
                              <p className="mt-2">n ! = {result?.tech_a}</p>
                              <p className="mt-2">n ! = {result?.tech_fa}</p>
                              <p className="mt-2">m ! = {result?.tech_b}</p>
                              <p className="mt-2">m ! = {result?.tech_fam}</p>
                              <p className="mt-2">
                                n ! + m ! = {result?.tech_fa} +{" "}
                                {result?.tech_fam}
                              </p>
                          ...
                          <>
                            ...
                            <div className="col-12 font-s-16 mt-2">
                              ...
                              <p className="mt-2">m ! = {result?.tech_fam}</p>
                              <p className="mt-2">
                                n !- m ! = {result?.tech_fa}- {result?.tech_fam}
                              </p>
                              <p className="mt-2">
                                n ! - m ! = {result?.tech_sub}
                              </p>
                          ...
                          <>
                            ...
                            <div className="col-12 font-s-16 mt-2">
                              ...
                              <p className="mt-2">m ! = {result?.tech_fam}</p>
                              <p className="mt-2">
                                n ! x m ! = {result?.tech_fa} x{" "}
                                {result?.tech_fam}
                              </p>
                              <p className="mt-2">
                                n ! x m ! = {result?.tech_mul}
                              </p>
                            </div>
                          </>
                        ) : (
