...
const RadiusOfConvergenceCalculator = () => {
                    ...
                    <div className="w-full mt-3">
                      <div className="w-full">
                        <div className="w-full text-[18px]">
                          {/* Agar aapke paas raw HTML hai to use dangerouslySetInnerHTML karen */}
                          <div
                            dangerouslySetInnerHTML={{
                              __html: result?.tech_specificHtml,
                            }}
                          />

                          <div className="w-full md:w-[60%] lg:w-[60%] mt-2 px-2 py-1 overflow-auto">
                          ...
                          <div className="overflow-auto w-full">
                            ...
                            <div className="bg-sky bordered rounded-lg px-3 py-2 mt-2 text-[18px] overflow-auto text-center">
                              <InlineMath>{`\\left|${result?.tech_ans}\\right| \\le 1`}</InlineMath>
                            </div>
                            ...
                            <div className="my-3 font-s-20">
                              <BlockMath>{`\\sum_{n=1}^\\infty ${result?.tech_enter}`}</BlockMath>
                            </div>
                            ...
                            <p className="my-3">
                              {data?.payload?.tech_lang_keys[7]} L &lt; 1:
                            </p>

                            <div className="my-3 font-s-20">
                              <BlockMath>{`L=\\lim_{n \\to \\infty}\\left|\\dfrac{a_{n+1}}{a_n}\\right|`}</BlockMath>
                            </div>

                            <p className="my-3">
                              <InlineMath>{`a_n=${result?.tech_enter}`}</InlineMath>
                            </p>

                            <div className="my-3 font-s-20">
                              {/* Replace 'n' with 'n+1' in the formula */}
                              <BlockMath>{`L=\\lim_{n \\to \\infty}\\left|\\dfrac{${result?.tech_enter.replace(
                                /n/g,
                                "n+1"
                              )}}{${result?.tech_enter}}\\right|`}</BlockMath>
                            </div>

                            <div className="overflow-auto">
                              <div className="mb-3 mt-4 font-s-20">
                                <BlockMath>{`L=\\lim_{n \\to \\infty}\\left|${result?.tech_equs}\\right|`}</BlockMath>
                              </div>
                            </div>
                            ...
                            <div className="my-3">
                              <InlineMath>{`L=\\left|${result?.tech_ans}\\right|`}</InlineMath>
                            </div>
...
export default RadiusOfConvergenceCalculator;
