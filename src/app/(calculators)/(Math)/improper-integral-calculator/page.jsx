...
const ImproperIntegralCalculator = () => {
  ...
  const isInf = (val) => val === "inf" || val === "-inf";
  const limText = (val) => val.replace("inf", "infty");
                    ...
                    <div className="w-full mt-3">
                      <div className="w-full text-[16px] overflow-auto">
                        <p className="mt-3 text-[18px]">
                          <InlineMath
                            math={`${result?.tech_res1} = ${result?.tech_ans}`}
                          />
                        </p>

                        {!Number(result?.tech_ans) && (
                          <p className="mt-3">
                        ...
                        <p className="mt-3">
                          ...
                          <InlineMath math={result?.tech_res1} />
                        </p>
                        ...
                        <p className="mt-3">
                          <InlineMath
                            math={`${result?.tech_int} = ${result?.tech_res}`}
                          />{" "}
                        ...
                        {isInf(formData?.tech_lb) ? (
                          <p className="mt-3">
                            <InlineMath
                              math={`\\lim_{x \\to ${limText(
                                formData?.tech_lb
                              )}} \\left(${result?.tech_res}\\right) = ${
                                result?.tech_first
                              }`}
                            />
                          </p>
                          ...
                          <p className="mt-3">
                            <InlineMath
                              math={`\\left(${result?.tech_res}\\right)|_{${withVar}=${formData?.tech_lb}} = ${result?.tech_first}`}
                            />
                          </p>
                        )}

                        {isInf(formData?.tech_ub) ? (
                          <p className="mt-3">
                            <InlineMath
                              math={`\\lim_{x \\to ${limText(
                                formData?.tech_ub
                          ...
                          <p className="mt-3">
                            <InlineMath
                              math={`\\left(${result?.tech_res}\\right)|_{${withVar}=${formData?.tech_ub}} = ${result?.tech_sec}`}
                            />
                          </p>
                        )}
                        ...
                        <p className="mt-3">
                          <InlineMath
                            math={`${result?.tech_res1} = \\left(${
                              isInf(formData?.tech_lb)
                                ? `\\lim_{x \\to ${limText(
                                    formData?.tech_lb
                                  )}}\\left(${result?.tech_res}\\right)`
                                : `\\left(${result?.tech_res}\\right)|_{${withVar}=${formData?.tech_lb}}`
                            }\\right) - \\left(${
                              isInf(formData?.tech_ub)
                                ? `\\lim_{x \\to ${limText(
                                    formData?.tech_ub
                                  )}}\\left(${result?.tech_res}\\right)`
                                : `\\left(${result?.tech_res}\\right)|_{${withVar}=${formData?.tech_ub}}`
                            }\\right) = ${result?.tech_ans}`}
                          />
                        </p>
...
export default ImproperIntegralCalculator;
