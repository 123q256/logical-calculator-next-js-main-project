...
const DistanceBetweenTwoPointsCalculator = () => {
  ...
  const dxSq = Math.pow(dx, 2);
  const dySq = Math.pow(dy, 2);
  const dSqSum = dxSq + dySq;
  return (
    <Calculator
      isLoading={isLoading}
      data={data}
                      ...
                      <div className="w-full">
                        <div className="w-full md:w-[60%] lg:w-[60%] mt-2 overflow-auto">
                          <table className="w-full text-[16px]">
                            <tbody>
                              <tr>
                                <td className="py-2 border-b w-[60%] font-semibold">
                        ...
                        <div className="w-full text-[17px] overflow-auto">
                          ...
                          <p className="mt-2">
                            <InlineMath
                              math={`d = \\sqrt{(${dx})^2 + (${dy})^2}`}
                            />
                          </p>

                          <p className="mt-2">
                            <InlineMath
                              math={`d = \\sqrt{${dxSq} + ${dySq}}`}
                            />
                          </p>

                          <p className="mt-2">
                            <InlineMath math={`d = \\sqrt{${dSqSum}}`} />
                          </p>

                          <p className="mt-2">d = {result?.tech_ans}</p>
                        </div>
                      </div>
                    </div>
                  </div>
...
export default DistanceBetweenTwoPointsCalculator;
