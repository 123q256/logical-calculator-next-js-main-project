...
import { useGetSingleCalculatorDetailsMutation ,useDistanceFormulaCalculatorMutation} from "../../../../redux/services/calculator/calculatorApi";
       ...
       <form className="row" onSubmit={handleSubmit}>
          <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg  space-y-6 mb-3">
            ...
            <div className="lg:w-[60%] md:w-[60%] w-full mx-auto ">
                <div className="grid grid-cols-2  lg:grid-cols-2 md:grid-cols-2  gap-4">
                    <div className="space-y-2">
                      ...
                      <div className="mt-2">
                        ...
                        >
                          <option value="2P">2 {data?.payload?.tech_lang_keys["point"]} </option>
                          <option value="3P">3 {data?.payload?.tech_lang_keys["point"]} </option>
                          <option value="PS">{data?.payload?.tech_lang_keys["sl"]} </option>
                          <option value="PL">{data?.payload?.tech_lang_keys["pl"]} </option>
                        </select>
                      </div>
                    </div>
                    <div className="space-y-2 dimen">
                        ...
                        <div className="mt-2">
                          <select
                             className={`input ${formData.tech_type === "PS" || formData.tech_type === "PL" ? "cursor-not-allowed bg-gray-200" : ""}`}
                            aria-label="select"
                            name="tech_dimen"
                            id="tech_dimen"
                              disabled={formData.tech_type === "PS" || formData.tech_type === "PL"} // disable condition
                ...
                {((formData.tech_type == "PS") || (formData.tech_type == "2P" && formData.tech_dimen == "2D") || (formData.tech_type == "3P" && formData.tech_dimen == "2D")) && (
                  <>
                  
                  <div className="grid grid-cols-1 mt-2  gap-4 threepoint2d twopoint2d sline">
                      <p className="text-[14px] text-blue-800 py-2">{data?.payload?.tech_lang_keys['f_point']}:</p>
                  </div>
                ...
                {(formData.tech_type == "PL" || formData.tech_type == "PS") && (
                  ...
                  <div className="grid grid-cols-1 mt-2  gap-4 sline pline">
                      <p className="text-[14px] text-blue-800 py-2">{data?.payload?.tech_lang_keys['line']} [y = mx + b]:</p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 mt-2  gap-4 pline">
                      <p className="py-2 text-[14px] text-blue-800">{data?.payload?.tech_lang_keys['sline']} [y = m₂x + b₂]:</p>
                  </div>
                  <div className="grid grid-cols-2 mt-2  gap-4 pline">
                   ...
                   {((formData.tech_type == "2P" && formData.tech_dimen == "3D") || (formData.tech_type == "3P" && formData.tech_dimen == "3D")) && (
                  <>
                  <div className="grid grid-cols-1 mt-2  gap-4 twopoint3d">
                      <p className="py-2 text-[14px] text-blue-800">{data?.payload?.tech_lang_keys['f_point']}:</p>
                  </div>
                  <div className="grid grid-cols-3 mt-2  gap-4 twopoint3d">
                    ...
                    {((formData.tech_type == "2P" && formData.tech_dimen == "4D") || (formData.tech_type == "3P" && formData.tech_dimen == "4D")) && (
                    <>
                  ...
                  {( (formData.tech_type == "2P" && formData.tech_dimen == "2D") || (formData.tech_type == "3P" && formData.tech_dimen == "2D")) && (
                  <>
                    <div className="grid grid-cols-1 mt-2  gap-4 twopoint2d">
                        <p className="py-2 text-[14px] text-blue-800">{data?.payload?.tech_lang_keys['s_point']}:</p>
                    </div>
                  ...
                  {(formData.tech_type == "3P" && formData.tech_dimen == "2D") && (
                    <>
                      <div className="grid grid-cols-1 mt-2  gap-4 threepoint2d">
                          <p className="py-2 text-[14px] text-blue-800">{data?.payload?.tech_lang_keys['t_point']}:</p>
                      </div>
                  ...
                  <div>
                    <ResultActions lang={data?.payload?.tech_lang_keys} />
                      ...
                      <div className="rounded-lg   items-center justify-center">
                        <div className="w-full  bg-light-blue p-3 radius-10 mt-3 text-[14px] md:text-[18px] overflow-auto">
                            {(formData?.tech_type=='PS') && (
                              <>
                                <p className="font-s-25">
                                  {data?.payload?.tech_lang_keys['dis']} = <strong className="text-blue">{result?.tech_ans}</strong>
                                </p>
                                <p className="font-s-20 text-start font-bold">{data?.payload?.tech_lang_keys['sol']}:</p>
                                <p className="mt-2">(x₁ , y₁) = ({formData?.tech_x1}, {formData?.tech_y1})</p>
                                <p className="mt-2">(m , b) = ({formData?.tech_m}, {formData?.tech_b})</p>

                                <BlockMath math={`d = \\frac{|mx_1 - y_1 + b|}{\\sqrt{m^2 + 1^2}}`} />
                                ...
                                <BlockMath
                                  math={`d = \\frac{|${formData?.tech_m * formData?.tech_x1} - ${formData?.tech_y1} + ${formData?.tech_b}|}{\\sqrt{${formData?.tech_m}^2 + 1}}`}
                                />

                                <BlockMath
                                  math={`d = \\frac{${Math.abs(
                                    formData?.tech_m * formData?.tech_x1 - formData?.tech_y1 + formData?.tech_b
                                  )}}{${Math.sqrt(Math.pow(formData?.tech_m, 2) + 1).toFixed(4)}}`}
                                />
                             ...
                             {(formData?.tech_type=='PL') && (
                              <>
                                ...
                                <p className="font-s-20 text-start font-bold">{data?.payload?.tech_lang_keys['sol']}:</p>
                                <p className="mt-2">(m₂ , b₂) = ({m2}, {b2})</p>
                                <p className="mt-2">(m , b) = ({m}, {b})</p>

                                <BlockMath math={`d = \\frac{b_2 - b}{\\sqrt{m^2 + 1^2}}`} />

                                <BlockMath math={`d = \\frac{${b2} - ${b}}{\\sqrt{${m}^2 + 1^2}}`} />

                                <BlockMath math={`d = \\frac{${b2} - ${b}}{\\sqrt{${Math.pow(m, 2)}} + 1}`} />

                                <BlockMath math={`d = \\frac{${b2} - ${b}}{${denominator.toFixed(4)}}`} />
                             ...
                             {(formData?.tech_type=='2P' && formData?.tech_dimen=='1D') && (
                              <>
                                ...
                                <p className="font-s-20 text-start">
                                  <strong>{data?.payload?.tech_lang_keys['sol']}:</strong>
                                </p>
                                <p className="mt-2">
                                  (x₁ , x₂) = ({formData?.tech_2px1}, {formData?.tech_2px2})
                                </p>
                                <p className="mt-2">
                                  <InlineMath math={`d = \\sqrt{(x_2 - x_1)^2}`} />
                                </p>
                                <p className="mt-2">
                                  <InlineMath math={`d = \\sqrt{(${formData?.tech_2px2} - (${formData?.tech_2px1}))^2}`} />
                                </p>
                                <p className="mt-2">
                                  <InlineMath math={`d = \\sqrt{(${formData?.tech_2px2 - formData?.tech_2px1})^2}`} />
                                </p>
                             ...
                             {(formData?.tech_type=='2P' && formData?.tech_dimen=='2D') && (
                              ...
                              <p className="mt-2">
                                (x₁ , x₂) = ({formData?.tech_x1}, {formData?.tech_x2})
                              </p>
                              <p className="mt-2">
                                (y₁ , y₂) = ({formData?.tech_y1}, {formData?.tech_y2})
                              </p>
                              ...
                              <p className="mt-2">
                                <InlineMath math={`d = \\sqrt{(${formData?.tech_x2} - ${formData?.tech_x1})^2 + (${formData?.tech_y2} - ${formData?.tech_y1})^2}`} />
                              </p>
                              <p className="mt-2">
                                <InlineMath math={`d = \\sqrt{(${formData?.tech_x2 - formData?.tech_x1})^2 + (${formData?.tech_y2 - formData?.tech_y1})^2}`} />
                              </p>
                              <p className="mt-2">
                                <InlineMath math={`d = \\sqrt{${Math.pow(formData?.tech_x2 - formData?.tech_x1, 2)} + ${Math.pow(formData?.tech_y2 - formData?.tech_y1, 2)}}`} />
                              </p>
                              <p className="mt-2">
                                <InlineMath math={`d = \\sqrt{${Math.pow(formData?.tech_x2 - formData?.tech_x1, 2) + Math.pow(formData?.tech_y2 - formData?.tech_y1, 2)}}`} />
                              </p>
                             ...
                             {(formData?.tech_type=='2P' && formData?.tech_dimen=='3D') && (
                              ...
                              <p className="mt-2">
                                (x₁ , x₂) = ({formData?.tech_3x1}, {formData?.tech_3x2})
                              </p>
                              <p className="mt-2">
                                (y₁ , y₂) = ({formData?.tech_3y1}, {formData?.tech_3y2})
                              </p>
                              <p className="mt-2">
                                (z₁ , z₂) = ({formData?.tech_3z1}, {formData?.tech_3z2})
                              </p>
                              ...
                              <p className="mt-2">
                                <InlineMath math={`d = \\sqrt{(${formData?.tech_3x2} - ${formData?.tech_3x1})^2 + (${formData?.tech_3y2} - ${formData?.tech_3y1})^2 + (${formData?.tech_3z2} - ${formData?.tech_3z1})^2}`} />
                              </p>
                              <p className="mt-2">
                                <InlineMath math={`d = \\sqrt{(${formData?.tech_3x2 - formData?.tech_3x1})^2 + (${formData?.tech_3y2 - formData?.tech_3y1})^2 + (${formData?.tech_3z2 - formData?.tech_3z1})^2}`} />
                              </p>
                              <p className="mt-2">
                                <InlineMath math={`d = \\sqrt{${Math.pow(formData?.tech_3x2 - formData?.tech_3x1, 2)} + ${Math.pow(formData?.tech_3y2 - formData?.tech_3y1, 2)} + ${Math.pow(formData?.tech_3z2 - formData?.tech_3z1, 2)}}`} />
                              </p>
                              <p className="mt-2">
                                <InlineMath math={`d = \\sqrt{${Math.pow(formData?.tech_3x2 - formData?.tech_3x1, 2) + Math.pow(formData?.tech_3y2 - formData?.tech_3y1, 2) + Math.pow(formData?.tech_3z2 - formData?.tech_3z1, 2)}}`} />
                              </p>
                             ...
                             {(formData?.tech_type=='2P' && formData?.tech_dimen=='4D') && (
                              <>
                                <p className="font-s-25">
                                  ...
                                  <strong className="text-blue">{result?.tech_ans}</strong>
                                </p>
                                <p className="font-s-20 text-start">
                                  <strong>{data?.payload?.tech_lang_keys["sol"]}:</strong>
                                </p>
                                <p className="mt-2">
                                  (x₁, x₂) = ({formData?.tech_4x1}, {formData?.tech_4x2})
                                </p>
                                <p className="mt-2">
                                  (y₁, y₂) = ({formData?.tech_4y1}, {formData?.tech_4y2})
                                </p>
                                <p className="mt-2">
                                  (z₁, z₂) = ({formData?.tech_4z1}, {formData?.tech_4z2})
                                </p>
                                <p className="mt-2">
                                  (k₁, k₂) = ({formData?.tech_4k1}, {formData?.tech_4k2})
                                </p>
                             ...
                             {(formData?.tech_type=='3P' && formData?.tech_dimen=='1D') && (
                              ...
                              <strong className="text-blue">{result?.tech_ans1}</strong>
                            </p>
                            <p className="font-s-25">
                              {data?.payload?.tech_lang_keys["dis"]}(3-2) ={" "}
                              <strong className="text-blue">{result?.tech_ans2}</strong>
                            </p>
                            <p className="font-s-25">
                              {data?.payload?.tech_lang_keys["dis"]}(1-3) ={" "}
                              <strong className="text-blue">{result?.tech_ans3}</strong>
                            </p>
                            ...
                            <p className="mt-2">
                              (x₁, x₂, x₃) = (
                              {formData?.tech_3px1}, {formData?.tech_3px2}, {formData?.tech_3px3})
                            </p>

                            {/* Distance 1-2 */}
                            <BlockMath math={`d_{(1-2)} = \\sqrt{(x_2 - x_1)^2}`} />
                            <BlockMath math={`d_{(1-2)} = \\sqrt{(${formData?.tech_3px2} - (${formData?.tech_3px1}))^2}`} />
                            <BlockMath math={`d_{(1-2)} = \\sqrt{(${formData?.tech_3px2 - formData?.tech_3px1})^2}`} />
                            <InlineMath math={`d_{(1-2)} = ${result?.tech_ans1}`} />

                            {/* Distance 3-2 */}
                            <div className="mt-3" />
                            <BlockMath math={`d_{(3-2)} = \\sqrt{(x_3 - x_2)^2}`} />
                            <BlockMath math={`d_{(3-2)} = \\sqrt{(${formData?.tech_3px3} - (${formData?.tech_3px2}))^2}`} />
                            <BlockMath math={`d_{(3-2)} = \\sqrt{(${formData?.tech_3px3 - formData?.tech_3px2})^2}`} />
                            <InlineMath math={`d_{(3-2)} = ${result?.tech_ans2}`} />

                            {/* Distance 1-3 */}
                            <div className="mt-3" />
                            <BlockMath math={`d_{(1-3)} = \\sqrt{(x_3 - x_1)^2}`} />
                            <BlockMath math={`d_{(1-3)} = \\sqrt{(${formData?.tech_3px3} - (${formData?.tech_3px1}))^2}`} />
                            <BlockMath math={`d_{(1-3)} = \\sqrt{(${formData?.tech_3px3 - formData?.tech_3px1})^2}`} />
                            <InlineMath math={`d_{(1-3)} = ${result?.tech_ans3}`} />
                             ...
                             <p className="font-s-25">
                              ...
                              <p className="mt-2">
                                (x₁, y₁) = ({formData?.tech_x1}, {formData?.tech_y1})
                              </p>
                              <p className="mt-2">
                                (x₂, y₂) = ({formData?.tech_x2}, {formData?.tech_y2})
                              </p>
                              <p className="mt-2">
                                (x₃, y₃) = ({formData?.tech_x3}, {formData?.tech_y3})
                              </p>

                              {/* Distance 1-2 */}
                              <BlockMath math={`d_{(1-2)} = \\sqrt{(x_2 - x_1)^2 + (y_2 - y_1)^2}`} />
                              <BlockMath
                              ...
                              {/* Distance 3-2 */}
                              <div className="mt-3" />
                              <BlockMath math={`d_{(3-2)} = \\sqrt{(x_3 - x_2)^2 + (y_3 - y_2)^2}`} />
                              <BlockMath
                              ...
                              {/* Distance 1-3 */}
                              <div className="mt-3" />
                              <BlockMath math={`d_{(1-3)} = \\sqrt{(x_3 - x_1)^2 + (y_3 - y_1)^2}`} />
                              <BlockMath
                            ...
                            {(formData?.tech_type=='3P' && formData?.tech_dimen=='3D') && (
                              ...
                              <p className="mt-2">
                                (x₁, y₁, z₁) = ({formData?.tech_3x1}, {formData?.tech_3y1}, {formData?.tech_3z1})
                              </p>
                              <p className="mt-2">
                                (x₂, y₂, z₂) = ({formData?.tech_3x2}, {formData?.tech_3y2}, {formData?.tech_3z2})
                              </p>
                              <p className="mt-2">
                                (x₃, y₃, z₃) = ({formData?.tech_3x3}, {formData?.tech_3y3}, {formData?.tech_3z3})
                              </p>

                              {/* Distance 1-2 */}
                              <BlockMath math={`d_{(1-2)} = \\sqrt{(x_2 - x_1)^2 + (y_2 - y_1)^2 + (z_2 - z_1)^2}`} />
                              <BlockMath
                              ...
                              {/* Distance 3-2 */}
                              <div className="mt-3" />
                              <BlockMath math={`d_{(3-2)} = \\sqrt{(x_3 - x_2)^2 + (y_3 - y_2)^2 + (z_3 - z_2)^2}`} />
                              <BlockMath
                              ...
                              {/* Distance 1-3 */}
                              <div className="mt-3" />
                              <BlockMath math={`d_{(1-3)} = \\sqrt{(x_3 - x_1)^2 + (y_3 - y_1)^2 + (z_3 - z_1)^2}`} />
                              <BlockMath
                             ...
                             {((formData?.tech_type=='3P' && formData?.tech_dimen=='4D')) && (
                              <>
                              <p className="font-s-25">
                                  {data?.payload?.tech_lang_keys['dis']}(1-2) = <strong className="text-blue">{result?.tech_ans1}</strong>
                                </p>
                                <p className="font-s-25">
                                  {data?.payload?.tech_lang_keys['dis']}(3-2) = <strong className="text-blue">{result?.tech_ans2}</strong>
                                </p>
                                <p className="font-s-25">
                                  {data?.payload?.tech_lang_keys['dis']}(1-3) = <strong className="text-blue">{result?.tech_ans3}</strong>
                                </p>

                                <p className="font-s-20 text-start font-bold">{data?.payload?.tech_lang_keys['sol']}:</p>

                                <p className="mt-2">
                                  (x₁ , y₁ , z₁ , k₁) = ({formData?.tech_4x1}, {formData?.tech_4y1}, {formData?.tech_4z1}, {formData?.tech_4k1})
                                </p>
                                <p className="mt-2">
                                  (x₂ , y₂ , z₂ , k₂) = ({formData?.tech_4x2}, {formData?.tech_4y2}, {formData?.tech_4z2}, {formData?.tech_4k2})
                                </p>
                                <p className="mt-2">
                                  (x₃ , y₃ , z₃ , k₃) = ({formData?.tech_4x3}, {formData?.tech_4y3}, {formData?.tech_4z3}, {formData?.tech_4k3})
                                </p>

                                <BlockMath math={`d(1-2) = \\sqrt{(x_2 - x_1)^2 + (y_2 - y_1)^2 + (z_2 - z_1)^2 + (k_2 - k_1)^2}`} />
                                <BlockMath math={`d(1-2) = \\sqrt{(${formData?.tech_4x2} - ${formData?.tech_4x1})^2 + (${formData?.tech_4y2} - ${formData?.tech_4y1})^2 + (${formData?.tech_4z2} - ${formData?.tech_4z1})^2 + (${formData?.tech_4k2} - ${formData?.tech_4k1})^2}`} />
                                <BlockMath math={`d(1-2) = \\sqrt{(${formData?.tech_4x2 - formData?.tech_4x1})^2 + (${formData?.tech_4y2 - formData?.tech_4y1})^2 + (${formData?.tech_4z2 - formData?.tech_4z1})^2 + (${formData?.tech_4k2 - formData?.tech_4k1})^2}`} />
                                <BlockMath math={`d(1-2) = ${result?.tech_ans1}`} />

                                <BlockMath math={`d(3-2) = \\sqrt{(x_3 - x_2)^2 + (y_3 - y_2)^2 + (z_3 - z_2)^2 + (k_3 - k_2)^2}`} />
                                <BlockMath math={`d(3-2) = \\sqrt{(${formData?.tech_4x3} - ${formData?.tech_4x2})^2 + (${formData?.tech_4y3} - ${formData?.tech_4y2})^2 + (${formData?.tech_4z3} - ${formData?.tech_4z2})^2 + (${formData?.tech_4k3} - ${formData?.tech_4k2})^2}`} />
                                <BlockMath math={`d(3-2) = \\sqrt{(${formData?.tech_4x3 - formData?.tech_4x2})^2 + (${formData?.tech_4y3 - formData?.tech_4y2})^2 + (${formData?.tech_4z3 - formData?.tech_4z2})^2 + (${formData?.tech_4k3 - formData?.tech_4k2})^2}`} />
                                <BlockMath math={`d(3-2) = ${result?.tech_ans2}`} />

                                <BlockMath math={`d(1-3) = \\sqrt{(x_3 - x_1)^2 + (y_3 - y_1)^2 + (z_3 - z_1)^2 + (k_3 - k_1)^2}`} />
                                <BlockMath math={`d(1-3) = \\sqrt{(${formData?.tech_4x3} - ${formData?.tech_4x1})^2 + (${formData?.tech_4y3} - ${formData?.tech_4y1})^2 + (${formData?.tech_4z3} - ${formData?.tech_4z1})^2 + (${formData?.tech_4k3} - ${formData?.tech_4k1})^2}`} />
                                <BlockMath math={`d(1-3) = \\sqrt{(${formData?.tech_4x3 - formData?.tech_4x1})^2 + (${formData?.tech_4y3 - formData?.tech_4y1})^2 + (${formData?.tech_4z3 - formData?.tech_4z1})^2 + (${formData?.tech_4k3 - formData?.tech_4k1})^2}`} />
