                  ...
                  <div className="rounded-lg flex items-center justify-center">
                    <div className="w-full mt-3">
                      <div className="flex flex-col items-center">
                        <div className="w-full text-center text-[18px] overflow-auto">
                          <p>{data?.payload?.tech_lang_keys[8]}</p>
                          <div className="mb-3 mt-4  px-3 text-[20px] rounded-lg  max-w-[90%] mx-auto">
                            <BlockMath
...
export default PowerSeriesCalculator;
