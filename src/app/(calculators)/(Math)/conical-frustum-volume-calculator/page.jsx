...
import { useConicalFrustumVolumeCalculatorMutation } from "../../../../redux/services/datecalculator/dateCalculatorApi";
                ...
                <div className="grid grid-cols-12 mt-3 gap-2">
                  <div className="col-span-12">
                    ...
                    <div className="mt-2">
                      ...
                      >
                        <option value="r_h">
                          {data?.payload?.tech_lang_keys["2"]} s, V, L, A |{" "}
                          {data?.payload?.tech_lang_keys["3"]} r1, r2, s{" "}
                        </option>
                        <option value="r_sh">
                          {data?.payload?.tech_lang_keys["2"]} h, V, L, A |{" "}
                          {data?.payload?.tech_lang_keys["3"]} r1, r2, V{" "}
                        </option>
                        <option value="r_v">
                          {data?.payload?.tech_lang_keys["2"]} h, s, L, A |{" "}
                          {data?.payload?.tech_lang_keys["3"]} V, l, w{" "}
                        </option>
                        <option value="r_l">
                          {data?.payload?.tech_lang_keys["2"]} h, s, V, A |{" "}
                          {data?.payload?.tech_lang_keys["3"]} r1, r2, L{" "}
                        </option>
                        <option value="r_a">
                          {data?.payload?.tech_lang_keys["2"]} h, s, V, L |{" "}
                          {data?.payload?.tech_lang_keys["3"]} r1, r2, A{" "}
                        </option>
                      </select>
                    </div>
                  </div>
              ...
              <div className="md:col-span-6 col-span-12">
                <div className="grid grid-cols-12 mt-3   gap-2 ">
                  <div className=" col-span-12 text-center mt-3 items-center justify-center hidden md:block">
                    <img
                      src="/images/new_volume_rec.webp"
                      height="100%"
                      width="80%"
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td className="py-2 border-b">
                                  {result?.tech_radius_1} {formData?.tech_units}
                                </td>
                              </tr>
                              <tr>
                                <td className="py-2 border-b" width="60%">
                                ...
                                <td className="py-2 border-b">
                                  {result?.tech_radius_2} {formData?.tech_units}
                                </td>
                              </tr>
                              <tr>
                                <td className="py-2 border-b" width="60%">
                                ...
                                <td className="py-2 border-b">
                                  {result?.tech_height} {formData?.tech_units}
                                </td>
                              </tr>
                              <tr>
                                <td className="py-2 border-b" width="60%">
                              ...
                              <tr>
                                ...
                                <td className="py-2 border-b">
                                  {result?.tech_lsa} {formData?.tech_units}
                                </td>
                              </tr>
                              <tr>
                                <td className="py-2 border-b" width="60%">
                                ...
                                <td className="py-2 border-b">
                                  {result?.tech_tsa} {formData?.tech_units}
                                </td>
                              </tr>
                              <tr>
                                <td className="py-2 border-b" width="60%">
                                ...
                                <td className="py-2 border-b">
                                  {result?.tech_bsa} {formData?.tech_units}
                                </td>
                              </tr>
                              <tr>
                                <td className="py-2 border-b" width="60%">
                                ...
                                <td className="py-2 border-b">
                                  {result?.tech_ttsa} {formData?.tech_units}
                                </td>
                              </tr>
                            </tbody>
                          </table>
