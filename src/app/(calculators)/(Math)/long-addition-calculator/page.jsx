                        ...
                        <table className="w-full text-[16px]">
                          <tbody>
                            ...
                            <tr>
                              <td className="py-2 border-b" width="50%">
                                <strong>
                                  {data?.payload?.tech_lang_keys["how"]}
                                </strong>
                              </td>
                              <td className="py-2 border-b">
                                {result?.tech_total_nbr !== undefined
                                  ? result.tech_total_nbr
                                  : "00"}
                              </td>
                            </tr>
                            <tr>
                              <td className="py-2 border-b" width="50%">
                                <strong>
                                  {data?.payload?.tech_lang_keys["nbrs"]}
                                </strong>
                              </td>
                              <td className="py-2 border-b">
                                {result?.tech_numbers !== undefined
                                  ? result.tech_numbers
                                  : "00"}
                              </td>
                            </tr>
...
export default LongAdditionCalculator;
