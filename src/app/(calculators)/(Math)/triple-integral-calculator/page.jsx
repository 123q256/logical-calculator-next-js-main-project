...
const TripleIntegralCalculator = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await calculateEbitCalculator({
        ...
        tech_ubz: formData.tech_ubz,
        tech_lbz: formData.tech_lbz,
      }).unwrap();
  ...
  const exampleLoadHandler = () => {
    ...
    setFormData((prev) => ({
      ...
      tech_ubz: getRandomInt(),
      tech_lbz: getRandomInt(),
    }));
                    ...
                    <div className="w-full mt-3">
                      <div className="w-full">
                        <div className="w-full text-[16px] overflow-auto">
                          <p className="mt-3 font-s-18 font-bold">
                            {data?.payload?.tech_lang_keys["8"]}
                          </p>
                          <p
                            className="mt-3 font-s-18"
