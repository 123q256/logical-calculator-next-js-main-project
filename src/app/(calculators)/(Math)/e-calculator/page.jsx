          ...
          <div className="lg:w-[40%] md:w-[60%] w-full mx-auto ">
            <div className="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
              ...
              {formData.tech_cal == "ax" && (
                <>
                  <div className="col-span-12 angle_show">
                  ...
                  <div className="rounded-lg  flex items-center justify-center">
                    <div className="w-full mt-3">
                      <div className="w-full">
                        <div className="w-full md:w-[80%] lg:w-[60%] mt- overflow-auto">
                              ...
                              <tr>
                                <td className="py-2 border-b" width="60%">
                                  <strong>
                                    ...
                                    <sup className="text-[16px]">
                                      {formData?.tech_x}
                                    </sup>
                                  </strong>
                                </td>
                                <td className="py-2 border-b">
                                  {Number(result?.tech_exp).toFixed(2)}
                                </td>
                              </tr>
                            </tbody>
                          </table>
                        </div>
                        <div className="col-12 text-[16px] mt-2 overflow-auto">
                          <p>
                          ...
                          {formData?.tech_cal === "ex" ? (
                            <>
                              <p className="mt-2">
                                e<sup className="text-[16px]">x</sup> = ?
                              </p>
                              <p className="mt-2">
                                (2.71828)
                                <sup className="text-[16px]">
                            ...
                            <>
                              <p className="mt-2">
                                10<sup className="text-[16px]">x</sup> = ?
                              </p>
                              <p className="mt-2">
                                (10)
                                <sup className="text-[16px]">
                            ...
                            <>
                              <p className="mt-2">
                                a<sup className="text-[16px]">x</sup> = ?
                              </p>
                              <p className="mt-2">
                                ({formData?.tech_a})
                                <sup className="text-[16px]">
