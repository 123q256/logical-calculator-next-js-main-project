...
import {
  useGetSingleCalculatorDetailsMutation,useVolumeCalculatorMutation
            ...
            <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
               <div className="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                    ...
                    <div className="row">
                              ...
                              <div className="row"> 
                                ...
                                { data?.payload?.tech_lang_keys["4"]}
                                  ...
                                  <div className="col-lg-12 col-6">
                                        <label htmlFor="tech_cyl_diameter" className="label" >
                        ...
                        {(formData.tech_volume_select == "Cone") && (
                          ...
                          <div className="col-12 " id="Cone">
                              <div className="row">
                                  ...
                                  <div className="col-lg-12 col-6">
                                        <label htmlFor="tech_con_diameter" className="label" >
                                      { data?.payload?.tech_lang_keys["6"]}
                                        </label>
                                        <div className="relative w-full ">
                                          <input
                          ...
                          <div className="" id="Triangular">
                              <div className="row">
                                  <div className="col-lg-12 col-6 pe-lg-0 pe-2">
                                      ...
                                      { data?.payload?.tech_lang_keys['5'] } { data?.payload?.tech_lang_keys['3'] } a
                                        </label>
                                        <div className="relative w-full ">
                                          <input
                                            type="number"
                                  ...
                                  <div className="col-lg-12 col-6">
                                      ...
                                      { data?.payload?.tech_lang_keys['5'] } { data?.payload?.tech_lang_keys['3'] } b
                                        </label>
                                        <div className="relative w-full ">
                                          <input
                                            type="number"
                                  ...
                                  <div className="col-lg-12 col-6 pe-lg-0 pe-2">
                                    <label htmlFor="tech_tri_height" className="label" >
                                      { data?.payload?.tech_lang_keys['5'] } { data?.payload?.tech_lang_keys['3'] } c
                                        </label>
                                        <div className="relative w-full ">
                                          <input
                                            type="number"
                                        ...
                                        <div className="absolute z-10 bg-white border border-gray-300 rounded-md w-auto mt-1 right-0">
                                          {[
                                            ...
                                            <p
                                              key={index}
                                              className="p-2 hover:bg-gray-100 cursor-pointer"
                                              onClick={() => setUnitHandler16(unit.value)}
                                            >
                                              {unit.label}
                                            </p>
                                          ))}
                        ...
                        {(formData.tech_volume_select == "Hollow") && (
                          ...
                          <div className="" id="Hollow">
                              <div className="row">
                                  <div className="col-lg-12 col-6 pe-lg-0 pe-2">
                                    <label htmlFor="tech_hol_inner_dia" className="label" >
                                  ...
                                  <div className="col-lg-12 col-6">
                                      <label htmlFor="tech_hol_outer_dia" className="label" >
                                          ...
                                          <div className="absolute z-10 bg-white border border-gray-300 rounded-md w-auto mt-1 right-0">
                                            {[
                                              ...
                                              <p
                                                key={index}
                                                className="p-2 hover:bg-gray-100 cursor-pointer"
                                                onClick={() => setUnitHandler19(unit.value)}
                                              >
                                                {unit.label}
                                              </p>
                                            ))}
                                          ...
                                          <div className="absolute z-10 bg-white border border-gray-300 rounded-md w-auto mt-1 right-0">
                                            {[
                                              ...
                                              <p
                                                key={index}
                                                className="p-2 hover:bg-gray-100 cursor-pointer"
                                                onClick={() => setUnitHandler20(unit.value)}
                                              >
                                                {unit.label}
                                              </p>
                                            ))}
                        ...
                        {(formData.tech_volume_select == "Conical") && (
                          ...
                          <div className="" id="Conical">
                              <div className="row">
                                  ...
                                  <div className="col-lg-12 col-6">
                                      <label htmlFor="tech_coni_bottom_r" className="label" >
                                          ...
                                          <div className="absolute z-10 bg-white border border-gray-300 rounded-md w-auto mt-1 right-0">
                                            {[
                                              ...
                                              <p
                                                key={index}
                                                className="p-2 hover:bg-gray-100 cursor-pointer"
                                                onClick={() => setUnitHandler23(unit.value)}
                                              >
                                                {unit.label}
                                              </p>
                                            ))}
                        ...
                        {(formData.tech_volume_select == "Truncated") && (
                          ...
                          <div className="" id="Truncated">
                              <div className="row">
                                  <div className="col-lg-12 col-6 pe-lg-0 pe-2">
                                      <label htmlFor="tech_tru_base_side" className="label" >
                                          ...
                                          <div className="absolute z-10 bg-white border border-gray-300 rounded-md w-auto mt-1 right-0">
                                            {[
                                              ...
                                              <p
                                                key={index}
                                                className="p-2 hover:bg-gray-100 cursor-pointer"
                                                onClick={() => setUnitHandler24(unit.value)}
                                              >
                                                {unit.label}
                                              </p>
                                            ))}
                                  ...
                                  <div className="col-lg-12 col-6">
                                      <label htmlFor="tech_tru_top_side" className="label" >
                                          ...
                                          <div className="absolute z-10 bg-white border border-gray-300 rounded-md w-auto mt-1 right-0">
                                            {[
                                              ...
                                              <p
                                                key={index}
                                                className="p-2 hover:bg-gray-100 cursor-pointer"
                                                onClick={() => setUnitHandler27(unit.value)}
                                              >
                                                {unit.label}
                                              </p>
                                            ))}
                                          ...
                                          <div className="absolute z-10 bg-white border border-gray-300 rounded-md w-auto mt-1 right-0">
                                            {[
                                              ...
                                              <p
                                                key={index}
                                                className="p-2 hover:bg-gray-100 cursor-pointer"
                                                onClick={() => setUnitHandler28(unit.value)}
                                              >
                                                {unit.label}
                                              </p>
                                            ))}
                                          ...
                                          <div className="absolute z-10 bg-white border border-gray-300 rounded-md w-auto mt-1 right-0">
                                            {[
                                              ...
                                              <p
                                                key={index}
                                                className="p-2 hover:bg-gray-100 cursor-pointer"
                                                onClick={() => setUnitHandler31(unit.value)}
                                              >
                                                {unit.label}
                                              </p>
                                            ))}
                  ...
                  <div className="col-span-12 md:col-span-6  flex items-center ps-lg-3 justify-center">
                        {(formData.tech_volume_select == "Rectangular") && (
                          <>
                          <img  src="/images/rectangular_v_new.png"  loading="lazy" alt="Rectangular" className="ms-5 max-rec_length " width="250px" height="180px" id="Rectangular_img"/>
                          </>
                        )}
                      {(formData.tech_volume_select == "Cube") && (
                          <>
                          <img  src="/images/cube_v.png"  loading="lazy" alt="Cube" width="177px" id="Cube_img" className=""/>
                          </>
                        )}
                      {(formData.tech_volume_select == "Cylinder") && (
                          <>
                          <img  src="/images/cylinder_v.png"  loading="lazy" alt="Cylinder" width="143px" id="Cylinder_img" className=""/>
                          </>
                        )}
                      {(formData.tech_volume_select == "Cone") && (
                          <>
                          <img  src="/images/cone_v.png"  loading="lazy" alt="Cone" width="107px" id="Cone_img" className=""/>
                          </>
                        )}
                      {(formData.tech_volume_select == "Sphere") && (
                          <>
                          <img  src="/images/sphere_v.png"  loading="lazy" alt="Sphere" height="150px" width="151px" id="Sphere_img" className="mt-3 "/>
                          </>
                        )}
                      {(formData.tech_volume_select == "Triangular") && (
                          <>
                          <img  src="/images/triangular_v1.webp"  loading="lazy" alt="Triangular" width="185px" id="Triangular_img" className=""/>
                          </>
                        )}
                      {(formData.tech_volume_select == "Pyramid") && (
                          <>
                          <img  src="/images/pyramid_v.png"  loading="lazy" alt="Pyramid" width="205px" id="Pyramid_img" className=""/>
                          </>
                        )}
                      {(formData.tech_volume_select == "Capsule") && (
                          <>
                          <img  src="/images/capsule_v.png"  loading="lazy" alt="Capsule" width="126px" id="Capsule_img" className=""/>
                          </>
                        )}
                      {(formData.tech_volume_select == "Hemisphere") && (
                          <>
                          <img  src="/images/hemisphere_v.png"  loading="lazy" alt="Hemisphere" width="200px" id="Hemisphere_img" className="ms-4 mt-3 "/>
                          </>
                        )}
                      {(formData.tech_volume_select == "Hollow") && (
                          <>
                          <img  src="/images/hollow_v.png"  loading="lazy" alt="Hollow" width="144px" id="Hollow_img" className=""/>
                          </>
                        )}
                      {(formData.tech_volume_select == "Conical") && (
                          <>
                          <img  src="/images/conical_v.png"  loading="lazy" alt="Conical" width="209px" id="Conical_img" className=""/>
                          </>
                        )}
                      {(formData.tech_volume_select == "Truncated") && (
                          <>
                          <img  src="/images/truncated_v.png"  loading="lazy" alt="Truncated" width="270px" id="Truncated_img" className="ms-5 "/>
                          </>
                        )}
                      {(formData.tech_volume_select == "Ellipsoid") && (
                          <>
                          <img  src="/images/ellipsoid_v.png"  loading="lazy" alt="Ellipsoid" width="145px" id="Ellipsoid_img" className=""/>
                          </>
                        )}
                      {(formData.tech_volume_select == "Column") && (
                          <>
                          <img  src="/images/column_v.png"  loading="lazy" alt="column" width="143px" id="Column_img" className=""/>
                          </>
                        )}
                      {(formData.tech_volume_select == "Square") && (
                          <>
                          <img  src="/images/square_v.png"  loading="lazy" alt="square" height="150px" width="260px" id="Square_img" className="ms-5 mt-3 "/>
                          </>
                        )}
                  </div>
                </div>
                          ...
                          <div className="w-full mt-3">
                              <div className="w-full mt-3">
                                      ...
                                      <tbody>
                                        <tr>
                                          ...
                                          <td className="border-b py-2 flex justify-end items-center">
                                              <div className="flex">
                                                <div id="circle_result">{convertedResult}</div>
                                             <div>
                                               <select
                                              id="onetw"
                                              className="ms-2"
                                  ...
                                  <div className="w-full overflow-auto method2-results">
                                      {(formData?.tech_volume_select == 'Rectangular') ? (
                                        <>
                                        <p className="mt-2 font-bold">{data?.payload?.tech_lang_keys['11']}</p>
                                        <p className="mt-2">{data?.payload?.tech_lang_keys['12']}:</p>
                                        ...
                                        {/* Substituted values */}
                                        <BlockMath
                                          math={`V = ${formData?.tech_rec_length || 0} \\times ${formData?.tech_rec_width || 0} \\times ${formData?.tech_rec_height || 0}`}
                                        />

                                        {/* Final calculated volume */}
                                        <BlockMath
                                          math={`V = ${(parseFloat(result?.tech_rectangular) || 0).toFixed(2)}\\ \\text{cm}^3`}
                                        />
                                        </>
                                      ): (formData?.tech_volume_select == 'Cube') ? (
                                        <>
                                      ...
                                      <BlockMath math={`V = \\text{Side} \\times \\text{Side} \\times \\text{Side}`} />
                                      <BlockMath math={`V = ${formData?.tech_cub_side} \\times ${formData?.tech_cub_side} \\times ${formData?.tech_cub_side}`} />
                                      <BlockMath math={`V = ${(parseFloat(result?.tech_cube) || 0).toFixed(2)}\\ \\text{cm}^3`} />
                                        </>
                                      ): (formData?.tech_volume_select == 'Cylinder') ? (
                                        <>
                                            <p className="mt-2 font-bold">{data?.payload?.tech_lang_keys['11']}</p>
                                        <p className="mt-2">{data?.payload?.tech_lang_keys['14']}:</p>

                                        <BlockMath math={`V = \\pi r^2 h`} />
                                        <BlockMath math={`r = d / 2`} />
                                        <BlockMath math={`r = ${formData?.tech_cyl_diameter} / 2`} />
                                        <BlockMath math={`r = ${result?.tech_radius}`} />
                                        <BlockMath math={`V = \\pi \\times ${result?.tech_radius}^2 \\times ${formData?.tech_cyl_height}`} />
                                        <BlockMath math={`V = ${(parseFloat(result?.tech_cylinder) || 0).toFixed(2)}\\ \\text{cm}^3`} />
                                        </>
                                      ): (formData?.tech_volume_select == 'Cone') ? (
                                        <>
                                        <p className="mt-2 font-bold">{data?.payload?.tech_lang_keys['11']}</p>
                                        <p className="mt-2">{data?.payload?.tech_lang_keys['15']}:</p>

                                        <BlockMath math={`V = \\frac{1}{3} \\pi r^2 h`} />
                                        <BlockMath math={`r = d / 2`} />
                                        <BlockMath math={`r = ${formData?.tech_con_diameter} / 2`} />
                                        <BlockMath math={`r = ${result?.tech_radius}`} />
                                        <BlockMath math={`V = \\frac{1}{3} \\times 3.14 \\times ${result?.tech_radius}^2 \\times ${formData?.tech_con_height}`} />
                                        <BlockMath math={`V = ${(parseFloat(result?.tech_cone) || 0).toFixed(2)}\\ \\text{cm}^3`} />
                                        </>
                                      ): (formData?.tech_volume_select == 'Sphere') ? (
                                        <>
                                        <p className="mt-2 font-bold">{data?.payload?.tech_lang_keys['11']}</p>
                                            <p className="mt-2">{data?.payload?.tech_lang_keys['16']}:</p>

                                            <BlockMath math={`V = \\frac{4}{3} \\pi r^3`} />
                                            <BlockMath math={`r = d / 2`} />
                                            <BlockMath math={`r = ${formData?.tech_sph_diameter} / 2`} />
                                            <BlockMath math={`r = ${result?.tech_radius}`} />
                                            <BlockMath math={`V = \\frac{4}{3} \\times 3.14 \\times ${result?.tech_radius}^3`} />
                                            <BlockMath math={`V = ${(parseFloat(result?.tech_sphere) || 0).toFixed(2)}\\ \\text{cm}^3`} />
                                        </>
                                      ): (formData?.tech_volume_select == 'Triangular') ? (
                                        <>
                                        <p className="mt-2 font-bold">{data?.payload?.tech_lang_keys['11']}</p>
                                        <p className="mt-2">{data?.payload?.tech_lang_keys['17']}:</p>

                                        <BlockMath math={`V = \\frac{1}{4}h \\sqrt{(a + b + c)(b + c - a)(c + a - b)(a + b - c)}`} />
                                        ...
                                        <BlockMath math={`V = \\frac{1}{4}(${formData?.tech_tri_h}) \\sqrt{${result?.tech_baseArea}}`} />

                                        <BlockMath math={`V = ${(parseFloat(result?.tech_triangular) || 0).toFixed(2)}\\ \\text{cm}^3`} />
                                        
                                        </>
                                      ): (formData?.tech_volume_select == 'Pyramid') ? (
                                        <>
                                        <p className="mt-2 font-bold">{data?.payload?.tech_lang_keys['11']}</p>
                                          <p className="mt-2">{data?.payload?.tech_lang_keys['18']}:</p>

                                          <BlockMath math={`V = \\frac{1}{3} \\times \\text{base area} \\times \\text{height}`} />

                                          <BlockMath math={`\\text{Base Area} = 0.33 \\times \\text{side} \\times \\text{side}`} />

                                          <BlockMath math={`\\text{Base Area} = 0.33 \\times ${formData?.tech_pyr_side} \\times ${formData?.tech_pyr_side}`} />

                                          <BlockMath math={`\\text{Base Area} = ${result?.tech_baseArea}`} />

                                          <BlockMath math={`V = \\frac{1}{3} \\times ${result?.tech_baseArea} \\times ${formData?.tech_pyr_height}`} />

                                          <BlockMath math={`V = ${Number(result?.tech_pyramid).toFixed(2)}\\ \\text{cm}^3`} />
                                        </>
                                      ): (formData?.tech_volume_select == 'Capsule')  ? (
                                        <>
                                        <p className="mt-2 font-bold">{data?.payload?.tech_lang_keys['11']}</p>
                                        <p className="mt-2">{data?.payload?.tech_lang_keys['20']}:</p>

                                        <BlockMath math={`V = \\pi r^2 \\left( \\frac{4}{3} r + h \\right)`} />

                                        <BlockMath math={`V = 3.14 \\times ${formData?.tech_cap_radius}^2 \\left( \\frac{4}{3} \\times ${formData?.tech_cap_radius} + ${formData?.tech_cap_height} \\right)`} />

                                        <BlockMath math={`V = ${Number(result?.tech_capsule).toFixed(2)}\\ \\text{cm}^3`} />
                                        
                                        </>
                                      ): (formData?.tech_volume_select == 'Hemisphere') ? (
                                        <>
                                        <p className="mt-2 font-bold">{data?.payload?.tech_lang_keys['11']}</p>
                                          <p className="mt-2">{data?.payload?.tech_lang_keys['21']}:</p>

                                          <BlockMath math={`V = \\frac{2}{3} \\pi r^3`} />

                                          <BlockMath math={`V = \\frac{2}{3} \\times 3.14 \\times ${formData?.tech_hem_radius}^3`} />

                                          <BlockMath math={`V = ${Number(result?.tech_hemisphere).toFixed(2)}\\ \\text{cm}^3`} />
                                        </>
                                      ): (formData?.tech_volume_select == 'Hollow') ? (
                                        <>
                                        <p className="mt-2 font-bold">{data?.payload?.tech_lang_keys['11']}</p>
                                        <p className="mt-2">{data?.payload?.tech_lang_keys['24']}:</p>

                                        <BlockMath math={`V = \\pi \\cdot h \\cdot \\frac{(R_{\\text{outer}}^2 - R_{\\text{inner}}^2)}{4}`} />

                                        <BlockMath math={`V = 3.14 \\times ${formData?.tech_hol_height} \\times \\frac{(${formData?.tech_hol_outer_dia}^2 - ${formData?.tech_hol_inner_dia}^2)}{4}`} />

                                        <BlockMath math={`V = ${Number(result?.tech_hollow).toFixed(2)}\\ \\text{cm}^3`} />
                                        </>
                                      ): (formData?.tech_volume_select == 'Conical') ? (
                                        <>
                                      <p className="mt-2 font-bold">{data?.payload?.tech_lang_keys['11']}</p>
                                      <p className="mt-2">{data?.payload?.tech_lang_keys['27']}:</p>

                                      <BlockMath math={`V = \\frac{h}{3} \\left( A_t + A_b + \\sqrt{A_t \\cdot A_b} \\right)`} />

                                      <BlockMath math={`V = \\frac{${formData?.tech_coni_height}}{3} \\left( ${formData?.tech_coni_top_r} + ${formData?.tech_coni_bottom_r} + \\sqrt{${formData?.tech_coni_top_r} \\times ${formData?.tech_coni_bottom_r}} \\right)`} />

                                      <BlockMath math={`V = ${Number(result?.tech_conical).toFixed(2)}\\ \\text{cm}^3`} />
                                        
                                        </>
                                      ): (formData?.tech_volume_select == 'Truncated') ? (
                                        <>
                                      <p className="mt-2 font-bold">{data?.payload?.tech_lang_keys['11']}</p>
                                      <p className="mt-2">{data?.payload?.tech_lang_keys['30']}:</p>

                                      <BlockMath math={`V = \\frac{1}{3} \\times h \\left(A_1 + A_2 + \\sqrt{A_1 \\cdot A_2}\\right)`} />

                                      <BlockMath math={`V = \\frac{1}{3} \\times ${formData?.tech_tru_height} \\left(${formData?.tech_tru_top_side} + ${formData?.tech_tru_base_side} + \\sqrt{${formData?.tech_tru_top_side} \\times ${formData?.tech_tru_base_side}}\\right)`} />

                                      <BlockMath math={`V = ${Number(result?.tech_truncated).toFixed(2)}\\ \\text{cm}^3`} />
                                        </>
                                      ): (formData?.tech_volume_select == 'Ellipsoid') ? (
                                        <>
                                        <p className="mt-2 font-bold">{data?.payload?.tech_lang_keys['11']}</p>
                                        <p className="mt-2">{data?.payload?.tech_lang_keys['34']}:</p>
                                        ...
                                        <BlockMath
                                          math={`V = ${Number(result?.tech_ellipsoid).toFixed(2)}\\ \\text{cm}^3`}
                                        />
                                        </>
                                      ): (formData?.tech_volume_select == 'Square') ? (
                                        <>
                                        <p className="mt-2 font-bold">{data?.payload?.tech_lang_keys['11']}</p>
                                        <p className="mt-2">{data?.payload?.tech_lang_keys['36']}:</p>

                                        <BlockMath math={`V = \\text{Side} \\times \\text{Side} \\times \\text{Side}`} />

                                        <BlockMath math={`V = ${formData?.tech_square} \\times ${formData?.tech_square} \\times ${formData?.tech_square}`} />

                                        <BlockMath math={`V = ${Number(result?.tech_square).toFixed(2)}\\ \\text{cm}^3`} />
                                        </>
                                      ): (formData?.tech_volume_select == 'Column') ? (
                                        <>
                                        <p className="mt-2 font-bold">{data?.payload?.tech_lang_keys['11']}</p>
                                        <p className="mt-2">{data?.payload?.tech_lang_keys['37']}:</p>

                                        <BlockMath math={`V = \\pi \\cdot r^2 \\cdot h`} />

                                        <BlockMath math={`V = \\pi \\cdot ${formData?.tech_col_radi}^2 \\cdot ${formData?.tech_col_height}`} />

                                        <BlockMath math={`V = ${Number(result?.tech_column).toFixed(2)}\\ \\text{cm}^3`} />
