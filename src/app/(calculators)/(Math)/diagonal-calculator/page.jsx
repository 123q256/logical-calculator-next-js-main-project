...
import { useGetSingleCalculatorDetailsMutation ,useDiagonalCalculatorMutation} from "../../../../redux/services/calculator/calculatorApi";
          ...
          <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg space-y-6 mb-3">
            ...
            <div className="lg:w-[60%] md:w-[60%] w-full mx-auto ">
                ...
                <div className="col-span-12 md:col-span-7">
                    ...
                    <div className="col-span-12">
                        {( formData.tech_given == "1" || formData.tech_given == "2"  || formData.tech_given == "3"  || formData.tech_given == "4" ) && (
                          <>
                          ...
                          {( formData.tech_given == "1" || formData.tech_given == "5"  || formData.tech_given == "6"  || formData.tech_given == "7" ) && (
                          <>
                          ...
                          {( formData.tech_given == "2" || formData.tech_given == "5" ) && (
                          <>
                          ...
                          {( formData.tech_given == "3" || formData.tech_given == "6" ) && (
                          <>
                          ...
                          {( formData.tech_given == "4" || formData.tech_given == "7" ) && (
                          <>
                ...
                <div className="col-span-12 md:col-span-5 flex items-center text-center">
                    <img   src="/images/diagonal.webp" height="180px" width="100%" alt="trianle details image" loading="lazy" decoding="async" />
                </div>
            </div>
        </div>
                                    ...
                                    <table className="w-full md:text-[18px] text-[16px]">
                                      <tbody>
                                        ...
                                        {(result?.tech_lsv != "") && (
                                          <>
                                            <tr>
                                                <td className="py-2 border-b" width="60%"><strong>{data?.payload?.tech_lang_keys[1]}</strong></td>
                                                <td className="py-2 border-b">{Number(result?.tech_lsv).toFixed(3)} cm</td>
                                            </tr>
                                          </>
                                        )}
                                            {(result?.tech_ssv != "") && (
                                          <>
                                            ...
                                            <tr>
                                                ...
                                                <td className="py-2 border-b">{Number(result?.tech_ssv).toFixed(3)} cm</td>
                                            </tr>
                                          </>
                                        )}
                                        {(result?.tech_area != "") && (
                                          <>
                                            ...
                                            <tr>
                                                ...
                                                <td className="py-2 border-b">{Number(result?.tech_area).toFixed(3)} cm²</td>
                                            </tr>
                                          </>
                                        )}
                                        {(result?.tech_perimeter != "") && (
                                          <>
                                            ...
                                            <tr>
                                                ...
                                                <td className="py-2 border-b">{Number(result?.tech_perimeter).toFixed(3)} cm</td>
                                            </tr>
                                          </>
                                        )}
                                        {(result?.tech_radius != "") && (
                                          <>
                                            <tr>
                                                <td className="py-2 border-b" width="60%"><strong>{data?.payload?.tech_lang_keys[6]}</strong></td>
                                                <td className="py-2 border-b">{Number(result?.tech_radius).toFixed(3)} cm</td>
                                            </tr>
                                        ...
                                        {(result?.tech_angle_α != "") && (
                                          <>
                                            <tr>
                                                ...
                                                <td className="py-2 border-b">{Number(result?.tech_angle_α).toFixed(3)} rad</td>
                                            </tr>
                                          
                                          </>
                                        )}
                                      {typeof result?.tech_diagonal === "number" && (
                                          <>
                                            <tr>
                                                <td className="py-2 border-b" width="60%"><strong>{data?.payload?.tech_lang_keys[7]}</strong></td>
                                                <td className="py-2 border-b">{Number(result?.tech_diagonal).toFixed(3)} rad</td>
                                            </tr>
