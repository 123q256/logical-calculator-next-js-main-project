...
import { useVolumeOfARectangleMutation } from "../../../../redux/services/datecalculator/dateCalculatorApi";
                ...
                <div className="grid grid-cols-12 mt-3   gap-2">
                  <div className="col-span-12">
                    ...
                    <div className="mt-2">
                      ...
                      >
                        <option value="hlw">
                          {data?.payload?.tech_lang_keys["2"]} V, S, d |{" "}
                          {data?.payload?.tech_lang_keys["3"]} h, l, w{" "}
                        </option>
                        <option value="slw">
                          {data?.payload?.tech_lang_keys["2"]} h, V, d |{" "}
                          {data?.payload?.tech_lang_keys["3"]} S, l, w{" "}
                        </option>
                        <option value="vlw">
                          {data?.payload?.tech_lang_keys["2"]} h, S, d |{" "}
                          {data?.payload?.tech_lang_keys["3"]} V, l, w{" "}
                        </option>
                        <option value="dlw">
                          {data?.payload?.tech_lang_keys["2"]} h, V, S |{" "}
                          {data?.payload?.tech_lang_keys["3"]} d, l, w{" "}
                        </option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div className="col-span-12">
                    {formData?.tech_choose === "slw" ? (
                      <label htmlFor="tech_third" className="label">
                        {data?.payload?.tech_lang_keys[14]} S
                        <sub className="font-s-12 text-blue">tot</sub>
                      </label>
                          ...
                          <table className="w-full font-s-16 mt-2">
                            <tbody>
                              <tr>
                                ...
                                <td className="py-2 border-b">
                                  <strong>
                                    {result?.tech_width} {formData?.tech_units}
                                  </strong>
                                </td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                ...
                                <td className="py-2 border-b">
                                  <strong>
                                    {result?.tech_s_tot} {formData?.tech_units}²
                                  </strong>
                                </td>
                              </tr>
                              <tr>
                                ...
                                <td className="py-2 border-b">
                                  <strong>
                                    {result?.tech_s_lat} {formData?.tech_units}²
                                  </strong>
                                </td>
                              </tr>
                              <tr>
                                ...
                                <td className="py-2 border-b">
                                  <strong>
                                    {result?.tech_s_top} {formData?.tech_units}²
                                  </strong>
                                </td>
                              </tr>
                              <tr>
                                ...
                                <td className="py-2 border-b">
                                  <strong>
                                    {result?.tech_s_btm} {formData?.tech_units}²
                                  </strong>
                                </td>
                              </tr>
                            </tbody>
