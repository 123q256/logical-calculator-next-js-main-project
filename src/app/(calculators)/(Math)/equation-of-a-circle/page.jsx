...
import { useGetSingleCalculatorDetailsMutation ,useEquationOfACircleMutation} from "../../../../redux/services/calculator/calculatorApi";
              ...
              <div className="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                    ...
                    <label htmlFor="tech_from" className="label">
                      ...
                      <div className="mt-2">
                        ...
                        >
                          ...
                          <option value="4">{data?.payload?.tech_lang_keys["2"]} </option>
                          <option value="5">{data?.payload?.tech_lang_keys["3"]} </option>
                        </select>
                      </div>
                  </div>
                  {(formData.tech_from == "1" || formData.tech_from == "2" || formData.tech_from == "3") && (
                    <>
                    <div className="col-span-12 standardEquation">
                        <div className="grid grid-cols-12   gap-2 md:gap-4 lg:gap-4">
                          <p className="col-span-12 text-center my-3 text-[16px] md:text-[18px]">
                            ...
                            <div className="col-span-4">
                              {(formData?.tech_from === '3') ? (
                                <>
                                <label htmlFor="tech_a" className="label">D </label>
                                </>
                              ):(
                                <>
                            ...
                            <div className="col-span-4">
                                {(formData?.tech_from === '3') ? (
                                <>
                                <label htmlFor="tech_b" className="label">E </label>
                                </>
                              ):(
                                <>
                            ...
                            <div className="col-span-4">
                              {(formData?.tech_from === '2') ? (
                                <>
                                <label htmlFor="tech_c" className="label">r </label>
                                </>
                              ): (formData?.tech_from === '3') ? (
                                <>
                                <label htmlFor="tech_c" className="label">F </label>
                                </>
                              ):(
                                <>
                  ...
                  {(formData.tech_from == "4" || formData.tech_from == "5") && (
                    ...
                    <div className="col-span-12  circlePoints">
                        <div className="grid grid-cols-12    gap-2 md:gap-4 lg:gap-4">
                            <p className="col-span-12 text-center my-3 text-[16px] md:text-[18px]"><strong>{data?.payload?.tech_lang_keys['5']} (x,y)</strong></p>
                            <div className={`${formData?.tech_from === '5' ? 'col-span-6' : 'col-span-4'} px-2 mt-0 mt-lg-2 xInput`}>
                  ...
                  {(formData.tech_from == "5") && (
                    ...
                    <div className="col-span-12  centerPoints">
                        <div className="grid grid-cols-12    gap-2 md:gap-4 lg:gap-4">
                            <p className="col-span-12 text-center my-3 text-[16px] md:text-[18px]"><strong>{data?.payload?.tech_lang_keys['7']} (h,k)</strong></p>
                            <div className="col-span-6">
                            <label htmlFor="tech_h1" className="label">  h </label>
                                  <div className=" relative">
                                  <input
                                    type="number"
                                    step="any"
                            ...
                            <div className="col-span-6">
                                <label htmlFor="tech_k1" className="label">  k </label>
                                  <div className=" relative">
                                  <input
                                    type="number"
                                    step="any"
                                 ...
                                 <div className="w-full md:w-[80%] lg:w-[80%] mt-2 overflow-auto" >
                                      ...
                                      <table className="w-full text-[16px] md:text-[18px]">
                                        <tbody>
                                          <tr>
                                              ...
                                              <td className="py-2 border-b"><strong>{result?.tech_radius}</strong></td>
                                          </tr>
                                          <tr>
                                              <td className="py-2 border-b" >{ data?.payload?.tech_lang_keys['10'] }</td>
                                              <td className="py-2 border-b"><strong>{result?.tech_diameter}</strong></td>
                                          </tr>
                                          <tr>
                                              <td className="py-2 border-b" >{ data?.payload?.tech_lang_keys['11'] }</td>
                                              <td className="py-2 border-b"><strong>[{result?.tech_d1} , {result?.tech_d2}]</strong></td>
                                          </tr>
                                          <tr>
                                              <td className="py-2 border-b" >{ data?.payload?.tech_lang_keys['12'] }</td>
                                              <td className="py-2 border-b"><strong>{result?.tech_eccentricity}</strong></td>
                                          </tr>
                                          <tr>
                                              <td className="py-2 border-b" rowspan="2" >{ data?.payload?.tech_lang_keys['13'] }</td>
                                              <td className="py-2"><strong>x-coordianate {result?.tech_A}</strong></td>
                                          </tr>
                                          <tr>
                                              <td className="py-2 border-b"><strong>y-coordianate {result?.tech_B}</strong></td>
                                          </tr>
                                          </tbody>
                                      </table>
                                  </div>
                                  <div className="w-full md:w-[80%] lg:w-[80%] mt-2 overflow-auto" >
                                      <table className="w-full text-[16px]">
                                        <tbody>
                                          <tr>
                                              <td className="py-2 border-b" ><strong>{ data?.payload?.tech_lang_keys['14'] }</strong></td>
                                              <td className="py-2 border-b">{result?.tech_area}</td>
                                          </tr>
                                          <tr>
                                              <td className="py-2 border-b" ><strong>{ data?.payload?.tech_lang_keys['15'] }</strong></td>
                                              <td className="py-2 border-b">{result?.tech_circumference}</td>
                                          </tr>
                                          <tr>
                                              <td className="py-2 border-b" ><strong>{ data?.payload?.tech_lang_keys['16'] }</strong></td>
                                              <td className="py-2 border-b">[{result?.tech_r1} , {result?.tech_r2}]</td>
                                          </tr>
                                          <tr>
                                              <td className="py-2 border-b" ><strong>{ data?.payload?.tech_lang_keys['17'] }</strong></td>
                                              <td className="py-2 border-b">{result?.tech_eccentricity}</td>
                                          </tr>
                                          <tr>
                                              <td className="py-2 border-b" rowspan="2" ><strong>{ data?.payload?.tech_lang_keys['18'] }</strong></td>
                                              <td className="py-2">x = {result?.tech_A} + {result?.tech_radius} cos(α)</td>
                                          </tr>
                                          <tr>
                                              <td className="py-2 border-b">y = {result?.tech_B} + {result?.tech_radius} sin(α)</td>
                                          </tr>
                                          </tbody>
                                      </table>
                                  </div>
