...
const ConvolutionCalculator = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.tech_seq1 || !formData.tech_seq2) {
    ...
    try {
      const response = await calculateEbitCalculator({
        tech_seq1: formData.tech_seq1,
        tech_seq2: formData.tech_seq2,
      }).unwrap();
          ...
          <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
            <div className="grid grid-cols-12 mt-3 gap-2 md:gap-4 lg:gap-4">
              <div className="col-span-12">
                <label htmlFor="tech_seq1" className="label">
                ...
                <div className="w-full py-2">
                  <textarea
                    ...
                    value={formData.tech_seq1 || ""}
                    onChange={handleChange}
                  />
                </div>
              </div>
              <div className="col-span-12">
                <label htmlFor="tech_seq2" className="label">
                        ...
                        <div className="col-12 text-center text-[20px]">
                          ...
                          <p className="my-3">
                            <strong className="bg-[#2845F5] px-3 py-2 md:text-[22px] rounded-lg text-white">
                              {result?.tech_conv?.map((value, index) => (
                                <span key={index}>
                                  {value}
                                  {index !== result.tech_conv.length - 1
                                    ? ", "
                                    : ""}
                                </span>
                              ))}
