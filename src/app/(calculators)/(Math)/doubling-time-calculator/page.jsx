...
const DoublingTimeCalculator = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.tech_x || !formData.tech_want) {
    ...
    setFormError("");
    try {
      const response = await calculateDoublingTime({
        tech_want: Number(formData.tech_want),
        ...
        <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg space-y-6 mb-3">
          ...
          <div className="lg:w-[50%] md:w-[50%] mx-auto">
            <div className="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
              ...
              <div className="col-span-12">
                <label htmlFor="tech_x" className="label" id="changeText">
                  {formData.tech_want === "2"
                    ? "Doubling Time:"
                    : `${data?.payload?.tech_lang_keys["3"]} (%):`}
                </label>
                <div className=" py-2">
