        ...
        <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg space-y-6 mb-3">
          ...
          <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
            <div className="grid grid-cols-12 mt-3 gap-2 ">
              <p className="col-span-12 text-center my-2 text-[18px]">
              ...
              <div className="col-span-2 flex items-center text-center text-[18px]">
                      ...
                      <div className="w-full">
                        ...
                        <div className="w-full md:w-[60%] lg:w-[60%] overflow-auto mt-2">
                          <table className="w-full text-[16px]">
                            <tbody>
                              <tr>
                                <td className="py-2 border-b w-[50%]">
                                  <strong>
                                    {data?.payload?.tech_lang_keys["3"]}
                                  </strong>
                                </td>
                                <td className="py-2 border-b">
                                  {formData?.tech_first} {result?.tech_sign}{" "}
                        ...
                        <div className="w-full text-[16px] overflow-auto">
                          ...
                          <p className="mt-2">
                            {result?.tech_nbr1}, {result?.tech_nbr2}
                          </p>
                          ...
                          <p className="mt-2">
                            {result?.tech_nbr1} {result?.tech_sign}{" "}
                            {result?.tech_nbr2}
                          </p>
