...
import { useGetSingleCalculatorDetailsMutation ,useLawOfSinesCalculatorMutation} from "../../../../redux/services/calculator/calculatorApi";
            ...
            <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
                <div className="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                  <div className="col-span-12 md:col-span-6">
                      <div className="col-12 mt-0 mt-lg-2">
                          ...
                          <div className="mt-2">
                            ...
                            >
                              <option value="abb">{data?.payload?.tech_lang_keys['2'] } A {data?.payload?.tech_lang_keys['3']} a, b, B</option>
                              <option value="acc">{data?.payload?.tech_lang_keys['2'] } A {data?.payload?.tech_lang_keys['3']} a, c, C</option>
                              <option value="aba">{data?.payload?.tech_lang_keys['2'] } B {data?.payload?.tech_lang_keys['3']} a, b, A</option>
                              <option value="bcc">{data?.payload?.tech_lang_keys['2'] } B {data?.payload?.tech_lang_keys['3']} b, c, C</option>
                              <option value="aca">{data?.payload?.tech_lang_keys['2'] } C {data?.payload?.tech_lang_keys['3']} a, c, A</option>
                              <option value="bcb">{data?.payload?.tech_lang_keys['2'] } C {data?.payload?.tech_lang_keys['3']} b, c, B</option>
                              <option value="bab">{data?.payload?.tech_lang_keys['4'] } a {data?.payload?.tech_lang_keys['3']} b, A, B</option>
                              <option value="cac">{data?.payload?.tech_lang_keys['4'] } a {data?.payload?.tech_lang_keys['3']} c, A, C</option>
                              <option value="aab">{data?.payload?.tech_lang_keys['4'] } b {data?.payload?.tech_lang_keys['3']} a, A, B</option>
                              <option value="cbc">{data?.payload?.tech_lang_keys['4'] } b {data?.payload?.tech_lang_keys['3']} c, B, C</option>
                              <option value="aac">{data?.payload?.tech_lang_keys['4'] } c {data?.payload?.tech_lang_keys['3']} a, A, C</option>
                              <option value="bbc">{data?.payload?.tech_lang_keys['4'] } c {data?.payload?.tech_lang_keys['3']} b, B, C</option>
                            </select>
                          </div>
                      </div>
                    {(formData.tech_cal == "abb" || formData.tech_cal == "acc" || formData.tech_cal == "aba"  || formData.tech_cal == "aca"  || formData.tech_cal == "aab"  || formData.tech_cal == "aac"  ) && (
                      <>
                     ...
                     {(formData.tech_cal == "abb" || formData.tech_cal == "aba" || formData.tech_cal == "bcc"  || formData.tech_cal == "bcb"  || formData.tech_cal == "bab"    || formData.tech_cal == "bbc" ) && (
                      <>
                    ...
                    {(formData.tech_cal == "acc" || formData.tech_cal == "bcc" || formData.tech_cal == "aca"  || formData.tech_cal == "bcb"  || formData.tech_cal == "cac"  || formData.tech_cal == "cbc") && (
                      <>
                     ...
                     {(formData.tech_cal == "aba" || formData.tech_cal == "aca" || formData.tech_cal == "bab" || formData.tech_cal == "cac" || formData.tech_cal == "aab" || formData.tech_cal == "aac") && (
                      <>
                      <div className="col-12 mt-0 mt-lg-2" id="A">
                    ...
                    {(formData.tech_cal == "abb" || formData.tech_cal == "bcb" || formData.tech_cal == "bab" || formData.tech_cal == "aab" || formData.tech_cal == "cbc" || formData.tech_cal == "bbc") && (
                      <>
                      <div className="col-12 mt-0 mt-lg-2 " id="B">
                    ...
                    {(formData.tech_cal == "acc"  || formData.tech_cal == "bcc" || formData.tech_cal == "cac" || formData.tech_cal == "cbc" || formData.tech_cal == "aac" || formData.tech_cal == "bbc") && (
                      <>
                      <div className="col-12 mt-0 mt-lg-2 " id="C">
                  ...
                  <div className="col-span-12 md:col-span-6 my-auto">
                     ...
                     <div className="col-12 text-[16px] md:text-[20px] text-center">
                        {formData.tech_cal == "abb" && (
                          <BlockMath math={`A = \\sin^{-1} \\left( \\dfrac{a \\sin B}{b} \\right)`} />
                        )}
                        {formData.tech_cal == "acc" && (
                          <BlockMath math={`A = \\sin^{-1} \\left( \\dfrac{a \\sin C}{c} \\right)`} />
                        )}
                        {formData.tech_cal == "aba" && (
                          <BlockMath math={`B = \\sin^{-1} \\left( \\dfrac{b \\sin A}{a} \\right)`} />
                        )}
                        {formData.tech_cal == "bcc" && (
                          <BlockMath math={`B = \\sin^{-1} \\left( \\dfrac{b \\sin C}{c} \\right)`} />
                        )}
                        {formData.tech_cal == "aca" && (
                          <BlockMath math={`C = \\sin^{-1} \\left( \\dfrac{c \\sin A}{a} \\right)`} />
                        )}
                        {formData.tech_cal == "bcb" && (
                          <BlockMath math={`C = \\sin^{-1} \\left( \\dfrac{c \\sin B}{b} \\right)`} />
                        )}
                      ...
                      <div className="col-12 text-center mt-5 flex items-center">
                          <img  src="/images/law_of_sine.webp" width="100%" height="100%" alt="Law of Sines" loading="lazy" decoding="async"/>
                      </div>
                  </div>
              </div>
          </div>
                       ...
                       <div className="rounded-lg  flex items-center justify-center">
                          <div className="w-full mt-3">
                                    ...
                                    <tbody>
                                      <tr>
                                        <td className="py-2 border-b" >
                                          <strong>
                                            {(formData?.tech_cal == 'abb' || formData?.tech_cal == 'acc') && `${data?.payload?.tech_lang_keys['2']} A`}
                                            {(formData?.tech_cal == 'aba' || formData?.tech_cal == 'bcc') && `${data?.payload?.tech_lang_keys['2']} B`}
                                            {(formData?.tech_cal == 'aca' || formData?.tech_cal == 'bcb') && `${data?.payload?.tech_lang_keys['2']} C`}
                                            {(formData?.tech_cal == 'bab' || formData?.tech_cal == 'cac') && `${data?.payload?.tech_lang_keys['4']} a`}
                                            {(formData?.tech_cal == 'aab' || formData?.tech_cal == 'cbc') && `${data?.payload?.tech_lang_keys['4']} b`}
                                            {(formData?.tech_cal == 'aac' || formData?.tech_cal == 'bbc') && `${data?.payload?.tech_lang_keys['4']} c`}
                                          </strong>
                                        </td>
                                        <td className="py-2 border-b">
                                          {(formData?.tech_cal == 'abb' || formData?.tech_cal == 'acc') && `${Number(result?.tech_angle_a).toFixed(5)}°`}
                                          {(formData?.tech_cal == 'aba' || formData?.tech_cal == 'bcc') && `${Number(result?.tech_angle_b).toFixed(5)}°`}
                                          {(formData?.tech_cal == 'aca' || formData?.tech_cal == 'bcb') && `${Number(result?.tech_angle_c).toFixed(5)}°`}
                                          {(formData?.tech_cal == 'bab' || formData?.tech_cal == 'cac') && `${Number(result?.tech_side_a).toFixed(5)} cm`}
                                          {(formData?.tech_cal == 'aab' || formData?.tech_cal == 'cbc') && `${Number(result?.tech_side_b).toFixed(5)} cm`}
                                          {(formData?.tech_cal == 'aac' || formData?.tech_cal == 'bbc') && `${Number(result?.tech_side_c).toFixed(5)} cm`}
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
                              ...
                              <div className="w-full text-[16px] method2-results">
                                  <p className="mt-2"><strong>{data?.payload?.tech_lang_keys['10']}:</strong></p>

                                  {(formData?.tech_cal=='abb') ? (
                                    <>
                                      <p className="mt-2">
                                          {data?.payload?.tech_lang_keys['5']} {data?.payload?.tech_lang_keys['2']} A
                                        </p>
                                        ...
                                        <div className="mt-2">
                                          <BlockMath math={`A = ${result?.tech_angle_a}^\\circ`} />
                                        </div>
                                    </>
                                  ): (formData?.tech_cal=='acc') ? (
                                    <>
                                  <p className="mt-2">
                                    ...
                                    <>
                                    <p className="mt-2">
                                      {data?.payload?.tech_lang_keys['5']} {data?.payload?.tech_lang_keys['2']} B
                                    </p>
                                    ...
                                    <div className="mt-2">
                                      <BlockMath math={`B = ${result?.tech_angle_b}^\\circ`} />
                                    </div>
                                    </>
                                  ): (formData?.tech_cal=='bcc') ? (
                                    <>
                                  <p className="mt-2">
                                    ...
                                    <>
                                      <p className="mt-2">
                                        {data?.payload?.tech_lang_keys['5']} {data?.payload?.tech_lang_keys['2']} C
                                      </p>
                                      ...
                                      <div className="mt-2">
                                        <BlockMath math={`C = ${result?.tech_angle_c}^\\circ`} />
                                      </div>
                                    </>
                                  ): (formData?.tech_cal=='bcb') ? (
                                    <>
                                  ...
                                  <div className="mt-2">
                                    ...
                                    <>
                                    <p className="mt-2">
                                        {data?.payload?.tech_lang_keys['5']} {data?.payload?.tech_lang_keys['4']} a
                                      </p>
                                  ...
                                  <div className="mt-2">
                                    ...
                                    <>
                                      <p className="mt-2">
                                      {data?.payload?.tech_lang_keys['5']} {data?.payload?.tech_lang_keys['4']} b
                                    </p>
                                    ...
                                    <>
                                  <p className="mt-2">
                                      {data?.payload?.tech_lang_keys['5']} {data?.payload?.tech_lang_keys['4']} c
                                    </p>
                                ...
                                <div className="mt-2">
                                  a = <InlineMath math={`${result?.tech_side_a} \\text{ cm}`} />
                                </div>
                                
                                <div className="mt-2">
                                  b = <InlineMath math={`${result?.tech_side_b} \\text{ cm}`} />
                                </div>
                                
                                <div className="mt-2">
                                  c = <InlineMath math={`${result?.tech_side_c} \\text{ cm}`} />
                                </div>

                                <p className="mt-2">{data?.payload?.tech_lang_keys['7']}</p>

                                <div className="mt-2">
                                  A = <InlineMath math={`${result?.tech_angle_a}^\\circ`} />
                                </div>

                                <div className="mt-2">
                                  B = <InlineMath math={`${result?.tech_angle_b}^\\circ`} />
                                </div>

                                <div className="mt-2">
                                  C = <InlineMath math={`${result?.tech_angle_c}^\\circ`} />
                                </div>

                                <p className="mt-2">{data?.payload?.tech_lang_keys['8']}</p>

                                <div className="mt-2">
                                  P = <InlineMath math={`${result?.tech_P} \\text{ cm}`} />
                                </div>

                                <div className="mt-2">
                                  s = <InlineMath math={`${result?.tech_s} \\text{ cm}`} />
                                </div>

                                <div className="mt-2">
                                  K = <InlineMath math={`${result?.tech_K} \\text{ cm}^2`} />
                                </div>

                                <div className="mt-2">
                                  r = <InlineMath math={`${result?.tech_r} \\text{ cm}`} />
                                </div>
