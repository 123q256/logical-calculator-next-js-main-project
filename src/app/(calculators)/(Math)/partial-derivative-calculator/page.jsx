...
const PartialDerivativeCalculator = () => {
            ...
            <div className="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
              <div className="col-span-12">
                ...
                <label for="tech_EnterEq" className="label mt-4">
                  ...
                  {data?.payload?.tech_lang_keys["1"]} e^x{" "}
                  {data?.payload?.tech_lang_keys["1"]} {"e^{x}"}
                </label>
              ...
              <div className="col-span-12 mt-3">
                <label htmlFor="tech_with" className="label">
                  {data?.payload?.tech_lang_keys["4"]}: W.R.T:
                </label>
                <div className="mt-2">
                  <select
                    className="input"
                        ...
                        {formData?.tech_how > 1 ? (
                          (() => {
                            ...
                            for (
                              ...
                              const fnIndex = Math.floor(i / 2) + 1;
                              content.push(
                                <div key={i}>
                                  <p className="mt-3 text-[18px]">
                                    <strong className="math">{`f${j} (x)`}</strong>{" "}
                                    {data?.payload?.tech_lang_keys["7"]}
                                  </p>
                                  <p className="mt-3 text-[18px] math">
                                  ...
                                  <div
                                    className="w-full mt-3 res_step hidden"
                                    step_cal={i + 1}
                                  >
                                    <p
                                      className="mt-3"
                                      dangerouslySetInnerHTML={{
                                        __html: result?.tech_final_res?.[i + 1],
                                      }}
                                    />
                                  </div>
                                </div>
                          ...
                          <>
                            ...
                            <div className="w-full mt-3 res_step">
                              {result?.tech_buffer && (
                                <div
                                  ref={containerRef}
