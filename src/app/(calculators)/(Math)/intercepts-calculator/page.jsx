...
const XandYInterceptsCalculator = () => {
  ...
  const bufferZero = result?.tech_buffer_zero || [];
  const bufferOne = result?.tech_buffer_one || "";
  const bufferP = bufferOne.split(",");
                    ...
                    <div className="w-full mt-3">
                      <div className="w-full mt-2 overflow-auto">
                        <table className="w-full text-[16px] text-left">
                          <tbody>
                            <tr>
                              <td className="py-2 border-b w-[30%] font-semibold">
...
export default XandYInterceptsCalculator;
