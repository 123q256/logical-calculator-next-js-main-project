            ...
            <div className="grid grid-cols-12 mt-3 gap-2 md:gap-4 lg:gap-4">
              <p className="col-span-12 text-center my-3 text-[18px]">
                <strong id="changeText">
                  {formData?.tech_opr === "2" && "a - b = ?"}
                  {formData?.tech_opr === "3" && "a × b = ?"}
                  {formData?.tech_opr === "4" && "a ÷ b = ?"}
                  {formData?.tech_opr === "5" && (
                    <>
                      a<sup className="text-[14px]">b</sup> = ?
                    </>
                  )}
                  {formData?.tech_opr === "6" && (
                    <>
                      <sup className="text-[14px]">b</sup>√a = ?
                    </>
                  )}
                  {formData?.tech_opr === "7" && (
                    <>
                        ...
                        <div className="w-full text-center text-[20px]">
                          <p
                            dangerouslySetInnerHTML={{
                              __html: result?.tech_ansText || "",
                            }}
                          ></p>
                          <p className="my-3">
                            <strong
                              className="bg-[#2845F5] text-white px-3 py-2 md:text-[32px] text-[20px] rounded-lg"
                              dangerouslySetInnerHTML={{
