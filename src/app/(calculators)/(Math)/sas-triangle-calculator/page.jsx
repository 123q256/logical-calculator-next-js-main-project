                  ...
                  <div className="rounded-lg  flex items-center justify-center">
                    <div className="w-full mt-3">
                      <div className="w-full">
                        <div className="w-full md:w-[90%] lg:w-[70%] overflow-auto mt-2">
                          <table className="w-full text-[16px]">
                            <tbody>
                              ...
                              <tr>
                                <td className="py-2 border-b" width="60%">
                                  <strong>
                                    {data?.payload?.tech_lang_keys[5]} ∠A (α)
                                  </strong>
                                </td>
                                <td className="py-2 border-b">
                                  {Number(result?.tech_alpha).toFixed(2)}
                              ...
                              <tr>
                                <td className="py-2 border-b" width="60%">
                                  <strong>
                                    {data?.payload?.tech_lang_keys[5]} ∠B (β)
                                  </strong>
                                </td>
                                <td className="py-2 border-b">
                                  {Number(result?.tech_beta).toFixed(2)}
                                  <sup className="text-[14px]">°</sup>
                                </td>
                              </tr>
                              <tr>
...
export default SasTriangleCalculator;
