...
const PowerOf10Calculator = () => {
  ...
  // currency code
  // rsult
  const input = parseFloat(formData?.tech_input);
        ...
        <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg space-y-6 mb-3">
          ...
          <div className="lg:w-[40%] md:w-[60%] w-full mx-auto ">
            <div className="grid grid-cols-12 mt-3 gap-2 md:gap-4 lg:gap-4">
              <p className="col-span-12 text-center my-2 text-[21px]">
                <strong>
                  10<sup className="font-s-14">x</sup> = a
                </strong>
              </p>
                    ...
                    <div className="w-full mt-3">
                      <div className="w-full overflow-auto">
                        ...
                        <div className="w-full text-[16px] overflow-auto">
                          ...
                          <p className="mt-2">
                            {(10).toString()}
                            <sup className="text-[14px]">{input}</sup> ={" "}
                            {Array.from(
                              { length: Math.round(input) },
                              (_, i) => (
                                <span key={i}>
                                  10 {i + 1 !== Math.round(input) ? "× " : ""}
                                </span>
                              )
                            )}
                          </p>
                          ...
                          <p className="mt-2">
                            (10)<sup className="text-[14px]">{input}</sup> ={" "}
                            {result?.tech_result}
                          </p>
                        </div>
                      </div>
...
export default PowerOf10Calculator;
