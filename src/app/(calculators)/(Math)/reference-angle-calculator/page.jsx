...
import { useReferenceAngleCalculatorMutation } from "../../../../redux/services/datecalculator/dateCalculatorApi";
...
const ReferenceAngleCalculator = () => {
                          ...
                          <table className="w-full  text-[16px]">
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td className="py-2 border-b">
                                  {result?.tech_ans * 0.017453} (rad)
                                </td>
                              </tr>
                              <tr>
                                <td className="py-2 border-b" width="60%">
                                  <strong>In Pi Radians</strong>
                                </td>
                                <td className="py-2 border-b">
                                  {result?.tech_pi} (π rad)
                                </td>
                              </tr>
                            </tbody>
                          </table>
...
export default ReferenceAngleCalculator;
