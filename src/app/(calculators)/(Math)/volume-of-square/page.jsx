                            ...
                            <tbody>
                              <tr>
                                ...
                                <td className="py-2 border-b">
                                  {Number(result?.tech_answer).toFixed(4)} in³
                                </td>
                              </tr>
                            </tbody>
                          </table>
                        ...
                        <div className="w-full md:w-[60%] lg:w-[60%]">
                          <table className="w-full text-[16px]">
                            <tbody>
                              ...
                              <tr>
                                <td className="py-2 border-b">ft³</td>
                                <td className="py-2 border-b">
                                  <strong>
                                    {Number(result?.tech_answer / 1728).toFixed(
                                      4
                                    )}
                                  </strong>
                                </td>
                              ...
                              <tr>
                                <td className="py-2 border-b">cm³</td>
                                <td className="py-2 border-b">
                                  <strong>
                                    {Number(
