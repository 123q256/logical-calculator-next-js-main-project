...
import { useGetSingleCalculatorDetailsMutation ,useLengthOfCurveCalculatorMutation} from "../../../../redux/services/calculator/calculatorApi";
              ...
              <div className="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                  <div className="col-span-12">
                      ...
                      <div className="mt-2">
                        ...
                        >
                          <option value="y">{data?.payload?.tech_lang_keys["2"]} : y=f(x)</option>
                          <option value="x">{data?.payload?.tech_lang_keys["2"]} : x=f(y)</option>
                          <option value="xy">{data?.payload?.tech_lang_keys["3"]} : x=x(t), y=y(t)</option>
                          <option value="r">{data?.payload?.tech_lang_keys["4"]} : r=r(t)</option>
                          <option value="xyz">{data?.payload?.tech_lang_keys["5"]} : x=x(t), y=y(t), z=z(t)</option>
                        </select>
                      </div>
                  </div>
                       ...
                       <label htmlFor="tech_func" className="label">
                        ...
                        <span className="text-blue-700 underline" id="ch">
                          {formData?.tech_cal === "x"
                            ...
                            : formData?.tech_cal === "r"
                            ? "r(t):"
                            : formData?.tech_cal === "xyz" || formData?.tech_cal === "xy"
                            ? "x(t):"
                            : "f(x):"}
                        </span>
                      </label>
                    ...
                    <div className="rounded-lg  flex items-center justify-center">
                        <div className="w-full mt-3 overflow-auto">
                              <div className="w-full text-[16px] overflow-auto">
                                  ...
                                  <p className="mt-3"> <strong>{data?.payload?.tech_lang_keys[10]}:</strong></p>
                                  ...
                                  {(formData?.tech_cal=='y') ? (
                                    ...
                                    <div className="mt-3">
                                      <BlockMath math={`L = \\int_a^b \\sqrt{\\left(f'\\left(x\\right)\\right)^2 + 1}dx`} />
                                    </div>
                                  ...
                                  <>
                                    ...
                                    <div className="mt-3">
                                      <BlockMath math={`L = \\int_a^b \\sqrt{\\left(f'\\left(x\\right)\\right)^2 + 1}dy`} />
                                    </div>
                              ...
                              <div className="mt-3">
                                <BlockMath math={`L = \\int_a^b \\sqrt{\\left(x'\\left(t\\right)\\right)^2 + \\left(y'\\left(t\\right)\\right)^2}dt`} />
                              </div>
                              ...
                              <p className="mt-3">
                                ...
                                >
                                  ...
                                  <div className="mt-3">
                                    <BlockMath math={`L = \\int_a^b \\sqrt{\\left(r\\left(t\\right)\\right)^2 + \\left(r'\\left(t\\right)\\right)^2}dt`} />
                                  </div>
                                  ...
                                  <div className="mt-3">
                                    <BlockMath math={`r(t) = (${result?.tech_enter}) = ${result?.tech_diff}`} />
                                  </div>
                                  ...
                                  <p className="mt-3">
                                    ...
                                    <div className="mt-3">
                                      <BlockMath math={`L = \\int_a^b \\sqrt{\\left(x'(t)\\right)^2 + \\left(y'(t)\\right)^2 + \\left(z'(t)\\right)^2}dt`} />
                                    </div>
                                    ...
                                    <div className="mt-3">
                                      <BlockMath math={`x(t) = (${result?.tech_enter}) = ${result?.tech_diff}`} />
                                    </div>

                                    <div className="mt-3">
                                      <BlockMath math={`y(t) = (${result?.tech_enter1}) = ${result?.tech_diff1}`} />
                                    </div>

                                    <div className="mt-3">
                                      <BlockMath math={`z(t) = (${result?.tech_enter2}) = ${result?.tech_diff2}`} />
                                    </div>
