...
import { useGetSingleCalculatorDetailsMutation ,useRationalZerosCalculatorMutation} from "../../../../redux/services/calculator/calculatorApi";
            ...
            <div className="lg:w-[70%] md:w-[90%] w-full mx-auto ">
              <div className="grid grid-cols-12 mt-3   gap-2 ">
                  ...
                  <div className="col-span-4">
                      <label htmlFor="v1" className="text-[14px] text-blue-800">a<sub className="text-[12px] text-blue-800">1</sub>:</label>
                  ...
                  <div className="col-span-4">
                      <label htmlFor="v2" className="text-[14px] text-blue-800">a<sub className="text-[12px] text-blue-800">2</sub>:</label>
                      <div className="w-full py-2">
                         <input
                              type="number"
                              step="any"
                  ...
                  <div className="col-span-4">
                      <label htmlFor="v3" className="text-[14px] text-blue-800">a<sub className="text-[12px] text-blue-800">3</sub>:</label>
                      <div className="w-full py-2">
                        <input
                              type="number"
                              step="any"
                  ...
                  {parseInt(formData.tech_no_of) >= 3 && (
                    ...
                    <div className="col-span-4  vc4" id="a4">
                        <label htmlFor="v4" className="text-[14px] text-blue-800">a<sub className="text-[12px] text-blue-800">4</sub>:</label>
                        <div className="w-full py-2">
                            <input
                                type="number"
                                step="any"
                   ...
                   {parseInt(formData.tech_no_of) >= 4 && (
                    ...
                    <div className="col-span-4 vc5" id="a5">
                        <label htmlFor="v5" className="text-[14px] text-blue-800">a<sub className="text-[12px] text-blue-800">5</sub>:</label>
                        <div className="w-full py-2">
                            <input
                                type="number"
                                step="any"
                   ...
                   {parseInt(formData.tech_no_of) >= 5 && (
                    ...
                    <div className="col-span-4  vc6" id="a6">
                        <label htmlFor="v6" className="text-[14px] text-blue-800">a<sub className="text-[12px] text-blue-800">6</sub>:</label>
                        <div className="w-full py-2">
                            <input
                                type="number"
                                step="any"
                  ...
                  {parseInt(formData.tech_no_of) >= 6 && (
                    ...
                    <div className="col-span-4  vc7" id="a7">
                        <label htmlFor="v7" className="text-[14px] text-blue-800">a<sub className="text-[12px] text-blue-800">7</sub>:</label>
                        <div className="w-full py-2">
                            <input
                                type="number"
                                step="any"
                  ...
                  {parseInt(formData.tech_no_of) >= 7 && (
                    ...
                    <div className="col-span-4  vc8" id="a8">
                        <label htmlFor="v8" className="text-[14px] text-blue-800">a<sub className="text-[12px] text-blue-800">8</sub>:</label>
                        <div className="w-full py-2">
                            <input
                                type="number"
                                step="any"
                  ...
                  {parseInt(formData.tech_no_of) >= 8 && (
                    ...
                    <div className="col-span-4 vc9" id="a9">
                        <label htmlFor="v9" className="text-[14px] text-blue-800">a<sub className="text-[12px] text-blue-800">9</sub>:</label>
                        <div className="w-full py-2">
                          <input
                                type="number"
                                step="any"
                  ...
                  {parseInt(formData.tech_no_of) >= 9 && (
                    ...
                    <div className="col-span-4  vc10" id="a10">
                        <label htmlFor="v10" className="text-[14px] text-blue-800">a<sub className="text-[12px] text-blue-800">10</sub>:</label>
                        <div className="w-full py-2">
                            <input
                                type="number"
                                step="any"
                    ...
                    <div className="rounded-lg  flex items-center justify-center">
                        <div className="w-full mt-3">
                            <div className="w-full overflow-auto">
                              ...
                              <p>{renderMixedText(data?.payload?.tech_lang_keys[10])}</p>
                              <p className="mt-3">
                             ...
                             {result?.tech_uq?.map((val, i) => (
                                <React.Fragment key={i}>
                                  <p className="mt-3">
                                    {data?.payload?.tech_lang_keys[18] || ""} {val || ""}
                                  </p>

                                  <p className="mt-3">
                                    {data?.payload?.tech_lang_keys[19]}:{" "}
                                    <InlineMath math={extractMath(result?.tech_eq?.[i]) || ""} />
                                  </p>

                                  <p className="mt-3">
                                    <InlineMath math={extractMath(result?.tech_result?.[i]) || ""} />
                                  </p>

                                  <p className="mt-3">
                                    {data?.payload?.tech_lang_keys[14] || ""} {result?.tech_final_result?.[i]}
                                  </p>
                                </React.Fragment>
                              ))}
