...
import { useGetSingleCalculatorDetailsMutation ,useAreaOfASectorCalculatorMutation} from "../../../../redux/services/calculator/calculatorApi";
            ...
            {formError && (
             ...
             <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
               <div className="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                <p className="col-span-12  mb-2"><strong>{ data?.payload?.tech_lang_keys['8'] }:</strong> { data?.payload?.tech_lang_keys['9'] }.</p>
                                      ...
                                      <table className="w-full  md:text-[18px] text-[16px]">
                                        <tbody>
                                          ...
                                          {(result?.tech_mode==1) ? (
                                            <>
                                              <tr>
                                                  <td className="py-2 border-b"><strong>{ data?.payload?.tech_lang_keys['4'] } (A)</strong></td>
                                                  <td className="py-2 border-b">{Number(result?.tech_area).toFixed(2)} {result?.tech_unit}²</td>
                                              </tr>
                                              <tr>
                                                  <td className="py-2 border-b"><strong>{ data?.payload?.tech_lang_keys['5'] } (L)</strong></td>
                                                  <td className="py-2 border-b">{Number(result?.tech_arc).toFixed(2)} {result?.tech_unit}</td>
                                              </tr>
                                              <tr>
                                                  <td className="py-2 border-b"><strong>{ data?.payload?.tech_lang_keys['6'] } (c)</strong></td>
                                                  <td className="py-2 border-b">{Number(result?.tech_c).toFixed(2)} {result?.tech_unit}</td>
                                              </tr>
                                              <tr>
                                                  <td className="py-2 border-b"><strong>{ data?.payload?.tech_lang_keys['3'] }</strong></td>
                                                  <td className="py-2 border-b">{Number(result?.tech_dia).toFixed(2)} {result?.tech_unit}</td>
                                              </tr>
                                            </>
                                          ): (result?.tech_mode==2) ? (
                                            <>
                                              ...
                                              <tr>
                                                  <td className="py-2 border-b"><strong>{ data?.payload?.tech_lang_keys['2'] }</strong></td>
                                                  <td className="py-2 border-b">{Number(result?.tech_rad).toFixed(2)} {result?.tech_unit}</td>
                                              </tr>
                                            </>
                                          ):(result?.tech_mode==3) ? (
                                            <>
                                              ...
                                              <tr>
                                                  <td className="py-2 border-b"><strong>{ data?.payload?.tech_lang_keys['7'] }</strong></td>
                                                  <td className="py-2 border-b">{Number(result?.tech_angle).toFixed(2)} rad / {Number(rad2deg(result?.tech_angle)).toFixed(2)} deg</td>
                                              </tr>
                                              <tr>
                                                  <td className="py-2 border-b"><strong>{ data?.payload?.tech_lang_keys['5'] } (L)</strong></td>
                                                  <td className="py-2 border-b">{Number(result?.tech_arc).toFixed(2)} {result?.tech_unit}</td>
                                            ...
                                            <>
                                              ...
                                              <tr>
                                                  <td className="py-2 border-b"><strong>{ data?.payload?.tech_lang_keys['2'] } (L)</strong></td>
                                                  <td className="py-2 border-b">{Number(result?.tech_rad).toFixed(2)} {result?.tech_unit}</td>
                                              </tr>
                                              <tr>
                                                  <td className="py-2 border-b"><strong>{ data?.payload?.tech_lang_keys['6'] } (c)</strong></td>
                                            ...
                                            <>
                                              ...
                                              <tr>
                                                  <td className="py-2 border-b"><strong>{ data?.payload?.tech_lang_keys['6'] } (c)</strong></td>
                                                  <td className="py-2 border-b">{Number(result?.tech_x).toFixed(2)} {result?.tech_unit}</td>
                                              </tr>
                                              <tr>
                                                  <td className="py-2 border-b"><strong>{ data?.payload?.tech_lang_keys['2'] }</strong></td>
                                                  <td className="py-2 border-b">{Number(result?.tech_rad).toFixed(2)} {result?.tech_unit}</td>
