...
const BaseCalculator = () => {
  ...
  const handleKeyPress = (e) => {
    ...
    if (base === "2") {
      ...
      allowedKeys = [
        48, 49, 8, 50, 51, 52, 53, 54, 55, 56, 57, 65, 66, 67, 97, 98, 99,
      ]; // 0-9, A-C
    } else if (base === "14") {
      allowedKeys = [
        48, 49, 8, 50, 51, 52, 53, 54, 55, 56, 57, 65, 66, 67, 68, 97, 98, 99,
        100,
      ]; // 0-9, A-D
    } else if (base === "15") {
      allowedKeys = [
        48, 49, 8, 50, 51, 52, 53, 54, 55, 56, 57, 65, 66, 67, 68, 69, 97, 98,
        99, 100, 101,
      ]; // 0-9, A-E
    } else if (base === "16") {
      allowedKeys = [
        48, 49, 8, 50, 51, 52, 53, 54, 55, 56, 57, 65, 66, 67, 68, 69, 70, 97,
        98, 99, 100, 101, 102,
      ]; // 0-9, A-F
    } else if (base === "17") {
      allowedKeys = [
        48, 49, 8, 50, 51, 52, 53, 54, 55, 56, 57, 65, 66, 67, 68, 69, 70, 71,
      ...
      allowedKeys = [
        48, 49, 8, 50, 51, 52, 53, 54, 55, 56, 57, 65, 66, 67, 68, 69, 70, 71,
        72, 73, 97, 98, 99, 100, 101, 102, 103, 104, 105,
      ];
    } else if (base === "20") {
      allowedKeys = [
        48, 49, 8, 50, 51, 52, 53, 54, 55, 56, 57, 65, 66, 67, 68, 69, 70, 71,
        72, 73, 74, 97, 98, 99, 100, 101, 102, 103, 104, 105, 106,
      ];
    } else if (base === "21") {
      allowedKeys = [
        48, 49, 8, 50, 51, 52, 53, 54, 55, 56, 57, 65, 66, 67, 68, 69, 70, 71,
        72, 73, 74, 75, 97, 98, 99, 100, 101, 102, 103, 104, 105, 106, 107,
      ];
    } else if (base === "22") {
      allowedKeys = [
        48, 49, 8, 50, 51, 52, 53, 54, 55, 56, 57, 65, 66, 67, 68, 69, 70, 71,
        72, 73, 74, 75, 76, 97, 98, 99, 100, 101, 102, 103, 104, 105, 106, 107,
        108,
      ];
    } else if (base === "23") {
      allowedKeys = [
        48, 49, 8, 50, 51, 52, 53, 54, 55, 56, 57, 65, 66, 67, 68, 69, 70, 71,
        72, 73, 74, 75, 76, 77, 97, 98, 99, 100, 101, 102, 103, 104, 105, 106,
        107, 108, 109,
      ];
    } else if (base === "24") {
      allowedKeys = [
        48, 49, 8, 50, 51, 52, 53, 54, 55, 56, 57, 65, 66, 67, 68, 69, 70, 71,
        72, 73, 74, 75, 76, 77, 78, 97, 98, 99, 100, 101, 102, 103, 104, 105,
        106, 107, 108, 109, 110,
      ];
    } else if (base === "25") {
      allowedKeys = [
        48, 49, 8, 50, 51, 52, 53, 54, 55, 56, 57, 65, 66, 67, 68, 69, 70, 71,
        72, 73, 74, 75, 76, 77, 78, 79, 97, 98, 99, 100, 101, 102, 103, 104,
        105, 106, 107, 108, 109, 110, 111,
      ];
    } else if (base === "26") {
      allowedKeys = [
        48, 49, 8, 50, 51, 52, 53, 54, 55, 56, 57, 65, 66, 67, 68, 69, 70, 71,
        72, 73, 74, 75, 76, 77, 78, 79, 80, 97, 98, 99, 100, 101, 102, 103, 104,
        105, 106, 107, 108, 109, 110, 111, 112,
      ];
    } else if (base === "27") {
      allowedKeys = [
        48, 49, 8, 50, 51, 52, 53, 54, 55, 56, 57, 65, 66, 67, 68, 69, 70, 71,
        72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 97, 98, 99, 100, 101, 102, 103,
        104, 105, 106, 107, 108, 109, 110, 111, 112, 113,
      ];
    } else if (base === "28") {
      allowedKeys = [
        48, 49, 8, 50, 51, 52, 53, 54, 55, 56, 57, 65, 66, 67, 68, 69, 70, 71,
        72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 97, 98, 99, 100, 101, 102,
        103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114,
      ];
    } else if (base === "29") {
      allowedKeys = [
        48, 49, 8, 50, 51, 52, 53, 54, 55, 56, 57, 65, 66, 67, 68, 69, 70, 71,
        72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 97, 98, 99, 100, 101,
        102, 103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114, 115,
      ];
    } else if (base === "30") {
      allowedKeys = [
        48, 49, 8, 50, 51, 52, 53, 54, 55, 56, 57, 65, 66, 67, 68, 69, 70, 71,
        72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 84, 97, 98, 99, 100,
      ...
      allowedKeys = [
        48, 49, 8, 50, 51, 52, 53, 54, 55, 56, 57, 65, 66, 67, 68, 69, 70, 71,
        72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 84, 85, 97, 98, 99, 100,
        101, 102, 103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114,
        115, 116, 117,
      ];
    } else if (base === "32") {
      allowedKeys = [
        48, 49, 8, 50, 51, 52, 53, 54, 55, 56, 57, 65, 66, 67, 68, 69, 70, 71,
        72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 84, 85, 86, 97, 98, 99,
      ...
      allowedKeys = [
        48, 49, 8, 50, 51, 52, 53, 54, 55, 56, 57, 65, 66, 67, 68, 69, 70, 71,
        72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 84, 85, 86, 87, 97, 98,
      ...
      allowedKeys = [
        48, 49, 8, 50, 51, 52, 53, 54, 55, 56, 57, 65, 66, 67, 68, 69, 70, 71,
        72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 84, 85, 86, 87, 88, 97,
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const apiError =
        response?.payload?.error || "Failed to calculate. Please try again.";
            ...
            <div className="w-full mx-auto p-4 result_calculator rounded-lg space-y-6">
              <div>
                ...
                <div className=" rounded-xl text-lg p-2">
                    ...
                    <div className="w-full mt-3">
                      <div className="w-full">
                        <div className="text-center">
                          ...
                          <p className="md:text-4xl bg-[#2845F5] text-[#fff] px-6 py-4 rounded-lg inline-block my-3">
                            <strong className="">
                  ...
                  <div className="bg-sky bordered rounded-lg p-6 mb-6 mt-6">
                    <h3 className="text-lg font-semibold mb-4 text-gray-800">
                      Input Information
                    </h3>
                    <div className="space-y-2 text-sm">
                      <p>
                        <strong>Base:</strong> {result?.input?.base} (
                        {result?.input?.base_name})
                      </p>
                      <p>
                  ...
                  {result?.step_by_step && (
                    <div className="bg-sky bordered rounded-lg p-6">
                      <h3 className="text-lg font-semibold mb-4 text-blue-800">
                        Step-by-Step Solution
                      </h3>
                      <div className="space-y-3">
                        {Object.entries(result.step_by_step).map(
                          ([key, value], index) => (
