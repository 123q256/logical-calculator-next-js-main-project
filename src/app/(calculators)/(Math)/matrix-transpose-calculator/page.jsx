...
const MatrixTransposeCalculator = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const matrixPayload = {};
    const rows = parseInt(formData.tech_matrix2);
    const cols = parseInt(formData.tech_matrix22);

    for (let i = 1; i <= rows; i++) {
      for (let j = 1; j <= cols; j++) {
        const key = `tech_matrix3${i}_${j}`;
        if (!formData[key]) {
          setFormError("Please fill all matrix B values.");
          return;
        }
        matrixPayload[key] = Number(formData[key]);
      }
    }
  ...
  // resul
  const renderMatrixLatex = (matrix) => {
        ...
        <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg space-y-6 mb-3">
          ...
          <div className="lg:w-[100%] md:w-[100%] w-full mx-auto ">
            <div className="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
              <p className="col-span-12  mt-0 mt-lg-2 text-[16px] text-blue px-1">
              ...
              <div className="col-span-12 overflow-auto">
                <table width={300} className="md:w-[100%] overflow-auto">
                  {table}
                </table>
              </div>
            </div>
                      ...
                      <div className="w-full">
                        <div className="w-full text-[16px] overflow-auto">
                          ...
                          <div className="mt-2 text-[18px]">
                            <BlockMath
                              math={`\\begin{bmatrix} ${renderMatrixLatex(
                                result?.tech_jawab
                              )} \\end{bmatrix}`}
                            />
                          </div>
                          ...
                          <div className="mt-2">
                            <BlockMath
                              math={`\\text{Calculate } \\begin{bmatrix} ${renderMatrixLatex(
                                result?.tech_zain
                          ...
                          <div className="mt-2">
                            <BlockMath
                              ...
                              }} \\begin{bmatrix} ${renderMatrixLatex(
                                result?.tech_jawab
                              )} \\end{bmatrix}`}
                            />
                          </div>
...
export default MatrixTransposeCalculator;
