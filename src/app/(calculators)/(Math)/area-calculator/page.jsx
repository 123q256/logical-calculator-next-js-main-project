...
import { useGetSingleCalculatorDetailsMutation ,useAreaCalculatorMutation} from "../../../../redux/services/calculator/calculatorApi";
            ...
            <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
              <div className="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                <div className="col-span-12 md:col-span-6">
                    <div className="col-12">
                        ...
                        <div className="mt-2">
                          ...
                          >
                            <option value="square">{data?.payload?.tech_lang_keys["2"]}</option>
                            <option value="rectangle">{data?.payload?.tech_lang_keys["3"]}</option>
                            <option value="triangle">{data?.payload?.tech_lang_keys["4"]}</option>
                            <option value="circle">{data?.payload?.tech_lang_keys["5"]}</option>
                            <option value="semicircle">{data?.payload?.tech_lang_keys["6"]}</option>
                            <option value="sector">{data?.payload?.tech_lang_keys["7"]}</option>
                            <option value="ellipse">{data?.payload?.tech_lang_keys["8"]}</option>
                            <option value="trapezoid">{data?.payload?.tech_lang_keys["9"]}</option>
                            <option value="parallelogram">{data?.payload?.tech_lang_keys["10"]}</option>
                            <option value="rhombus">{data?.payload?.tech_lang_keys["11"]}</option>
                            <option value="kite">{data?.payload?.tech_lang_keys["12"]}</option>
                            <option value="regular pentagon">{data?.payload?.tech_lang_keys["13"]}</option>
                            <option value="regular hexagon">{data?.payload?.tech_lang_keys["14"]}</option>
                            <option value="regular octagon">{data?.payload?.tech_lang_keys["15"]}</option>
                            <option value="annulus (ring)">{data?.payload?.tech_lang_keys["16"]}</option>
                            <option value="irregular quadrilateral">{data?.payload?.tech_lang_keys["17"]}</option>
                            <option value="regular polygon">{data?.payload?.tech_lang_keys["18"]}</option>
                          </select>
                        </div>  
                        
                    </div>
                    {((formData.tech_shapes == "circle") || (formData.tech_shapes == "semicircle") || (formData.tech_shapes == "sector") || (formData.tech_shapes == "annulus (ring)"))  && (
                      <>
                      ...
                      <div className="col-12 test1">
                        ...
                        <div className="mt-2">
                          <select
                            ...
                            onChange={handleChange}
                          >
                            <option value="1">{data?.payload?.tech_lang_keys["21"]} </option>
                            <option value="2">{data?.payload?.tech_lang_keys["22"]} (SSS) </option>
                            <option value="3">{data?.payload?.tech_lang_keys["23"]} (SAS) </option>
                            <option value="4">{data?.payload?.tech_lang_keys["24"]} (ASA)</option>
                          </select>
                        </div>
                      </div>
                      ...
                      <>
                        <div className="col-12 test2">
                          ...
                          <div className="mt-2">
                            ...
                            >
                              <option value="1">{data?.payload?.tech_lang_keys["21"]} </option>
                              <option value="2">{data?.payload?.tech_lang_keys["25"]}  </option>
                              <option value="3">{data?.payload?.tech_lang_keys["26"]} </option>
                            </select>
                          </div>
                    ...
                    {(formData.tech_shapes == "rhombus") && (
                      <>
                        <div className="col-12 test3">
                            <label htmlFor="tech_find_triangle_three" className="label">
                            {data?.payload?.tech_lang_keys["20"]}:
                          </label>
                          <div className="mt-2">
                            <select
                            ...
                            >
                              <option value="1">{data?.payload?.tech_lang_keys["21"]} </option>
                              <option value="2">{data?.payload?.tech_lang_keys["27"]}  </option>
                              <option value="3">{data?.payload?.tech_lang_keys["28"]} </option>
                            </select>
                          </div>
                      ...
                      <>
                        <div className="col-12 test4">
                            <label htmlFor="tech_find_triangle_four" className="label">
                              {data?.payload?.tech_lang_keys["20"]}:
                            </label>
                            <div className="mt-2">
                              <select
                                ...
                                onChange={handleChange}
                              >
                                <option value="1">{data?.payload?.tech_lang_keys["27"]} </option>
                                <option value="2">{data?.payload?.tech_lang_keys["29"]}  </option>
                              </select>
                            </div>
                        </div>
                      </>
                    ...
                    {((formData.tech_shapes == "sector") || (formData.tech_shapes == "irregular quadrilateral") || (formData.tech_shapes == "parallelogram" && formData.tech_find_triangle_two == "2")  || (formData.tech_shapes == "rhombus" && formData.tech_find_triangle_three == "3" ) || (formData.tech_shapes == "kite" && formData.tech_find_triangle_four == "2")) && (
                      <>
                    ...
                    {((formData.tech_shapes == "triangle" && formData.tech_find_triangle == "4")) && (
                      <>
                      ...
                      {( (formData.tech_shapes == "parallelogram" && formData.tech_find_triangle_two == "3")) && (
                        <>
                      ...
                      {((formData.tech_shapes == "triangle" && formData.tech_find_triangle == "3") || (formData.tech_shapes == "triangle" && formData.tech_find_triangle == "4")) && (
                        <>
                      ...
                      {((formData.tech_shapes == "irregular quadrilateral") || (formData.tech_shapes == "parallelogram" && formData.tech_find_triangle_two == "3")  || (formData.tech_shapes == "rhombus" && formData.tech_find_triangle_three == "2" ) || (formData.tech_shapes == "kite" && formData.tech_find_triangle_four == "1") ) && (
                        <>
                    ...
                    {((formData.tech_shapes == "square") || (formData.tech_shapes == "rectangle") || (formData.tech_shapes == "triangle" && formData.tech_find_triangle == "2") ||  (formData.tech_shapes == "triangle" && formData.tech_find_triangle == "3") || (formData.tech_shapes == "triangle" && formData.tech_find_triangle == "4")  || (formData.tech_shapes == "ellipse") || (formData.tech_shapes == "trapezoid") || (formData.tech_shapes == "regular pentagon") || (formData.tech_shapes == "regular hexagon") || (formData.tech_shapes == "regular octagon") || (formData.tech_shapes == "regular polygon") || (formData.tech_shapes == "parallelogram" && formData.tech_find_triangle_two == "2")  || (formData.tech_shapes == "rhombus" && formData.tech_find_triangle_three == "1" )  || (formData.tech_shapes == "rhombus" && formData.tech_find_triangle_three == "3" ) || (formData.tech_shapes == "kite" && formData.tech_find_triangle_four == "2"))  && (
                      <>
                      ...
                      {( (formData.tech_shapes == "rectangle") || (formData.tech_shapes == "triangle" && formData.tech_find_triangle == "1") || (formData.tech_shapes == "triangle" && formData.tech_find_triangle == "2") || (formData.tech_shapes == "triangle" && formData.tech_find_triangle == "3")  || (formData.tech_shapes == "ellipse" ) || (formData.tech_shapes == "trapezoid") || (formData.tech_shapes == "parallelogram" && formData.tech_find_triangle_two == "1") || (formData.tech_shapes == "parallelogram" && formData.tech_find_triangle_two == "2") || (formData.tech_shapes == "kite" && formData.tech_find_triangle_four == "2")) && (
                      <>
                    ...
                    {((formData.tech_shapes == "triangle" && formData.tech_find_triangle == "1") || (formData.tech_shapes == "trapezoid") || (formData.tech_shapes == "parallelogram" && formData.tech_find_triangle_two == "1") || (formData.tech_shapes == "rhombus" && formData.tech_find_triangle_three == "1" ) ) && (
                      <>
                      ...
                      {((formData.tech_shapes == "triangle" && formData.tech_find_triangle == "2")) && (
                      <>
                ...
                <div className="col-span-12 md:col-span-6 flex items-center justify-center">
                  {formData.tech_shapes == "square" && ( <> <img   src="/images/sav1.svg"  alt="Flow Rate Calculator" width="130" height="130" className="change_img"/>  </> )}
                  {formData.tech_shapes == "rectangle" && ( <> <img   src="/images/sav2.svg"  alt="Flow Rate Calculator" width="130" height="130" className="change_img"/>  </> )}
                  ...
                  {formData.tech_shapes == "triangle" && ( 
                    ...
                    {formData.tech_find_triangle == "1" && (
                      ...
                      <img   src="/images/sav12.svg"  alt="Flow Rate Calculator" width="130" height="130" className="change_img"/> 
                      </>
                    )}
                      {formData.tech_find_triangle == "2" && (
                      <>
                      <img   src="/images/sav4.svg"  alt="Flow Rate Calculator" width="130" height="130" className="change_img"/> 

                      </>
                    )}
                      {formData.tech_find_triangle == "3" && (
                      <>
                      <img   src="/images/sav5.svg"  alt="Flow Rate Calculator" width="130" height="130" className="change_img"/> 

                      </>
                    )}
                      {formData.tech_find_triangle == "4" && (
                      <>
                        <img   src="/images/sav6.svg"  alt="Flow Rate Calculator" width="130" height="130" className="change_img"/> 
                      </>
                    )}
                    
                    </> )}
                
                  {formData.tech_shapes == "circle" && ( <> <img   src="/images/sav7.svg"  alt="Flow Rate Calculator" width="130" height="130" className="change_img"/>  </> )}
                  {formData.tech_shapes == "semicircle" && ( <> <img   src="/images/sav8.svg"  alt="Flow Rate Calculator" width="130" height="130" className="change_img"/>  </> )}
                  {formData.tech_shapes == "sector" && ( <> <img   src="/images/sav9.svg"  alt="Flow Rate Calculator" width="130" height="130" className="change_img"/>  </> )}
                  {formData.tech_shapes == "ellipse" && ( <> <img   src="/images/sav10.svg"  alt="Flow Rate Calculator" width="130" height="130" className="change_img"/>  </> )}
                  {formData.tech_shapes == "trapezoid" && ( <> <img   src="/images/sav11.svg"  alt="Flow Rate Calculator" width="130" height="130" className="change_img"/>  </> )}
                  ...
                  {formData.tech_shapes == "parallelogram" && ( 
                    ...
                    {formData.tech_find_triangle_two == "2" && (
                      <>
                    <img   src="/images/sav13.svg"  alt="Flow Rate Calculator" width="130" height="130" className="change_img"/> 
                      </>
                    )}
                    {formData.tech_find_triangle_two == "3" && (
                      <>
                      <img   src="/images/sav14.svg"  alt="Flow Rate Calculator" width="130" height="130" className="change_img"/>   
                      </>
                    )}
                  ...
                  {formData.tech_shapes == "rhombus" && ( 
                    ...
                    {formData.tech_find_triangle_three == "1" && (
                      <>
                    <img   src="/images/sav16.svg"  alt="Flow Rate Calculator" width="130" height="130" className="change_img"/> 
                      </>
                    )}
                      {formData.tech_find_triangle_three == "2" && (
                      <>
                      <img   src="/images/sav17.svg"  alt="Flow Rate Calculator" width="130" height="130" className="change_img"/>  
                      </>
                    )}

                      {formData.tech_find_triangle_three == "3" && (
                      <>
                      <img   src="/images/sav15.svg"  alt="Flow Rate Calculator" width="130" height="130" className="change_img"/>  
                      </>
                    )}
                  ...
                  {formData.tech_find_triangle_four == "1" && (
                    <>
                    <img   src="/images/sav18.svg"  alt="Flow Rate Calculator" width="130" height="130" className="change_img"/> 

                    </>
                  )}
                  {formData.tech_find_triangle_four == "2" && (
                    <>
                      <img   src="/images/sav19.svg"  alt="Flow Rate Calculator" width="130" height="130" className="change_img"/> 
                    </>
                  )}
                  
                    </> )}
                
                  {formData.tech_shapes == "regular pentagon" && ( <> <img   src="/images/sav20.svg"  alt="Flow Rate Calculator" width="130" height="130" className="change_img"/>  </> )}
                  {formData.tech_shapes == "regular hexagon" && ( <> <img   src="/images/sav21.svg"  alt="Flow Rate Calculator" width="130" height="130" className="change_img"/>  </> )}
                  {formData.tech_shapes == "regular octagon" && ( <> <img   src="/images/sav22.svg"  alt="Flow Rate Calculator" width="130" height="130" className="change_img"/>  </> )}
                  {formData.tech_shapes == "annulus (ring)" && ( <> <img   src="/images/sav23.svg"  alt="Flow Rate Calculator" width="130" height="130" className="change_img"/>  </> )}
                  {formData.tech_shapes == "irregular quadrilateral" && ( <> <img   src="/images/sav24.svg"  alt="Flow Rate Calculator" width="130" height="130" className="change_img"/>  </> )}
                  {formData.tech_shapes == "regular polygon" && ( <> <img   src="/images/sav25.svg"  alt="Flow Rate Calculator" width="130" height="130" className="change_img"/>  </> )}
                      ...
                      <div className="rounded-lg  flex items-center justify-center">
                        <div className="w-full mt-3">
                            <div className="w-full my-2 text-center">
                               {(result?.tech_method=="1") && (
                                <>
                                  ...
                                  <p className="text-[18px] md:text-[20px]">
                                    <strong>{data?.payload?.tech_lang_keys['2']} {data?.payload?.tech_lang_keys['32']}</strong>
                                  </p>
                                  <p className="text-[32px] bg-[#2845F5] text-[#fff] px-3 py-2 rounded-lg inline-block my-2">
                                    <strong className="text-blue">
                                      {Number(result?.tech_answer).toFixed(2)}
                                      <span className="text-[18px] md:text-[20px]"> (cm<sup>2</sup>)</span>
                                    </strong>
                                  </p>
                                </div>

                                <p className="mt-2">
                                  <strong>{data?.payload?.tech_lang_keys['36']} :</strong>
                                </p>
                                <p className="mt-2">
                                  <BlockMath math={`${data?.payload?.tech_lang_keys['2']}\\ ${data?.payload?.tech_lang_keys['32']} = a^2`} />
                                </p>
                                ...
                                <p className="mt-2">
                                  <strong>{data?.payload?.tech_lang_keys['37']} :</strong>
                                </p>
                                <p className="mt-2">
                                  <BlockMath math={`${data?.payload?.tech_lang_keys['2']}\\ ${data?.payload?.tech_lang_keys['32']} = (${result?.tech_area})^2`} />
                                </p>

                                <p className="mt-2">
                                  <BlockMath math={`${data?.payload?.tech_lang_keys['2']}\\ ${data?.payload?.tech_lang_keys['32']} = ${Number(result?.tech_answer).toFixed(2)}`} />
                                  <span className="text-black"> (cm<sup>2</sup>)</span>
                                </p>
                                </>
                               )}
                                ...
                                <div className="text-center">
                                <p className="text-[18px] md:text-[20px]">
                                  <strong>{data?.payload?.tech_lang_keys['3']} {data?.payload?.tech_lang_keys['32']}</strong>
                                </p>
                                <p className="text-[32px] bg-[#2845F5] text-[#fff] px-3 py-2 rounded-lg inline-block my-2">
                                  <strong className="text-blue">
                                    {Number(result?.tech_answer).toFixed(2)}
                              ...
                              <p className="mt-2">
                                <BlockMath
                                  math={`${data?.payload?.tech_lang_keys['3']}\\ ${data?.payload?.tech_lang_keys['32']} = ${Number(result?.tech_answer).toFixed(2)}`}
                                />
                                <span className="text-black"> (cm<sup>2</sup>)</span>
                              </p>
                                  </>
                               ...
                               {(result?.tech_method=="31") && (
                                <>
                                 <div className="text-center">
                                <p className="text-[18px] md:text-[20px]">
                                  <strong>{data?.payload?.tech_lang_keys['4']} {data?.payload?.tech_lang_keys['32']}</strong>
                                </p>
                                <p className="text-[32px] bg-[#2845F5] text-[#fff] px-3 py-2 rounded-lg inline-block my-2">
                                  <strong className="text-blue">
                                    {Number(result?.tech_answer).toFixed(2)}
                              ...
                              <p className="mt-2">
                                <BlockMath
                                  math={`${data?.payload?.tech_lang_keys['4']}\\ ${data?.payload?.tech_lang_keys['32']} = ${Number(result?.tech_answer).toFixed(2)}`}
                                />
                                <span className="text-black"> (cm<sup>2</sup>)</span>
                              </p>
                                ...
                                <>
                                 <div className="text-center">
                                  <p className="text-[18px] md:text-[20px]">
                                    <strong>{data?.payload?.tech_lang_keys['10']} {data?.payload?.tech_lang_keys['32']}</strong>
                                  </p>
                                  <p className="text-[32px] bg-[#2845F5] text-[#fff] px-3 py-2 rounded-lg inline-block my-2">
                                    <strong className="text-blue">
                                      {Number(result?.tech_answer).toFixed(2)}
                                ...
                                <p className="mt-2">
                                  <BlockMath
                                    math={`${data?.payload?.tech_lang_keys['10']}\\ ${data?.payload?.tech_lang_keys['32']} = ${Number(result?.tech_answer).toFixed(2)}`}
                                  />
                                  <span className="text-black"> (cm<sup>2</sup>)</span>
                                </p>
                            ...
                            <p className="mt-2">
                              ...
                              <div className="text-center">
                              <p className="text-[18px] md:text-[20px]">
                                <strong>{data?.payload?.tech_lang_keys['11']} {data?.payload?.tech_lang_keys['32']}</strong>
                              </p>
                              <p className="text-[32px] bg-[#2845F5] text-[#fff] px-3 py-2 rounded-lg inline-block my-2">
                                <strong className="text-blue">
                                  {Number(result?.tech_answer).toFixed(2)}
                            ...
                            <p className="mt-2">
                              <BlockMath
                                math={`${data?.payload?.tech_lang_keys['11']}\\ ${data?.payload?.tech_lang_keys['32']} = ${Number(result?.tech_answer).toFixed(2)}`}
                              />
                              <span className="text-black"> (cm<sup>2</sup>)</span>
                            </p>
                              ...
                              <div className="text-center">
                                <p className="text-[18px] md:text-[20px]">
                                  <strong>{data?.payload?.tech_lang_keys['12']} {data?.payload?.tech_lang_keys['32']}</strong>
                                </p>
                                <p className="text-[32px] bg-[#2845F5] text-[#fff] px-3 py-2 rounded-lg inline-block my-2">
                                  <strong className="text-blue">
                                    {Number(result?.tech_answer).toFixed(2)}
                              ...
                              <p className="mt-2">
                                <BlockMath
                                  math={`${data?.payload?.tech_lang_keys['12']}\\ ${data?.payload?.tech_lang_keys['32']} = ${Number(result?.tech_answer).toFixed(2)}`}
                                />
                                <span className="text-black"> (cm<sup>2</sup>)</span>
                              </p>
                               </>
                             ...
                             <div className="text-center">
                                <p className="text-[18px] md:text-[20px]">
                                  <strong>{data?.payload?.tech_lang_keys['5']} {data?.payload?.tech_lang_keys['32']}</strong>
                                </p>
                                <p className="text-[32px] bg-[#2845F5] text-[#fff] px-3 py-2 rounded-lg inline-block my-2">
                                  <strong className="text-blue">
                                    {Number(result?.tech_answer).toFixed(2)}
                              ...
                              <p className="mt-2">
                                <BlockMath
                                  math={`${data?.payload?.tech_lang_keys['5']}\\ ${data?.payload?.tech_lang_keys['32']} = ${Number(result?.tech_answer).toFixed(2)}`}
                                />
                                <span className="text-black"> (cm<sup>2</sup>)</span>
                              </p>
                               ...
                               <>
                                <div className="text-center">
                                <p className="text-[18px] md:text-[20px]">
                                  <strong>{data?.payload?.tech_lang_keys['6']} {data?.payload?.tech_lang_keys['32']}</strong>
                                </p>
                                <p className="text-[32px] bg-[#2845F5] text-[#fff] px-3 py-2 rounded-lg inline-block my-2">
                                  <strong className="text-blue">
                                    {Number(result?.tech_answer).toFixed(2)}
                              ...
                              <p className="mt-2">
                                <BlockMath
                                  math={`${data?.payload?.tech_lang_keys['6']}\\ ${data?.payload?.tech_lang_keys['32']} = ${Number(result?.tech_answer).toFixed(2)}`}
                                />
                                <span className="text-black"> (cm<sup>2</sup>)</span>
                              </p>
                               </>
                                ...
                                <div className="text-center">
                                  <p className="text-[18px] md:text-[20px]">
                                    <strong>
                                      {data?.payload?.tech_lang_keys['6']} {data?.payload?.tech_lang_keys['7']} {data?.payload?.tech_lang_keys['32']}
                                    </strong>
                                  </p>
                                  <p className="text-[32px] bg-[#2845F5] text-[#fff] px-3 py-2 rounded-lg inline-block my-2">
                                    <strong className="text-blue">
                                ...
                                <p className="mt-2">
                                  <BlockMath math={`r = ${result?.tech_radius}, \\quad \\alpha = ${result?.tech_angle_value}`} />
                                </p>
                                ...
                                <p className="mt-2">
                                  <BlockMath
                                    math={`${data?.payload?.tech_lang_keys['6']}\\ ${data?.payload?.tech_lang_keys['7']}\\ ${data?.payload?.tech_lang_keys['32']} = ${Number(result?.tech_answer).toFixed(2)}`}
                                  />
                                  <span className="text-black"> (cm<sup>2</sup>)</span>
                                </p>
                               ...
                               <div className="text-center">
                                  <p className="text-[18px] md:text-[20px]">
                                    <strong>{data?.payload?.tech_lang_keys['8']} {data?.payload?.tech_lang_keys['32']}</strong>
                                  </p>
                                  <p className="text-[32px] bg-[#2845F5] text-[#fff] px-3 py-2 rounded-lg inline-block my-2">
                                    <strong className="text-blue">
                                      {Number(result?.tech_answer).toFixed(2)}
                                ...
                                <p className="mt-2">
                                  <BlockMath math={`${data?.payload?.tech_lang_keys['8']}\\ ${data?.payload?.tech_lang_keys['32']} = \\pi a b`} />
                                </p>
                                ...
                                <p className="mt-2">
                                  <BlockMath math={`a = ${result?.tech_area}, \\quad b = ${result?.tech_box}`} />
                                </p>
                                ...
                                <p className="mt-2">
                                  <BlockMath math={`${data?.payload?.tech_lang_keys['8']}\\ ${data?.payload?.tech_lang_keys['32']} = 3.14159265358 \\times ${result?.tech_area} \\times ${result?.tech_box}`} />
                                </p>

                                <p className="mt-2">
                                  <BlockMath
                                    math={`${data?.payload?.tech_lang_keys['8']}\\ ${data?.payload?.tech_lang_keys['32']} = ${Number(result?.tech_answer).toFixed(2)}`}
                                  />
                                  <span className="text-black"> (cm<sup>2</sup>)</span>
                                </p>
                               </>
                             ...
                             <div className="text-center">
                              <p className="text-[18px] md:text-[20px]">
                                <strong>{data?.payload?.tech_lang_keys['9']} {data?.payload?.tech_lang_keys['32']}</strong>
                              </p>
                              <p className="text-[32px] bg-[#2845F5] text-[#fff] px-3 py-2 rounded-lg inline-block my-2">
                                <strong className="text-blue">
                                  {Number(result?.tech_answer).toFixed(2)}
                            ...
                            <p className="mt-2">
                              <BlockMath math={`${data?.payload?.tech_lang_keys['9']}\\ ${data?.payload?.tech_lang_keys['32']} = \\frac{(a + b) \\times h}{2}`} />
                            </p>
                            ...
                            <p className="mt-2">
                              <BlockMath math={`a = ${result?.tech_area},\\quad b = ${result?.tech_box},\\quad h = ${result?.tech_height}`} />
                            </p>
                            ...
                            <p className="mt-2">
                              <BlockMath math={`${data?.payload?.tech_lang_keys['9']}\\ ${data?.payload?.tech_lang_keys['32']} = \\frac{(${result?.tech_area} + ${result?.tech_box}) \\times ${result?.tech_height}}{2}`} />
                            </p>

                            <p className="mt-2">
                              <BlockMath
                                math={`${data?.payload?.tech_lang_keys['9']}\\ ${data?.payload?.tech_lang_keys['32']} = ${Number(result?.tech_answer).toFixed(2)}`}
                              />
                              <span className="text-black"> (cm<sup>2</sup>)</span>
                            </p>
                               ...
                               <>
                                <div className="text-center">
                                    <p className="text-[18px] md:text-[20px]">
                                      <strong>{data?.payload?.tech_lang_keys['13']} {data?.payload?.tech_lang_keys['32']}</strong>
                                    </p>
                                    <p className="text-[32px] bg-[#2845F5] text-[#fff] px-3 py-2 rounded-lg inline-block my-2">
                                      <strong className="text-blue">
                                        {Number(result?.tech_answer).toFixed(2)}
                                  ...
                                  <p className="mt-2">
                                    <BlockMath math={`${data?.payload?.tech_lang_keys['13']}\\ ${data?.payload?.tech_lang_keys['32']} = ${Number(result?.tech_answer).toFixed(2)}`} />
                                    <span className="text-black"> (cm<sup>2</sup>)</span>
                                  </p>
                               ...
                               <div className="text-center">
                                  <p className="text-[18px] md:text-[20px]">
                                    <strong>{data?.payload?.tech_lang_keys['14']} {data?.payload?.tech_lang_keys['32']}</strong>
                                  </p>
                                  <p className="text-[32px] bg-[#2845F5] text-[#fff] px-3 py-2 rounded-lg inline-block my-2">
                                    <strong className="text-blue">
                                      {Number(result?.tech_answer).toFixed(2)}
                                ...
                                <p className="mt-2">
                                  <BlockMath math={`${data?.payload?.tech_lang_keys['14']}\\ ${data?.payload?.tech_lang_keys['32']} = \\frac{3}{2} \\sqrt{3} a^2`} />
                                </p>
                                ...
                                <p className="mt-2">
                                  <BlockMath math={`${data?.payload?.tech_lang_keys['14']}\\ ${data?.payload?.tech_lang_keys['32']} = \\frac{3}{2} \\sqrt{3} ${result?.tech_area}^2`} />
                                </p>

                                <p className="mt-2">
                                  <BlockMath math={`${data?.payload?.tech_lang_keys['14']}\\ ${data?.payload?.tech_lang_keys['32']} = ${Number(result?.tech_answer).toFixed(2)}`} />
                                  <span className="text-black"> (cm<sup>2</sup>)</span>
                                </p>
                                ...
                                <>
                                 <div className="text-center">
                                  <p className="text-[18px] md:text-[20px]">
                                    <strong>{data?.payload?.tech_lang_keys['15']} {data?.payload?.tech_lang_keys['32']}</strong>
                                  </p>
                                  <p className="text-[32px] bg-[#2845F5] text-[#fff] px-3 py-2 rounded-lg inline-block my-2">
                                    <strong className="text-blue">
                                      {Number(result?.tech_answer).toFixed(2)}
                                  ...
                                  <p className="mt-2"><strong>{data?.payload?.tech_lang_keys['36']} :</strong></p>
                                  <p className="mt-2">
                                    <BlockMath
                                  ...
                                  <p className="mt-2"><strong>Input :</strong></p>
                                  <p className="mt-2">
                                    <BlockMath math={`a = ${result?.tech_area}`} />
                                  </p>

                                  <p className="mt-2"><strong>{data?.payload?.tech_lang_keys['37']} :</strong></p>
                                  <p className="mt-2">
                                    <BlockMath
                                  ...
                                  <p className="mt-2">
                                    <BlockMath
                                      math={`${data?.payload?.tech_lang_keys['15']}\\ ${data?.payload?.tech_lang_keys['32']} = ${Number(result?.tech_answer).toFixed(2)}`}
                                    />
                                    <span className="text-black"> (cm<sup>2</sup>)</span>
                                  </p>
                                </div>
                              ...
                              <div className="text-center">
                                <p className="text-[18px] md:text-[20px]">
                                  <strong>{data?.payload?.tech_lang_keys['16']} {data?.payload?.tech_lang_keys['32']}</strong>
                                </p>
                                <p className="text-[32px] bg-[#2845F5] text-[#fff] px-3 py-2 rounded-lg inline-block my-2">
                                  <strong className="text-blue">
                                    {Number(result?.tech_answer).toFixed(2)}
                                ...
                                <p className="mt-2">
                                  <BlockMath
                                    math={`${data?.payload?.tech_lang_keys['16']}\\ ${data?.payload?.tech_lang_keys['32']} = ${Number(result?.tech_answer).toFixed(2)}`}
                                  />
                                  <span className="text-black"> (cm<sup>2</sup>)</span>
                                </p>
                              </div>
                               ...
                               <div className="text-center">
                                  <p className="text-[18px] md:text-[20px]">
                                    <strong>{data?.payload?.tech_lang_keys['17']} {data?.payload?.tech_lang_keys['32']}</strong>
                                  </p>
                                  <p className="text-[32px] bg-[#2845F5] text-[#fff] px-3 py-2 rounded-lg inline-block my-2">
                                    <strong className="text-blue">
                                      {Number(result?.tech_answer).toFixed(2)}
                                  ...
                                  <p className="mt-2"><strong>Input :</strong></p>
                                  <p className="mt-2">
                                    e = {result?.tech_e}, f = {result?.tech_f}, α = {result?.tech_angle_value}
                                  </p>
                                  ...
                                  <p className="mt-2">
                                    <BlockMath
                                      math={`${data?.payload?.tech_lang_keys['17']}\\ ${data?.payload?.tech_lang_keys['32']} = ${Number(result?.tech_answer).toFixed(2)}`}
                                    />
                                    <span className="black-text"> (cm<sup>2</sup>)</span>
                                  </p>
                                </div>
                              ...
                              <div className="text-center">
                              <p className="text-[18px] md:text-[20px]">
                                <strong>{data?.payload?.tech_lang_keys['18']} {data?.payload?.tech_lang_keys['32']}</strong>
                              </p>
                              <p className="text-[32px] bg-[#2845F5] text-[#fff] px-3 py-2 rounded-lg inline-block my-2">
                                <strong className="text-blue">
                                  {Number(result?.tech_answer).toFixed(2)}
                              ...
                              <p className="mt-2"><strong>{data?.payload?.tech_lang_keys['36']} :</strong></p>
                              <p className="mt-2">
                                <BlockMath math={`${data?.payload?.tech_lang_keys['18']}\\ ${data?.payload?.tech_lang_keys['32']} = a^2 \\times \\frac{\\cot\\left(\\frac{\\pi}{n}\\right)}{4}`} />
                              </p>

                              <p className="mt-2"><strong>Input :</strong></p>
                              <p className="mt-2">
                                a = {result?.tech_area}, Number of sides (n) = {result?.tech_number_of_sides}
                              </p>
                              ...
                              <p className="mt-2">
                                <BlockMath
                                  math={`${data?.payload?.tech_lang_keys['18']}\\ ${data?.payload?.tech_lang_keys['32']} = ${Number(result?.tech_answer).toFixed(2)}`}
                                />
                                <span className="black-text"> (cm<sup>2</sup>)</span>
                              </p>
                            </div>
