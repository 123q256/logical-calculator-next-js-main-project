...
import { useGetSingleCalculatorDetailsMutation ,useSimilarTrianglesCalculatorMutation} from "../../../../redux/services/calculator/calculatorApi";
            ...
            <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
                <div className="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                  <div className="col-span-12">
                      ...
                      <div className="col-span-12" id="similarity_criterion_select">
                          ...
                          <div className="mt-2">
                            <select
                              ...
                              onChange={handleChange}
                            >
                              <option value="SSS">{data?.payload?.tech_lang_keys["5"]} (SSS)</option>
                              <option value="SAS">{data?.payload?.tech_lang_keys["6"]} (SAS)</option>
                              <option value="ASA">{data?.payload?.tech_lang_keys["7"]} (ASA)</option>
                            </select>
                          </div>
                      </div>
                      </>
                    ...
                    <p className="col-span-12 text-[18px]"><strong>△ABC</strong></p>
                      {((formData.tech_type == "1" && formData.tech_similarity == "SSS" ) || (formData.tech_type == "1" && formData.tech_similarity == "SAS" ) ||(formData.tech_type == "2" )) && (
                        <>
                        <div className="col-span-12 md:col-span-4 lg:col-span-4 ABC_f_input">
                            <label htmlFor="tech_ABC_f" className="label" >AB (a): </label>
                      ...
                      {((formData.tech_type == "1" && formData.tech_similarity == "ASA" )) && (
                        <>
                      <div className="col-span-12 md:col-span-4 lg:col-span-4 ABC_f_input">
                          <label htmlFor="tech_ABC_f" className="label" >  AB (a): </label>
                          <div className="relative w-full ">
                      ...
                      {((formData.tech_type == "1" && formData.tech_similarity == "SSS" ) || (formData.tech_type == "1" && formData.tech_similarity == "SAS" ) ||(formData.tech_type == "2" )) && (
                        <>
                          <div className="col-span-12 md:col-span-4 lg:col-span-4 ABC_f_input">
                            <label htmlFor="tech_ABC_s" className="label" >BC (b): </label>
                              <div className="relative w-full ">
                              <input
                                type="number"
                                name="tech_ABC_s"
                      ...
                      {((formData.tech_type == "1" && formData.tech_similarity == "SSS" ) || (formData.tech_type == "2" )) && (
                      <>
                      <div className="col-span-12 md:col-span-4 lg:col-span-4 ABC_f_input">
                        <label htmlFor="tech_ABC_t" className="label" >AC (c): </label>
                          <div className="relative w-full ">
                          <input
                            type="number"
                            name="tech_ABC_t"
                        ...
                        {((formData.tech_type == "1" && formData.tech_similarity == "SAS" )) && (
                      <>
                        <div className="col-span-12 md:col-span-4 lg:col-span-4 ABC_f_input">
                            <label htmlFor="tech_ABC_t" className="label" > ∠BAC (α₁) </label>
                            <div className="relative w-full ">
                            <input
                              type="number"
                              name="tech_ABC_t"
                      ...
                      {((formData.tech_type == "1" && formData.tech_similarity == "ASA" )) && (
                        ...
                        <div className="col-span-12 ABC_f_input">
                          <label htmlFor="tech_ABC_corresponding" className="label" >{data?.payload?.tech_lang_keys["8"]} △ABC:</label>
                            <div className="relative w-full ">
                            <input
                              type="number"
                      ...
                      {((formData.tech_type == "2" )) && (
                            <>
                          <div className="col-span-12 md:col-span-4 lg:col-span-4 " id="scale_factor_input">
                      ...
                      {((formData.tech_type == "1" )) && (
                          <>
                          <p className="col-span-12 text-[18px] DEF_inputs"><strong>△DEF</strong></p>
                          </>
                      )}

                      {((formData.tech_type == "1" && formData.tech_similarity == "SSS" ) || (formData.tech_type == "1" && formData.tech_similarity == "SAS" )) && (
                            <>
                        <div className="col-span-12 md:col-span-4 lg:col-span-4 DEF_f_input">
                            <label htmlFor="tech_DEF_f" className="label" >DE (d): </label>
                              <div className="relative w-full ">
                              <input
                                type="number"
                                name="tech_DEF_f"
                      ...
                      <div className="col-span-12 md:col-span-4 lg:col-span-4 DEF_s_input">
                          <label htmlFor="tech_DEF_s" className="label" >EF (e): </label>
                            <div className="relative w-full ">
                            <input
                              type="number"
                              name="tech_DEF_s"
                    ...
                    {((formData.tech_type == "1" && formData.tech_similarity == "ASA" )) && (
                      ...
                      {((formData.tech_type == "1" && formData.tech_similarity == "SSS" )) && (
                      <>
                        <div className="col-span-12 md:col-span-4 lg:col-span-4 DEF_inputs">
                            <label htmlFor="tech_DEF_t" className="label" >DF (f): </label>
                              <div className="relative w-full ">
                              <input
                                type="number"
                                name="tech_DEF_t"
                      ...
                      <>
                    <div className="col-span-12 md:col-span-4 lg:col-span-4 DEF_inputs">
                        <label htmlFor="tech_DEF_t" className="label" >  ∠EDF (α₂) </label>
                        <div className="relative w-full ">
                        <input
                          type="number"
                          name="tech_DEF_t"
                      ...
                      {((formData.tech_type == "1" && formData.tech_similarity == "ASA" )) && (
                        ...
                        <div className="col-span-12  DEF_inputs">
                          <label htmlFor="tech_DEF_corresponding" className="label" >{data?.payload?.tech_lang_keys["8"]}  △DEF:</label>
                          <div className="relative w-full ">
                          <input
                            type="number"
                        ...
                        <div className="rounded-lg  flex items-center justify-center">
                            <div className="w-full mt-3">
                                <div className="w-full">
                                    <div className="w-full md:w-[60%]  overflow-auto mt-2">
                                        <table className="w-full text-[16px] md:text-[18px]">
                                          <tbody>
                                            ...
                                            {(formData?.tech_type === "2") ? (
                                              <>
                                                <tr>
                                                    <td className="py-2 border-b" ><strong>{ data?.payload?.tech_lang_keys[13] } △ABC</strong></td>
                                                    <td className="py-2 border-b">△ABC { result?.tech_ABC_area_ans } (cm²)</td>
                                                </tr>
                                                <tr>
                                                    <td className="py-2 border-b" ><strong>{ data?.payload?.tech_lang_keys[14] } △ABC</strong></td>
                                                    <td className="py-2 border-b">△ABC { result?.tech_ABC_perimeter_ans } (cm)</td>
                                                </tr>
                                                <tr>
                                                    <td className="py-2 border-b" ><strong>DE (d)</strong></td>
                                                    <td className="py-2 border-b">△ABC { result?.tech_DEF_f_ans } (cm)</td>
                                                </tr>
                                                <tr>
                                                    <td className="py-2 border-b" ><strong>EF (e)</strong></td>
                                                    <td className="py-2 border-b">△ABC { result?.tech_DEF_s_ans } (cm)</td>
                                                </tr>
                                                <tr>
                                                    <td className="py-2 border-b" ><strong>DF (f)</strong></td>
                                                    <td className="py-2 border-b">△ABC { result?.tech_DEF_t_ans } (cm)</td>
                                                </tr>
                                                <tr>
                                                    <td className="py-2 border-b" ><strong>{ data?.payload?.tech_lang_keys[13] } △DEF</strong></td>
                                                    <td className="py-2 border-b">△ABC { result?.tech_DEF_area_ans } (cm²)</td>
                                                </tr>
                                                <tr>
                                                    <td className="py-2 border-b" ><strong>{ data?.payload?.tech_lang_keys[14] } △DEF</strong></td>
                                                    <td className="py-2 border-b">△ABC { result?.tech_DEF_perimeter_ans } (cm)</td>
                                                </tr>
                                              ...
                                              <>
                                                <tr>
                                                    <td className="py-2 border-b" width="60%"><strong>{ data?.payload?.tech_lang_keys[10] }</strong></td>
                                                    <td className="py-2 border-b">△ABC { result?.tech_symbol } △DEF</td>
                                                </tr>
                                                {(formData?.tech_similarity == "ASA" && result?.tech_jawab == "equal") && (
                                                  <>
                                                    <tr>
                                                        <td className="py-2 border-b" width="60%"><strong>{ data?.payload?.tech_lang_keys[9] } (k)</strong></td>
                                                        <td className="py-2 border-b">{ result?.tech_scale_ans }</td>
                                                    </tr>
                                                  </>
                                                )}
                                                {(formData?.tech_similarity == "ASA") && (
                                                  <>
                                                    <tr>
                                                        <td className="py-2 border-b" width="60%"><strong>∠ACB (γ₁)</strong></td>
                                                        <td className="py-2 border-b">{ result?.tech_ACB_jawab } (deg)</td>
                                                    </tr>
                                                    <tr>
                                                        <td className="py-2 border-b" width="60%"><strong>∠DFE (γ₂)</strong></td>
                                                        <td className="py-2 border-b">{ result?.tech_DEF_jawab } (deg)</td>
                                                    </tr>
                                                  </>
                                                )}
