...
import { useLiteralEquationsCalculatorMutation } from "../../../../redux/services/datecalculator/dateCalculatorApi";
            ...
            <div className="grid grid-cols-12 mt-3 gap-2 md:gap-4 lg:gap-4">
              <div className="col-span-12">
                <div className="col-span-12 md:col-span-4 lg:col-span-4 md:flex md:justify-between">
                  <label for="tech_equ" className="label mt-4">
                      ...
                      <div className="w-full text-[16px] overflow-auto">
                        ...
                        {result?.tech_explain?.map((value, key) => (
                          <div key={key}>
                            ...
                            <div className="mt-3">
                              <BlockMath
                                math={String(result?.tech_steps?.[key])}
                              />
                            </div>
