      ...
      <form className="row" onSubmit={handleSubmit}>
        <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg space-y-6 mb-3">
          ...
          <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
            ...
            {formData.tech_to == "2" && (
              <>
                <div className="grid grid-cols-12 gap-1 md:gap-4  mt-3">
                  <p className="col-span-12 px-2">
                    <strong>Note:</strong> Please! enter any five values to know
                    the sixth one.
                  </p>
                </div>
                <div className="grid grid-cols-12  gap-1 md:gap-4  mt-1">
                  <div className="col-span-12 md:col-span-6">
            ...
            {formData.tech_to == "3" && (
              <>
                <div className="grid grid-cols-12   gap-1 md:gap-4 my-3">
                  <p className="col-span-12 px-2">
                ...
                <div className="grid grid-cols-1 mt-3   gap-1 md:gap-4 ">
                  <div className="space-y-2">
                    <p className="col-12">
