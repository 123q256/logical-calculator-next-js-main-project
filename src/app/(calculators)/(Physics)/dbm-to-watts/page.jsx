...
const DbmToWattsCalculator = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.tech_calculation || !formData.tech_input) {
            ...
            <div className="grid grid-cols-12 gap-2 md:gap-4 lg:gap-4">
              ...
              <div className="col-span-12">
                ...
                <div className=" relative">
                  ...
                  {formData.tech_calculation == "1" && (
                    <>
                      <span className="input_unit">dBm</span>
                    </>
                  )}
                  {formData.tech_calculation == "2" && (
                    <>
                  ...
                  {formData.tech_calculation == "3" && (
                    <>
                      <span className="input_unit">W</span>
                    </>
                  )}
                  {formData.tech_calculation == "4" && (
                    <>
                      <span className="input_unit">mW</span>
                    </>
                  )}
                </div>
              </div>
                          ...
                          <p className="text-[18px]">
                            <strong>
                              ...
                              formData?.tech_calculation == "2"
                                ...
                                : `${data?.payload?.tech_lang_keys[7]} (${data?.payload?.tech_lang_keys[9]})`}
                            </strong>
                          </p>
                          <p className="md:text-[25px] text-[18px] bg-[#2845F5] px-3 py-2 rounded-lg inline-block my-3">
...
export default DbmToWattsCalculator;
