...
const RelativeHumidityCalculator = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.tech_temperature || !formData.tech_point) {
  ...
  const setUnitHandler1 = (unit) => {
    setFormData((prev) => ({ ...prev, tech_point_unit: unit }));
...
export default RelativeHumidityCalculator;
