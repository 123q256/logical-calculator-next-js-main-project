          ...
          <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
            <div className="grid grid-cols-12 mt-3 gap-1  md:gap-4">
              ...
              {(formData.tech_find == "1" ||
                ...
                formData.tech_find == "4") && (
                <>
                  <div className="col-span-12 md:col-span-6  radius">
              ...
              {(formData.tech_find == "1" ||
                ...
                formData.tech_find == "6") && (
                <>
                  <div className="col-span-12 md:col-span-6  t_velocity">
              ...
              {(formData.tech_find == "1" ||
                ...
                formData.tech_find == "5") && (
                <>
                  <div className="col-span-12 md:col-span-6  centi_force">
                          ...
                          {result?.tech_mass && (
                            <>
                              <div className="col-lg-5 mt-2">
                                <table className="w-full md:w-[50%] text-[18px]">
                                  <tbody>
                                    <tr>
