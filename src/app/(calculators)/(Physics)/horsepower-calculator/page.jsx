            ...
            <div className="grid grid-cols-12  gap-4">
              <div className="col-span-12">
                ...
                <div className="mt-2">
                  ...
                  >
                    <option value="1">
                      {data?.payload?.tech_lang_keys["et"]}
                    </option>
                    <option value="2">
                      {data?.payload?.tech_lang_keys["ts"]}{" "}
                    </option>
                    <option value="3">
                      {data?.payload?.tech_lang_keys["rpm"]}{" "}
                    </option>
                    <option value="4">
                      {data?.payload?.tech_lang_keys["base"]}{" "}
                    </option>
                  </select>
                </div>
              </div>
                    ...
                    <div className="w-full mt-3">
                      <div className="w-full md:w-[60%] lg:w-[60%] mt-2">
                        {(formData?.tech_method == 1 ||
                          ...
                          <>
                            <p className="mt-2">
                              {data?.payload?.tech_lang_keys["pow"]}
                            </p>
                        ...
                        {formData?.tech_method == 4 && (
                          <>
                            ...
                            <p className="mt-2">
                              <strong>
                                {result?.tech_hp}{" "}
                                {data?.payload?.tech_lang_keys["wat"]}
                              </strong>
                            </p>
