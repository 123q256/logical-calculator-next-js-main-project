...
const FreeFallCalculator = () => {
  ...
  const setUnitHandler4 = (unit) => {
    setFormData((prev) => ({ ...prev, tech_v_one_unit: unit }));
        ...
        <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg space-y-6 mb-3">
          ...
          <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
            <div className="grid grid-cols-12 mt-3  gap-4">
              ...
              <div className="col-span-6 dis ">
                <label htmlFor="tech_acceleration" className="label">
                  {data?.payload?.tech_lang_keys["5"]} (g)
                </label>
              ...
              <div className="col-span-6 initial ">
              ...
              {formData.tech_selection == "3" && (
                <>
                  <div className="col-span-6  velocity">
                    <label htmlFor="tech_velocity_one" className="label">
                      {data?.payload?.tech_lang_keys["9"]} (V)
                    </label>
                    <div className="relative w-full ">
                      <input
                        type="number"
                        name="tech_velocity_one"
                        step="any"
                        className="mt-1 input"
                        value={formData.tech_velocity_one}
                        placeholder="00"
                        min="1"
                        onChange={handleChange}
                      />
                            ...
                            result?.tech_answer2 !== undefined ? (
                              <>
                                ...
                                <tr>
                                  ...
                                  <td className="py-2 border-b">
                                    {result?.tech_answer2} (m/s)
                                  </td>
                                </tr>
                              </>
                            ) : result?.tech_answer3 !== undefined &&
                              ...
                              <>
                                ...
                                <tr>
                                  ...
                                  <td className="py-2 border-b">
                                    {result?.tech_answer4} (m/s)
                                  </td>
                                </tr>
                              </>
                            ) : result?.tech_answer5 !== undefined &&
