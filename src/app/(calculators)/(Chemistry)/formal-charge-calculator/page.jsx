...
const FormalChargeCalculator = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.tech_V || !formData.tech_LP || !formData.tech_BE) {
        ...
        <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg shadow-md space-y-6 mb-3">
          ...
          <div className="lg:w-[70%] md:w-[90%] w-full mx-auto ">
            <div className="grid grid-cols-1  lg:grid-cols-2 md:grid-cols-2  gap-1 md:gap-2">
              ...
              <div className="">
                <label htmlFor="tech_BE" className="label">
                ...
                <div>
                  ...
                  <div className="rounded-lg  flex items-center justify-center">
                    <div className="w-full mt-3 text-center ">
                      <p>{data?.payload?.tech_lang_keys["4"]} (FC):</p>
