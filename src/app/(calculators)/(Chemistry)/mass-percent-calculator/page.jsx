                      ...
                      <div className="w-full">
                        {result?.tech_method == "1" && (
                          <>
                            ...
                            <p>
                              <strong className="text-green-800 text-[28px]">
                                {result?.tech_mass_percent}{" "}
                                <span className="text-green-800 text-[16px] md:text-[20px]">
                                  (%)
                                </span>
                              </strong>
                            </p>
                            <div className="col-12 grid grid-col-12 gap-2 overflow-auto md:text-[18px] text-[16px]">
                              <table
