...
const GramsToAtomsCalculator = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.tech_form || !formData.tech_x || !formData.tech_y) {
            ...
            <div className="grid grid-cols-12 gap-1  md:gap-4">
              <div className="col-span-12 md:col-span-6">
                <label htmlFor="tech_x" className="label">
                  {data?.payload?.tech_lang_keys["4"]} (g/mol):
                </label>
                  ...
                  <div className="rounded-lg flex items-center justify-center">
                    <div className="w-full mt-3">
                      <div className="w-full text-center">
                        <p>
                          <strong className="md:text-[20px] lg:text-[20px]">
                        ...
                        <p>
                          <strong className="text-[#119154] md:text-[25px] lg:text-[25px]">
                            {result?.tech_ans}
                            <span className="text-[#119154] md:text-[20px] lg:text-[20px]">
                              {formData?.tech_form == "raw"
...
export default GramsToAtomsCalculator;
