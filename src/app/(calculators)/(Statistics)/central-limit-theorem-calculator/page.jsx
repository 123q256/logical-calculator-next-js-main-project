...
const CentralLimitTheoremCalculator = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.tech_u || !formData.tech_o || !formData.tech_n) {
            ...
            <div className="grid grid-cols-12 mt-3 ">
              <div className="col-span-12">
                <label htmlFor="tech_u" className="label">
                  {data?.payload?.tech_lang_keys["1"]} (μ):
                </label>
              ...
              <div className="col-span-12">
                <label htmlFor="tech_o" className="label">
                  {data?.payload?.tech_lang_keys["2"]} (σ):
                </label>
                <div className=" relative">
                  <input
                    type="number"
                  ...
                  <div className="rounded-lg  flex items-center justify-center">
                    <div className="w-full mt-3">
                      <div className="w-full">
                        ...
                        <p className="w-full mt-2">s = σ / √n</p>
                        <p className="w-full mt-2">
                          s = {result?.tech_o} / √{result?.tech_n}
                        </p>
                        <p className="w-full mt-2">
                          s = {result?.tech_o} / {result?.tech_s1}
                        </p>
                        <p className="w-full mt-2">
                          <strong>s = {result?.tech_s}</strong>
                        </p>
                      </div>
                    </div>
                  </div>
...
export default CentralLimitTheoremCalculator;
