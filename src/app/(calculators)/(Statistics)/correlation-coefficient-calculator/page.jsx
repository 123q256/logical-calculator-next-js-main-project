              ...
              <div className="w-full result mx-auto p-4 lg:p-8 md:p-8 result_calculator rounded-lg space-y-6">
                <div>
                  ...
                  <div className="rounded-lg flex items-center justify-center">
                    <div className="w-full mt-3 text-[16px] md:text-[18px]">
                      ...
                      {result?.tech_method === "2" && (
                        <>
                          ...
                          <div className="col-lg-6 mt-2 overflow-auto">
                            ...
                            >
                              <thead className="bg-gray-100 bordered">
                                <tr>
                              ...
                              <tbody>
                                {result?.tech_numbers?.map((x, i) => (
                                  <tr key={i} className="bg-white bordered">
                        ...
                        >
                          ...
                          <tbody>
                            {Array.from({ length: result?.tech_countx }).map(
                              (_, i) => (
                                <tr className="bg-white bordered"  key={i}>
                                  <td className="bordered p-2 text-center">
