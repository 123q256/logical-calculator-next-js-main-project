...
const BinomialCoefficientCalculator = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.tech_n || !formData.tech_k) {
                  ...
                  <div className="rounded-lg flex items-center justify-center">
                    <div className="w-full mt-3">
                      <div className="w-full">
                        ...
                        <p className="w-full mt-3 text-[18px]">Solution:</p>
                        ...
                        />
                        <BlockMath
                          math={`\\binom{${n}}{${k}} = \\frac{${n}!}{${k}!(${
                            n - k
                          })!}`}
                        />
                        <BlockMath
                          math={`\\binom{${n}}{${k}} = \\frac{${factorial(
                            n
                          )}}{${factorial(k)} \\times ${factorial(n - k)}}`}
                        />
                        <BlockMath
                          math={`\\binom{${n}}{${k}} = ${result?.tech_ans}`}
                        />
...
export default BinomialCoefficientCalculator;
