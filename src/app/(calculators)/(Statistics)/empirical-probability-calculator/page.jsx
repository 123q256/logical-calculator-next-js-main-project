...
const EmpiricalProbabilityCalculator = () => {
            ...
            <>
              <div className="w-full mx-auto p-4 lg:p-8 md:p-8 rounded-lg result_calculator space-y-6 result">
                <div>
                  ...
                  <div className="rounded-lg  flex items-center mt-4 justify-center">
                    <div className="w-full overflow-auto">
                      <div className="text-center">
                        <p className="text-[18px]">
                          <strong>{data?.payload?.tech_lang_keys["5"]}</strong>
                        </p>
                        <p className="text-[22px] px-3 py-2 radius-10 d-inline-block my-3">
                          <strong className="bg-[#2845F5] text-white  p-4 rounded-xl">
                            {result?.tech_answer}
                          </strong>
                        </p>
                      </div>
                      <p className="col-12 mt-3 text-[18px]">
                        <strong className="text-blue">Formula:</strong>
                      </p>
                      <p className="col-12 mt-3 font-s-14">
                      ...
                      <p className="col-12 mt-3">
                        <InlineMath
                          math={`= \\dfrac{${formData?.tech_first}}{${formData?.tech_second}}`}
                        />
                      </p>
...
export default EmpiricalProbabilityCalculator;
