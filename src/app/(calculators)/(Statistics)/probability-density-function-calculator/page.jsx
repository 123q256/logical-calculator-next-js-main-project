              ...
              <div className="lg:col-span-6 md:col-span-6 col-span-12">
                ...
                <div className="mt-2">
                  ...
                  >
                    ...
                    <option value="2">
                      Chi-Square {data?.payload?.tech_lang_keys["3"]}
                    </option>
                    <option value="3">
                      F-{data?.payload?.tech_lang_keys["3"]}
                    </option>
                    <option value="4">
                    ...
                    <option value="7">
                      t-{data?.payload?.tech_lang_keys["3"]}
                    </option>
                    <option value="8">
                ...
                <>
                  <div className="lg:col-span-6 md:col-span-6 col-span-12 two">
                    ...
                    {formData.tech_select == "4" && (
                      <>
                        <label htmlFor="tech_b" className="label">
                          {data?.payload?.tech_lang_keys["11"]} (δ)
                        </label>
                      </>
                    )}
                    {formData.tech_select == "5" && (
...
export default ProbabilityDensityFunctionCalculator;
