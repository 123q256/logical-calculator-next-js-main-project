  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await calculateEbitCalculator({
        tech_video: formData.tech_video,
        tech_average: formData.tech_average,
        tech_click: formData.tech_click,
      }).unwrap();
          ...
          <div className="lg:w-[50%] md:w-[70%] w-full mx-auto ">
            <div className="grid grid-cols-12 mt-3  gap-4">
              <div className="col-span-12">
                <label htmlFor="tech_video" className="label">
              ...
              <div className="col-span-12">
                <label htmlFor="tech_click" className="label">
                ...
                <div>
                  ...
                  <div className="rounded-lg  flex items-center justify-center">
                    <div className="w-full mt-3">
                      <div className="w-full md:w-[70%] lg:w-[60%] overflow-auto mt-2">
                        <table className="w-full lg:text-[18px] text-[16px]">
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td className="py-2 border-b">
                                {currency.symbol}{" "}
                                {Math.abs(result?.tech_averageRevenue)}
                              </td>
                            </tr>
                          </tbody>
                        </table>
