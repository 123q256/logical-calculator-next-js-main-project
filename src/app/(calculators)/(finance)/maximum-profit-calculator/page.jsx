...
const MaximumProfitCalculator = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.tech_p || !formData.tech_Q || !formData.tech_C) {
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td className="py-2 border-b">
                                {currency.symbol}{" "}
                                {Number(result?.tech_R).toFixed(2)}{" "}
                              </td>
                            </tr>
                            <tr>
                              <td className="py-2 border-b" width="60%">
                              ...
                              <td className="py-2 border-b">
                                {currency.symbol}{" "}
                                {Number(result?.tech_profit).toFixed(2)}{" "}
                              </td>
                            </tr>
                          </tbody>
                        </table>
...
export default MaximumProfitCalculator;
