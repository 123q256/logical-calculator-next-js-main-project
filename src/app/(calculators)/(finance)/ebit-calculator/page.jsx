    ...
    >
      <form className="row" onSubmit={handleSubmit}>
        <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg space-y-6 mb-3">
          ...
          <div className="w-full lg:w-[40%] md:w-[40%] mx-auto">
            <div className="grid grid-cols-1  mt-3   gap-2 md:gap-4 lg:gap-4">
              <div className="  ">
              ...
              <div className=" ">
                <label htmlFor="tech_y" className="label">
                  {data?.payload?.tech_lang_keys["o_e"]}:
                </label>
                <div className="  relative">
                  <input
                    type="number"
                  ...
                  <div className="rounded-lg  flex items-center justify-center">
                    <div className="w-full  p-6 rounded-lg mt-6">
                      <div className="w-full text-center text-xl">
                        <p className="my-3 ">
                          <strong className="px-6 py-4 text-3xl rounded-lg bg-[#2845F5] text-white">
                            {result.tech_ebit} {currency.symbol}
                          </strong>
                        </p>
                      </div>
                    </div>
