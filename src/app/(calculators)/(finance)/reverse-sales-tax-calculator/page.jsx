...
const ReverseSalesTaxCalculator = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.tech_final || !formData.tech_sale) {
                    ...
                    <div className="w-full mt-3">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td className="py-2 border-b">
                                {" "}
                                {currency.symbol}{" "}
                                {Number(result?.tech_reverse).toFixed(4)}
                              </td>
                            </tr>
                          </tbody>
                        </table>
                      ...
                      <div className="col-12 font-s-16">
                        ...
                        <p className="mt-2">
                          ...
                          {data?.payload?.tech_lang_keys[2]}/100))
                        </p>
                        <p className="mt-2">
                          {data?.payload?.tech_lang_keys[3]} ={" "}
                          {formData?.tech_final} / (1 + ({formData?.tech_sale}
                          /100))
                        </p>
                        <p className="mt-2">
                          {data?.payload?.tech_lang_keys[3]} = {currency.symbol}{" "}
                          {Number(result?.tech_reverse).toFixed(4)}
                        </p>
                      </div>
                    </div>
...
export default ReverseSalesTaxCalculator;
