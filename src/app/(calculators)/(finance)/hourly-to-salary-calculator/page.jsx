        ...
        <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg space-y-6 mb-3">
          ...
          <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
            <div className="grid grid-cols-12 mt-3  gap-4">
              ...
              <div className="col-span-12 md:col-span-6 lg:col-span-6 tip">
              ...
              <div className="col-span-12 md:col-span-6 lg:col-span-6 ppl">
                ...
                <div className=" relative">
                  <input
                    ...
                    className="input my-2"
                    aria-label="input"
                    placeholder={data?.payload?.tech_lang_keys["3"]}
                  ...
                  <div className="rounded-lg  flex items-center justify-center">
                    <div className="w-full mt-3">
                      <div className="w-full">
                        <div className="w-full md:w-[80%] lg:w-[60%]  text-[16px] overflow-auto">
                          <table className="w-full">
                            <tbody>
                              <tr>
                                ...
                                <td className="border-b py-2">
                                  {currency.symbol} {result?.tech_annuly}
                                </td>
                              </tr>
                              <tr>
                                <td className="border-b py-2">
                              ...
                              <tr>
                                ...
                                <td className="border-b py-2">
                                  {currency.symbol} {result?.tech_weekly}
                                </td>
                              </tr>
                              <tr>
                                <td className="border-b py-2">
