            ...
            <div className="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-4">
              <div className="space-y-2">
                ...
                <div className="mt-2">
                  ...
                  >
                    ...
                    <option value="remove">
                      {data?.payload?.tech_lang_keys["remove"]}{" "}
                    </option>
                  </select>
                </div>
              </div>
              ...
              <div className="space-y-2 ">
                <label htmlFor="tech_vat" className="label">
                  {data?.payload?.tech_lang_keys["rate"]} %
                </label>
                <div className=" relative">
                  <input
                    type="number"
                ...
                <div>
                  ...
                  <div className="rounded-lg  flex items-center justify-center">
                    <div className="w-full bg-light-blue  rounded-lg mt-6">
                      <div className="w-full md:w-[50%] mt-4 overflow-auto">
                        <table className="w-full text-[16px]">
                          <tbody>
                            <tr>
                              <td className="py-2 border-b w-7/10 font-bold">
                                Your Value-Added Tax (VAT)
                              </td>
                            ...
                            <tr>
                              ...
                              <td className="py-2 border-b">
                                {currency.symbol} {result?.tech_net}
                              </td>
                            </tr>
                            <tr>
                              <td className="py-2 border-b w-7/10 font-bold">
                              ...
                              <td className="py-2 border-b">
                                {currency.symbol} {result?.tech_gross}
                              </td>
                            </tr>
                          </tbody>
                        </table>
