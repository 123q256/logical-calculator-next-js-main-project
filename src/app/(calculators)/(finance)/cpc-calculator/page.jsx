            ...
            <div className="grid grid-cols-12 mt-3  gap-4">
              <div className="col-span-12">
                ...
                <div className="mt-2">
                  ...
                  >
                    ...
                    <option value="cpc">
                      {data?.payload?.tech_lang_keys["cpc"]}
                    </option>
                    <option value="click">
              ...
              <div className="col-span-12">
                <label htmlFor="tech_x" className="label">
                  {formData.tech_method == "cost"
                    ? data?.payload?.tech_lang_keys["cpc"] + ":"
                    : formData.tech_method == "cpc"
                    ? data?.payload?.tech_lang_keys["cost"] + ":"
                    : data?.payload?.tech_lang_keys["cost"] + ":"}
                </label>
                      ...
                      <div className="w-full text-center text-[20px]">
                        ...
                        <p className="my-3">
                          <strong className="bg-[#2845F5] text-white rounded-lg px-3 py-2 text-[25px] ">
                            {result?.ans ? result.ans : <span>0.0</span>}
                          </strong>
                        </p>
                      </div>
                    </div>
