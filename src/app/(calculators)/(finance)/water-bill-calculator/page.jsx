...
const WaterBillCalculator = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.waterRate || !formData.gallonUsage) {
    ...
    try {
      const response = await calculateEbitCalculator({
        ...
        gallonUsage: formData.gallonUsage,
      }).unwrap();
          ...
          <div className="lg:w-[40%] md:w-[60%] w-full mx-auto ">
            <div className="grid grid-cols-12 mt-3  gap-4">
              <div className="col-span-12">
                <label htmlFor="waterRate" className="label">
              ...
              <div className="col-span-12">
                <label htmlFor="gallonUsage" className="label">
                    ...
                    <div className="w-full mt-3">
                      <div className="w-full">
                          ...
                          <div className="flex justify-center">
                            <p className="text-[25px] bg-[#2845F5] text-white rounded-lg px-3 py-2  my-3">
                              <strong className="text-blue">
                                {currency.symbol}{" "}
                                {Number(result?.totalBill).toFixed(2)}
                              </strong>
                            </p>
                          </div>
                        </div>
                        <div className="w-full">
                          ...
                          <p className="mt-2">
                            {data?.payload?.tech_lang_keys["4"]} ={" "}
                            {formData?.waterRate} * {formData?.gallonUsage}
                          </p>
                          <p className="mt-2">
                            {data?.payload?.tech_lang_keys["4"]} ={" "}
                            {Number(result?.totalBill).toFixed(2)}{" "}
