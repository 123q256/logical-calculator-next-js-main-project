...
const ActualCashValueCalculator = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await calculateEbitCalculator({
        ...
        tech_expected: formData.tech_expected,
  ...
  return (
    ...
    >
      <form className="row" onSubmit={handleSubmit}>
        <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg input_formspace-y-6 mb-3">
          {formError && (
                      ...
                      <div className="col-12 text-center">
                        ...
                        <p className="my-3">
                          <strong className="bg-[#2845F5] text-white rounded-lg px-3 py-2 text-[25px]">
                            {currency.symbol}{" "}
                            {Number(result?.tech_acv).toFixed(2)}
                          </strong>
                        </p>
                      </div>
                    </div>
...
export default ActualCashValueCalculator;
