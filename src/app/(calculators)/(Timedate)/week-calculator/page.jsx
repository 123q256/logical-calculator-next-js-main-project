            ...
            <div className="grid grid-cols-1 gap-4">
              <div className="space-y-2">
                <div className="md:flex items-center space-x-4">
                  <label className="pe-2 cursor-pointer" htmlFor="s_date">
                    <input
                      type="radio"
                      name="tech_stype"
                      value="s_date"
                  ...
                  <label className="cursor-pointer" htmlFor="e_date">
                    <input
                      type="radio"
                      name="tech_stype"
                      className="mr-2 border cursor-pointer"
              ...
              <div className="grid grid-cols-5 lg:grid-cols-5 md:grid-cols-5 mt-4 gap-2 items-center">
                        ...
                        <div className="w-full">
                          {formData.tech_stype === "date" ? (
                            <div className="text-center">
                              <p className="text-2xl md:text-4xl lg:text-4xl bg-[#2845F5] text-[#fff] px-4 py-3 rounded-lg inline-block my-6">
