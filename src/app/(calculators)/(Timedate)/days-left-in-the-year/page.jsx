                  ...
                  <div className="rounded-lg  flex items-center justify-center">
                    <div className="col-12 bg-light-blue result p-3 radius-10 mt-3 overflow-auto">
                      ...
                      <p className="text-center p-2">
                        What is Days form <strong>{result?.tech_now}</strong>{" "}
                        left in this year ? The answer is{" "}
                        <strong>{result?.tech_daysRemaining}</strong> Days are
                        left in End of the year.{" "}
                        <strong>{result?.tech_weeksRemaining}</strong> weeks and{" "}
                        <strong>{result?.tech_remainingDaysAfterWeeks}</strong>{" "}
                        days are Remaining left in the year.
                      </p>
                    </div>
                  </div>
                </div>
...
export default Daysleftintheyear;
