...
import { useMonthsleftintheyearCalculationMutation } from "../../../../redux/services/datecalculator/dateCalculatorApi";
                  ...
                  <div className="rounded-lg  flex items-center justify-center">
                    <div className="col-12  result radius-10 mt-4 overflow-auto">
                      <div className="text-center mb-3">
                        ...
                        <p className="bordered d-inline rounded-lg p-2 px-4 bg-sky text-[18px]">
