...
const HowManyMonthsLeftIn2025 = (selectedDate) => {
              ...
              <div className="w-full result mx-auto p-4 lg:p-8 md:p-8 result_calculator rounded-lg space-y-6">
                <div>
                  ...
                  <div className="rounded-lg  flex items-center justify-center">
                    <div className="col-12  result p-1 radius-10 mt-3 overflow-auto">
                      <div className="text-center mb-3">
                        ...
                        <p className="bordered rounded-lg d-inline p-2 px-4 bg-sky font-s-25">
                          <strong className="text-blue">
                            ...
                            {result?.tech_remainingDaysAfterMonths === 0
                              ? ""
                              : result?.tech_remainingDaysAfterMonths === 1
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2  gap-1 md:gap-4">
                        <div className="col-lg-6 p-1">
                          <div className="bordered rounded-lg bg-sky justify-between p-3">
                            <p>📅 Months</p>
                      ...
                      <p className="text-center p-2">
                        How many Months form <strong>{result?.tech_now}</strong>{" "}
                        left in this year ? The answer is{" "}
                        <strong>{result?.tech_monthsRemaining}</strong>
                        {result?.tech_monthsRemaining === 1
                          ? "Month"
                          : "Months are"}
                        left in End of the year.{" "}
                        <strong>{result?.weeksRemaining}</strong> weeks and{" "}
                        <strong>{result?.remainingDaysAfterWeeks}</strong> days
                        are Remaining left in the year.
                      </p>
                    </div>
                  </div>
                </div>
...
export default HowManyMonthsLeftIn2025;
