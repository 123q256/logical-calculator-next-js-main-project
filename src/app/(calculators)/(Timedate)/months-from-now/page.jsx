...
const MonthsFromNowCalculator = () => {
  ...
  useEffect(() => {
    ...
    const htmlContent = Array.from({ length: 50 }, (_, i) => {
      ...
      const addedWeeksDate = addMonths(today, index);
      ...
      return `
             <tr className="font-bold hover:bg-gray-600" style={{ fontWeight: 700 }}>
                 <td><time datetime="PT${index}W">${index}  Months from today</time></td>
  ...
  const dates = {
    addThreeMonths: addMonths(today, 3),
    addFourMonths: addMonths(today, 4),
    addSixMonths: addMonths(today, 6),
    addNineMonths: addMonths(today, 9),
    addEighteenMonths: addMonths(today, 18),
  };
      ...
      <form className="row" onSubmit={handleSubmit}>
        <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg space-y-6 mb-3">
          ...
          <div className="lg:w-[60%] md:w-[90%] w-full mx-auto ">
            <div className="grid grid-cols-1 mt-2 lg:grid-cols-2 md:grid-cols-2 gap-1 md:gap-4">
        ...
        {calculateDeadlineLoading ? (
          ...
          result && (
            <>
              <div className="w-full result mx-auto p-1 lg:p-8 md:p-8 result_calculator rounded-lg  space-y-6">
                <div>
                    ...
                    <div className="w-full bg-light-blue result p-3 rounded-lg mt-3 overflow-auto">
                      <div className="flex flex-wrap">
                        <div className="lg:w-1/2 w-full p-1">
                          <div className="bordered rounded-md bg-sky p-2 flex justify-between">
                            <p>📅 Date</p>
                        ...
                        <p className="w-full text-center p-2">
                          ...
                          the total {result.tech_weeksInYear} weeks of the year.
                          It also marks day{" "}
...
export default MonthsFromNowCalculator;
