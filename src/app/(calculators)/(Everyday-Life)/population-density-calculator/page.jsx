...
const PopulationDensityCalculator = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.tech_area || !formData.tech_no) {
              ...
              <div className="col-span-12">
                ...
                <div className=" relative">
                  <input
                    ...
                    onChange={handleChange}
                  />
                  <span className="input_unit">sq. mi</span>
                </div>
              </div>
            </div>
          </div>
                    ...
                    <div className="w-full mt-3">
                      <div className="w-full">
                        <div className="text-center">
                          ...
                          <p className=" mt-3">
                            <strong className="bg-[#2845F5] py-2 px-3 text-white text-[21px] rounded-lg">
                              {result?.tech_ans}{" "}
                              {data?.payload?.tech_lang_keys["4"]} sq. mi
                            </strong>
                          </p>
                        </div>
                      </div>
...
export default PopulationDensityCalculator;
