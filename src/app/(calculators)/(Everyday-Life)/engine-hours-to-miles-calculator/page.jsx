...
const EngineHoursToMilesCalculator = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.tech_f_input || !formData.tech_s_input) {
                    ...
                    <div className="col-12 bg-light-blue result p-3 radius-10 mt-3">
                      <div className="w-full">
                        ...
                        <div className="text-center">
                          ...
                          <p className="mt-2">
                            {data?.payload?.tech_lang_keys[1]} ={" "}
                            {formData?.tech_f_input}
                          </p>
                          <p className="mt-2">
                            {data?.payload?.tech_lang_keys[2]} ={" "}
                            {formData?.tech_s_input}
                          </p>
                          ...
                          <p className="mt-2">
                            {data?.payload?.tech_lang_keys[6]} ={" "}
                            {formData?.tech_f_input} * {formData?.tech_s_input}
                          </p>
                          <p className="mt-2">
                            {data?.payload?.tech_lang_keys[6]} ={" "}
...
export default EngineHoursToMilesCalculator;
