...
const AverageTimeCalculator = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setFormError("");
    try {
      const response = await calculateAverageCalculator({
              ...
              <div className="w-full overflow-auto mera_table">
                ...
                <div className="w-full add ">
                  <button
                    ...
                    title="Add New Time"
                    onClick={addRow}
                    className="add_btn units_active  font-semibold bg-[#2845F5] text-white cursor-pointer rounded-[30px] focus:outline-none px-4 py-2 my-5"
                  >
                          ...
                          <table className="w-full" cellspacing="0">
                            ...
                            <tr>
                              ...
                              <td className="p-2">
                                <p className="text-center">
                                  <strong className="text-green-800 mx-2 text-[25px]">
                                    {Math.round(result?.tech_time_miliseconds)}
                                  </strong>
                                  {data?.payload?.tech_lang_keys[4]}
                                </p>
                              </td>
