...
const GoldCostPerPoundCalculator = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.tech_weight || !formData.tech_cost) {
            ...
            <div className="grid grid-cols-12 mt-3  gap-4">
              ...
              <div className="lg:col-span-6 md:col-span-6 col-span-12">
                <label htmlFor="tech_weight" className="label">
                  {data?.payload?.tech_lang_keys["3"]} (lbs):
                </label>
                <div className=" relative">
                  <input
                    type="number"
                          ...
                          <div className="flex justify-center">
                            <p className="text-[25px] bg-[#2845F5] text-white rounded-lg px-3 py-2  my-3">
                              <strong className="text-blue">
                                {currency.symbol} {result?.tech_GCP}{" "}
                                <span className="text-[18px]">/ lb</span>
                              </strong>
                            </p>
                          </div>
                        </div>
...
export default GoldCostPerPoundCalculator;
