                ...
                <div>
                  ...
                  <div className="rounded-lg  flex items-center justify-center">
                    <div className="w-full bg-light-blue rounded-[10px] mt-3">
                      <div className="my-2">
                        <div className="lg:w-[100%] overflow-auto md:text-[18px] text-[16px]">
                        ...
                        <div className="lg:flex mf:flex">
                          <div className="w-full lg:w-[50%] overflow-auto md:text-[18px] text-[16px] mt-3">
                            <table className="w-full">
                              <tbody>
                                <tr>
                          ...
                          <div className="w-full lg:w-[50%] flex items-center overflow-auto">
                            <div
                              style={{
                                width: "350px",
                                height: "350px",
