            ...
            <div className="grid grid-cols-12 mt-3  gap-4">
              <div className="lg:col-span-6 md:col-span-6 col-span-12">
                <label htmlFor="tech_d" className="label">
                  {data?.payload?.tech_lang_keys["focus_d"]} (d):
                </label>
              ...
              <div className="lg:col-span-6 md:col-span-6 col-span-12">
                <label htmlFor="tech_f" className="label">
                  {data?.payload?.tech_lang_keys["focal_d"]} (f):
                </label>
                <div className="relative w-full ">
                  <input
                    type="number"
                          ...
                          <table className="w-full text-[16px]">
                            <tbody>
                              ...
                              <tr>
                                <td className="border-b py-2">
                                  <strong>
                                    {data?.payload?.tech_lang_keys["o_d"]} :
                                  </strong>
                                </td>
                                <td className="border-b py-2">
                                  {result?.tech_g} m
                              ...
                              <tr>
                                <td className="border-b py-2">
                                  <strong>
                                    {data?.payload?.tech_lang_keys["s_d"]} :
                                  </strong>
                                </td>
                                <td className="border-b py-2">
                                  {result?.tech_h} m
...
export default MagnificationCalculator;
